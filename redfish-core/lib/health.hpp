...
struct HealthPopulate : std::enable_shared_from_this<HealthPopulate>
{
    ...
    ~HealthPopulate()
    {
        ...
        for (const auto &[path, interfaces] : statuses)
        {
            ...
            // We only want to look at this association if either the path of
            // this association is an inventory item, or one of the endpoints
            // in this association is a child
