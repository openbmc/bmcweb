...
inline void beforeHandleSystemsDBusEventLogEntryCollection(
...
inline void beforeHandleSystemsDBusEventLogEntry(
...
inline void beforeHandleSystemsDBusLogServiceActionsClear(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void beforeHandleSystemsDBusEventLogEntryDownload(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName, const std::string& entryId)
{
...
inline void requestRoutesDBusEventLogEntry(App& app)
{
    BMCWEB_ROUTE(
        ...
        .methods(boost::beast::http::verb::get)(
            std::bind_front(beforeHandleSystemsDBusEventLogEntry, std::ref(app),
...
inline void requestRoutesDBusEventLogEntryDownload(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            beforeHandleSystemsDBusEventLogEntryDownload, std::ref(app)));
}
} // namespace redfish
