...
inline void jsonSchemaResponseGet(nlohmann::json& json)
{
...
inline void jsonJsonSchemaFileCollectionGet(
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    jsonSchemaResponseGet(asyncResp->res.jsonValue);
}
...
inline void requestRoutesRedfish(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/JsonSchemas/")
        .methods(boost::beast::http::verb::get)(
            std::bind_front(jsonJsonSchemaFileCollectionGet, std::ref(app)));
}
