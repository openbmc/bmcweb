...
inline void requestEthernetInterfacesRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/EthernetInterfaces/<str>/")
        ...
        sdbusplus::message::object_path("/xyz/openbmc_project/network") / ifaceId,
        "xyz.openbmc_project.Network.EthernetInterface", "NICEnabled", "InterfaceEnabled", *interfaceEnabled);
            }
