    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    dbus::utility::async_method_call(
        asyncResp,
        std::bind_front(afterDeleteIPAddress, version, ifaceId, prefixLength,
                        address, gateway, propertyName, asyncResp),
        "xyz.openbmc_project.Network",
                       ...
                       const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    dbus::utility::async_method_call(
        asyncResp, std::bind_front(afterCreateIPv6, address, asyncResp),
