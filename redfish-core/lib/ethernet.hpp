    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    BMCWEB_LOG_ERROR << "handleSLAACAutoConfigPatch " << dhcp;
    crow::connections::systemBus->async_method_call(
        [asyncResp](const boost::system::error_code ec) {
            if (ec)
            {
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/EthernetInterfaces/<str>/")
        ...
        .methods(boost::beast::http::verb::patch)(
            [&app](const crow::Request& req,
                ...
                std::optional<nlohmann::json> statelessAddressAutoConfiguration;
                ...
                if (!json_util::readJsonPatch(
                        ...
                        statelessAddressAutoConfiguration, "MTUSize", mtuSize,
                ...
                if (statelessAddressAutoConfiguration)
                {
                    if (!json_util::readJson(
                            *statelessAddressAutoConfiguration, asyncResp->res,
                ...
                getEthernetIfaceData(
                    ...
                    [asyncResp, ifaceId, hostname = std::move(hostname),
                     ...
                     statelessAddressAutoConfiguration =
                         std::move(statelessAddressAutoConfiguration),
