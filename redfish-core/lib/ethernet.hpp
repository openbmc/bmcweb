    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    for (json_util::NullOrValue<nlohmann::json::object_t>& thisJson : input)
    {
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    for (const json_util::NullOrValue<nlohmann::json::object_t>& thisJson :
         input)
    {
...
inline void requestEthernetInterfacesRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/EthernetInterfaces/<str>/")
        ...
        std::optional<
            std::vector<json_util::NullOrValue<nlohmann::json::object_t>>>
            ipv4StaticAddresses;
        std::optional<
            std::vector<json_util::NullOrValue<nlohmann::json::object_t>>>
            ipv6StaticAddresses;
