...
{
    // TODO(): Once refactor approved, use existing bmcweb filename validator
...
std::vector<std::string> Hook::listInstances(void) const
{
    ...
    for (const auto& instanceDir : instanceDirs)
    {
        ...
        result.push_back(instanceDir.string());
    }
