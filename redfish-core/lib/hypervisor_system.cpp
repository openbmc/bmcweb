 ...
 * @return None.
 */
static void getHypervisorState(
 ...
 * @return None.
 */
static void getHypervisorActions(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static bool extractHypervisorInterfaceData(
 ...
 * @return None.
 */
static void setHypervisorIPv4Address(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void setHypervisorIPv4Subnet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void setHypervisorIPv4Gateway(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None
 */
static void createHypervisorIPv4(
 ...
 * @return None
 */
static void deleteHypervisorIPv4(
...
static void parseInterfaceData(nlohmann::json& jsonResponse,
                               const std::string& ifaceId,
...
static void setDHCPEnabled(const std::string& ifaceId, bool ipv4DHCPEnabled,
                           const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void handleHypervisorIPv4StaticPatch(
    const std::string& ifaceId,
...
static void handleHypervisorHostnamePatch(
    const std::string& hostName,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void setIPv4InterfaceEnabled(
...
static void handleHypervisorEthernetInterfaceCollectionGet(
...
static void handleHypervisorEthernetInterfaceGet(
    App& app, const crow::Request& req,
...
static void handleHypervisorEthernetInterfacePatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& ifaceId)
{
