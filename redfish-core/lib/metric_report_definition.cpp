...
static bool formatMessageOnError(crow::Response& res, const std::string& id,
...
static metric_report_definition::ReportActionsEnum toRedfishReportAction(
...
static std::string toDbusReportAction(std::string_view redfishValue)
{
...
static metric_report_definition::MetricReportDefinitionType
...
static std::string toDbusReportingType(std::string_view redfishValue)
{
...
static metric_report_definition::CollectionTimeScope
...
static std::string toDbusCollectionTimeScope(std::string_view redfishValue)
{
...
static metric_report_definition::ReportUpdatesEnum toRedfishReportUpdates(
    std::string_view dbusValue)
{
    if (dbusValue ==
...
static std::string toDbusReportUpdates(std::string_view redfishValue)
{
...
static std::optional<nlohmann::json::array_t> getLinkedTriggers(
...
static bool getUserMetric(crow::Response& res, nlohmann::json::object_t& metric,
...
static bool getUserMetrics(crow::Response& res,
...
static bool getChassisSensorNodeFromMetrics(
...
static std::string toRedfishProperty(std::string_view dbusMessage)
{
    if (dbusMessage == "Id")
    {
        return "Id";
...
static bool handleParamError(crow::Response& res, const char* errorMessage,
                             std::string_view key)
{
...
static void afterAddReport(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterSetReadingParams(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterSetReportingProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& id,
...
static void setReportTypeAndInterval(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, std::string_view id,
...
static void afterSetReportUpdates(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& id,
    const boost::system::error_code& ec, const sdbusplus::message_t& msg)
{
    if (ec == boost::system::errc::invalid_argument)
...
static void afterSetReportActions(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& id,
    const boost::system::error_code& ec, const sdbusplus::message_t& msg)
{
    if (ec == boost::system::errc::invalid_argument)
...
static void handleMetricReportDefinitionCollectionHead(
...
static void handleMetricReportDefinitionCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void afterRetrieveUriToDbusMap(
    const std::shared_ptr<bmcweb::AsyncResp>& /*asyncResp*/,
...
static void handleMetricReportDefinitionsPost(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleMetricReportHead(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& /*id*/)
{
...
static void handleMetricReportGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& id)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleMetricReportDelete(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& id)
