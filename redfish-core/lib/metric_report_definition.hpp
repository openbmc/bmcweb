...
{
    asyncResp->res.jsonValue["@odata.type"] = schemas::metricReportDefinition;
        ...
        crow::connections::systemBus->async_method_call(
            ...
            if (ec == boost::system::errc::file_exists)
            {
                messages::resourceAlreadyExists(
                    aResp->res, schemas::metricReportDefinition, "Id", name);
                return;
            }
...
inline void requestRoutesMetricReportDefinitionCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/TelemetryService/MetricReportDefinitions/")
        ...
        asyncResp->res.jsonValue["@odata.type"] =
            schemas::metricReportDefinitionCollection;
