...
class MetricReportDefinition : public Node
{
  ...
  private:
        ...
        const std::vector<std::pair<std::string, telemetry::ReportProp>>& ret)
    {
        ...
        std::optional<const telemetry::ReportAction*> reportActions;
        std::optional<const telemetry::ReadingParameters*> readingParams;
        std::optional<const telemetry::ReportingType*> reportingType;
        std::optional<telemetry::ScanPeriod> scanPeriod;

        if (!dbus::utility::readProperties(ret, "ReportActions", reportActions,
