        ...
        properties)
{
    ...
    if (reportActions == nullptr || readingParams == nullptr ||
        reportingType == nullptr || reportUpdates == nullptr ||
        name == nullptr || appendLimit == nullptr || interval == nullptr ||
        triggerIds == nullptr)
    {
