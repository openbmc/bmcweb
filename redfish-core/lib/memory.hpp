    ...
    const DimmProperties& properties)
{
    ...
    const std::optional<sdbusplus::UnpackError> error =
    ...
    if (error)
    {
        ...
        log_utils::logPropertyError(*error);
        return;
    }
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath, "",
        [dimmId, aResp{std::move(aResp)}](const boost::system::error_code ec,
            ...
            if (ec)
            {
                BMCWEB_LOG_DEBUG << log_utils::dbusResponseError;
                messages::internalError(aResp->res);
            ...
            const std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(
                    properties, "MemorySizeInKB", memorySizeInKB,
                    "MemoryDataWidth", memoryDataWidth, "PartNumber",
                    partNumber, "SerialNumber", serialNumber, "Manufacturer",
                    manufacturer, "RevisionCode", revisionCode, "Present",
                    present, "MemoryTotalWidth", memoryTotalWidth, "ECC", eCC,
                    "FormFactor", formFactor, "AllowedSpeedsMT",
                    ...
                    "MemoryController", memoryController, "Slot", slot,
                    "Socket", socket, "SparePartNumber", sparePartNumber,
