...
inline void dimmPropToHex(const std::shared_ptr<bmcweb::AsyncResp>& aResp,
                          const char* key, const std::optional<uint16_t> value)
{
    if (value)
    {
...
{
    std::optional<uint16_t> moduleManufacturerID, moduleProductID,
        subsystemVendorID, subsystemDeviceID;
    std::optional<uint64_t> volatileRegionSizeLimitInKiB,
        ...
        spareDeviceCount;
    std::optional<bool> configurationLockCapable, dataLockCapable,
        passphraseCapable, isRankSpareEnabled, configurationLocked;
    std::optional<uint32_t> maxAveragePowerLimitmW;
    std::optional<std::string> allowedMemoryModes, memoryMedia;
    ...
    std::optional<std::string> badProperty = sdbusplus::unpackPropertiesNoThrow(
        ...
        "PmRegionSizeLimitInKiB", pmRegionSizeLimitInKiB, "VolatileSizeInKiB",
        volatileSizeInKiB, "PmSizeInKiB", pmSizeInKiB, "CacheSizeInKB",
        cacheSizeInKB, "VoltaileRegionMaxSizeInKib", voltaileRegionMaxSizeInKib,
        ...
        spareDeviceCount, "IsRankSpareEnabled", isRankSpareEnabled,
    ...
    if (badProperty)
    {
        BMCWEB_LOG_DEBUG << "Invalid property type for " << *badProperty;
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath, "",
        [dimmId, aResp{std::move(aResp)}](const boost::system::error_code ec,
            ...
            std::optional<uint16_t> dataWidth;
            std::optional<uint16_t> revisionCode;
            std::optional<bool> present;
            std::optional<uint16_t> totalWidth;
            std::optional<std::string> ecc;
            std::optional<std::string> formFactor;
            std::optional<std::vector<uint16_t>> allowedSpeedMt;
            std::optional<uint8_t> memoryAttributes;
            std::optional<uint16_t> memoryConfiguredSpeedInMhz;
            std::optional<std::string> memoryType;
            std::optional<std::string> locationCode;
            std::optional<std::string> channel, memoryController, slot, socket,
                partNumber, serialNumber, manufacturer, sparePartNumber, model;
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, path,
        ...
        [aResp{std::move(aResp)}](
            ...
            std::optional<std::string> memoryClassification, partitionId;
            std::optional<uint64_t> offsetInKiB, sizeInKiB;
            std::optional<bool> passphraseState;
