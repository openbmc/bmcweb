    ...
    const nlohmann::json::json_pointer& jsonPtr)
{
    ...
    const uint64_t* cacheSizeInKiB = nullptr;
    ...
    const bool success = sdbusplus::unpackPropertiesNoThrow(
        ...
        "PmSizeInKiB", pmSizeInKiB, "CacheSizeInKiB", cacheSizeInKiB,
    ...
    if (allowedMemoryModes != nullptr && !allowedMemoryModes->empty())
    {
    ...
    if (memoryMedia != nullptr && !memoryMedia->empty())
    {
    ...
    const nlohmann::json::json_pointer& jsonPtr)
{
    ...
    if (formFactor != nullptr && !formFactor->empty())
    {
    ...
    if (memoryType != nullptr && !memoryType->empty())
    {
    ...
    if (locationCode != nullptr && !locationCode->empty())
    {
        asyncResp->res
    ...
    const nlohmann::json::json_pointer& regionPtr)
{
    ...
    if (memoryClassification != nullptr && !memoryClassification->empty())
    {
    ...
    if (partitionId != nullptr && !partitionId->empty())
    {
