...
inline void getDimmInventoryItem(const std::shared_ptr<bmcweb::AsyncResp>& resp,
...
class Memory : public Node
{
  ...
  private:
               ...
               const std::vector<std::string>& params) override
    {
        ...
        auto getDimmData = [asyncResp,
                            dimmId](const std::string& objectPath,
        ...
        getDimmInventoryItem(asyncResp, dimmId, std::move(getDimmData));
    }
                 ...
                 const std::vector<std::string>& params) override
    {
        ...
        auto setDimmData = [asyncResp, locationIndicatorActive](
        ...
        getDimmInventoryItem(asyncResp, dimmId, std::move(setDimmData));
    }
};
