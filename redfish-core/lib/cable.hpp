...
inline void cablesByNameGet(const crow::Request& /*unused*/,
...
void inline getCables(const crow::Request& /*unused*/,
                      const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
inline void requestRoutesCableCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Cables/")
        ...
        .methods(boost::beast::http::verb::get)(getCables);
}
/**
 * The Cable schema
 */
inline void requestRoutesCable(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Cables/<str>/")
        ...
        .methods(boost::beast::http::verb::get)(cablesByNameGet);
}
