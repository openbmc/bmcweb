 ...
 */
static void getProcessorUUID(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
static void getCpuDataByInterface(
...
static void getCpuDataByService(
 ...
 */
static processor::ThrottleCause dbusToRfThrottleCause(
...
static void readThrottleProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
...
static void getThrottleProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getCpuAssetData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                            const std::string& service,
                            const std::string& objPath)
{
...
static void getCpuRevisionData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                               const std::string& service,
                               const std::string& objPath)
{
...
static void getAcceleratorDataByService(
 ...
 *                                      speed cores.
 */
static void highSpeedCoreIdsHandler(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
static void getCpuLocationCode(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                               const std::string& service,
                               const std::string& objPath)
{
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
static void getCpuUniqueId(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                           const std::string& service,
...
static void handleProcessorSubtree(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
static void getProcessorObject(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& processorId,
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
static void getOperatingConfigData(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& service, const std::string& objPath)
{
    dbus::utility::getAllProperties(
 ...
 */
static void patchAppliedOperatingConfig(
...
static void handleProcessorHead(
...
static void handleProcessorCollectionHead(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleProcessorGet(
...
static void handleProcessorPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName, const std::string& processorId)
{
