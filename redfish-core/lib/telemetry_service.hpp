...
inline void afterGetTelemetryServiceProperties(
    ...
    const dbus::utility::DBusPropertiesMap& ret)
{
    if (ec)
    {
        ...
        BMCWEB_LOG_ERROR("afterGetTelemetryServiceProperties DBus error {}",
                         ec);
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    dbus::utility::getAllProperties(
        ...
        std::bind_front(afterGetTelemetryServiceProperties, asyncResp));
}
