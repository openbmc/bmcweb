    ...
    const uint64_t computerSystemIndex)
{
    const std::string path = std::format(
        "/xyz/openbmc_project/control/host{}/boot", computerSystemIndex);

    const sdbusplus::message::object_path settingsPath(path);

    dbus::utility::getProperty<std::string>(
        "xyz.openbmc_project.Settings", settingsPath,
    ...
    const uint64_t computerSystemIndex, const bool bootOverrideEnableSetting)
{
    ...
    const std::string path =
        std::format("/xyz/openbmc_project/control/host{}/boot/one_time",
                    computerSystemIndex);
    ...
    const uint64_t computerSystemIndex)
{
    ...
    const std::string path = std::format(
        "/xyz/openbmc_project/control/host{}/auto_reboot", computerSystemIndex);
    ...
    const uint64_t computerSystemIndex)
{
    ...
    const std::string path =
        std::format("/xyz/openbmc_project/control/host{}/power_restore_policy",
                    computerSystemIndex);
                          ...
                          const std::optional<std::string>& bootEnable)
{
    ...
    sdbusplus::message::object_path settingsPath(path);
