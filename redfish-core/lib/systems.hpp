...
void getPowerRestorePolicy(std::shared_ptr<AsyncResp> aResp)
{
    ...
    crow::connections::systemBus->async_method_call(
        [aResp](const boost::system::error_code ec,
            ...
            if (*policyPtr == "xyz.openbmc_project.Control.Power.RestorePolicy."
                              "Policy.AlwaysOn")
            {
                aResp->res.jsonValue["PowerRestorePolicy"] = "AlwaysOn";
            }
            else if (*policyPtr ==
                     "xyz.openbmc_project.Control.Power.RestorePolicy."
                     "Policy.AlwaysOff")
            {
                aResp->res.jsonValue["PowerRestorePolicy"] = "AlwaysOff";
            }
            else
            {
                aResp->res.jsonValue["PowerRestorePolicy"] = "LastState";
            }
        },
        "xyz.openbmc_project.Settings",
                                  ...
                                  std::optional<std::string> policy)
{
    ...
    if (*policy == "AlwaysOn")
    {
        powerRestorPolicy = "xyz.openbmc_project.Control.Power.RestorePolicy."
                            "Policy.AlwaysOn";
    }
