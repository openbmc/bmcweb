    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/")
        ...
        crow::connections::systemBus->async_method_call(
            ...
            for (const auto& object : objects)
            {
                ...
                std::string computerSystemName;
                std::string computerSystemIndex;
                if ((nodeStr.find("host") + 1) == std::string::npos ||
                    nodeStr == firstNodeStr)
                {
                    computerSystemName = "system";
                }
                else
                {
                    ...
                    computerSystemName = "system" + computerSystemIndex;
                }
        ...
        asyncResp->res.jsonValue["Actions"]["#ComputerSystem.Reset"] = {
            ...
            {"@Redfish.ActionInfo",
             crow::utility::urlFromPieces("redfish", "v1", "Systems",
                                          computerSystemName, "ResetActionInfo")
                 .string()}};
...
inline void requestRoutesSystemResetActionInfo(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/ResetActionInfo/")
        ...
        asyncResp->res.jsonValue["@odata.id"] =
            ("/redfish/v1/Systems/" + computerSystemName + "/ResetActionInfo");
        asyncResp->res.jsonValue["@odata.type"] =
