...
void getBaseboardList(CallbackFunc &&callback) {
  ...
  crow::connections::systemBus->async_method_call(
      ...
      std::array<const char *, 1>{"xyz.openbmc_project.Inventory.Item.Board"});
};
                ...
                crow::connections::systemBus->async_method_call(
                    [ aResp, name(std::string(name)) ](
                      ...
                      for (const std::pair<std::string, VariantType> &property :
                        ...
                        if (value != nullptr) {
                          aResp->res.jsonValue[property.first] = *value;
>>>>>>> 8793ed3... Remove the providers interface from systems
            }
                  }
          ...
          for (auto const &i : s.second) {
            if (boost::ends_with(i, "Dimm")) {
              ...
              crow::connections::systemBus->async_method_call(
                  ...
                  s.first, path, "org.freedesktop.DBus.Properties", "GetAll",
                  "xyz.openbmc_project.Inventory.Item.Dimm");
                  ...
                  [aResp](const boost::system::error_code ec,
                    ...
                    for (const std::pair<std::string, VariantType> &p :
                      ...
                      if (p.first == "UUID") {
                        const std::string *value =
                            mapbox::getPtr<const std::string>(p.second);
                        BMCWEB_LOG_DEBUG << "UUID = " << *value << " length "
                                         << value->length();
                        if (value != nullptr) {
                          ...
                          if (value->length() > 0 && value->length() < 32) {
                            ...
                            correctedValue.append(32 - value->length(), '0');
