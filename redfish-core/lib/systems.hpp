 ...
 */
inline void
    modifyCpuFunctionalState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
inline void getProcessorSummary(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                                ...
                                const std::string& path)
{
    ...
    auto getCpuFunctionalState = [asyncResp](const boost::system::error_code& ec3,
 ...
 * @return None.
 */
inline void getMemorySummary(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                             const std::string& service,
                             const std::string& path)
{
    sdbusplus::asio::getAllProperties(
 ...
 */
inline int assignBootParameters(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
inline void getBootOverrideType(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    sdbusplus::asio::getProperty<std::string>(
...
inline void getBootOverrideMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    sdbusplus::asio::getProperty<std::string>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        "/xyz/openbmc_project/control/host0/boot",
...
inline void
    processBootOverrideEnable(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                              const bool bootOverrideEnableSetting)
{
    if (!bootOverrideEnableSetting)
    {
        asyncResp->res.jsonValue["Boot"]["BootSourceOverrideEnabled"] = "Disabled";
        return;
    }
    ...
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        ...
        if (oneTimeSetting)
        {
            asyncResp->res.jsonValue["Boot"]["BootSourceOverrideEnabled"] = "Once";
        }
        else
        {
 ...
 * @return None.
 */
inline void getBootProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
inline void getLastResetTime(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    sdbusplus::asio::getProperty<uint64_t>(
        *crow::connections::systemBus, "xyz.openbmc_project.State.Chassis",
        ...
        [asyncResp](const boost::system::error_code& ec, uint64_t lastResetTime) {
        if (ec)
        {
            BMCWEB_LOG_DEBUG << "D-BUS response error " << ec;
            return;
 ...
 */
inline void
    getAutomaticRebootAttempts(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    getAutomaticRetryPolicy(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        ...
        [asyncResp](const boost::system::error_code& ec, bool autoRebootEnabled) {
        if (ec)
        {
            if (ec.value() != EBADR)
            {
...
inline void
    setAutomaticRetryAttempts(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return Integer error code.
 */
inline void setBootModeOrSource(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                                const std::optional<std::string>& bootSource)
{
    ...
    // Figure out which DBUS interface and property to use
    if (assignBootParameters(asyncResp, *bootSource, bootSourceStr, bootModeStr) !=
        0)
    {
        BMCWEB_LOG_DEBUG
            << "Invalid property value for BootSourceOverrideTarget: "
...
inline void setBootProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                              const std::optional<std::string>& bootSource,
                              const std::optional<std::string>& bootType,
                              const std::optional<std::string>& bootEnable)
{
 ...
 * @return None.
 */
inline void setAutomaticRetry(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
inline void translatePowerMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      ...
                      const std::string& modeString)
{
    ...
    {
        messages::propertyValueNotInList(asyncResp->res, modeString, "PowerMode");
    }
    return mode;
}
 ...
 * @return None.
 */
inline void setWDTProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
inline void getIdlePowerSaver(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
inline void setIdlePowerSaver(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
