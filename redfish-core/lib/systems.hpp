    ...
    getBootOverrideEnable(const std::shared_ptr<bmcweb::AsyncResp>& aResp)
{
    crow::connections::systemBus->async_method_call(
        [aResp](const boost::system::error_code ec,
            ...
            bool bootOverrideEnableSetting = *bootOverrideEnablePtr;
                              ...
                              std::optional<std::string> bootEnable)
{
    ...
    setBootModeOrSource(aResp, std::move(bootSource));
    setBootType(aResp, std::move(bootType));
    setBootEnable(aResp, std::move(bootEnable));
}
