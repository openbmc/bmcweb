...
inline void getBootOverrideType(
    ...
    const uint64_t computerSystemIndex)
{
    sdbusplus::message::object_path settingsPath =
        systems_utils::getSettingsObjectPath(computerSystemIndex);
    settingsPath /= "boot";
    ...
    const uint64_t computerSystemIndex)
{
    ...
    sdbusplus::message::object_path settingsPath =
        systems_utils::getSettingsObjectPath(computerSystemIndex);
    settingsPath /= "power_restore_policy";
