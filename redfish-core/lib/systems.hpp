 ...
 */
inline bool
    autoRebootPolicyEnabled(const std::shared_ptr<bmcweb::AsyncResp>& aResp)
{
    ...
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        ...
        [aResp, &autoReboot](const boost::system::error_code ec,
                              ...
                              const uint32_t& retryAttempts)
{
    ...
    auto autoReboot = autoRebootPolicyEnabled(aResp);
    if (!autoReboot)
    {
