...
void getComputerSystem(std::shared_ptr<AsyncResp> aResp)
{
    ...
    auto getCpuPresenceState =
        [aResp](const boost::system::error_code ec,
            ...
            nlohmann::json &procCount = aResp->res.jsonValue
        ...
        auto getCpuFunctionalState =
            ...
            const bool *isCpuFunctional = std::get_if<bool>(&cpuFunctionalCheck);
            ...
            nlohmann::json &prevProcState = aResp->res.jsonValue["ProcessorSummary"]
                                                        ["Status"]["State"];

            if (prevProcState == "Disabled")
            {
                aResp->res.jsonValue["ProcessorSummary"]["Status"]["State"] = cpuStatus;
            }
        };
