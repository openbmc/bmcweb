                       ...
                       const std::string& portPath)>&& callback)
{
    getFabricPortPaths(asyncResp, fabricAdapterPath,
                       std::bind_front(afterGetValidFabricPortPath, asyncResp,
                                       portId, std::move(callback)));
}

inline void afterGetValidFabricPortPathForPortHead(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    ...
    const std::string& serviceName)
{
    ...
    getValidFabricPortPath(
        ...
        std::bind_front(afterGetValidFabricPortPathForPortHead, asyncResp,
                        portId));
}
                         ...
                         const std::string& portId)
{
    ...
    getValidFabricAdapterPath(adapterId, systemName, asyncResp,
                              std::bind_front(afterHandleFabricPortHead,
                                              asyncResp, adapterId, portId));
}

inline void afterDoHandleFabricPortGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    ...
    const std::string& fabricAdapterPath, const std::string& /*unused*/)
{
    ...
    getValidFabricPortPath(asyncResp, fabricAdapterPath, portId,
                           std::bind_front(afterDoHandleFabricPortGet,
    ...
    const std::string& systemName, const std::string& adapterId)
{
    ...
    getValidFabricAdapterPath(
        ...
        std::bind_front(afterHandleFarbicPortCollectionHead, asyncResp,
                        adapterId));
}
