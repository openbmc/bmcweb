...
static void handleSystemsLogServicesPostCodesGet(
...
static void handleSystemsLogServicesPostCodesPost(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
static void getPostCodeForEntry(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getPostCodeForBoot(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleSystemsLogServicesPostCodesEntriesGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
static void handleSystemsLogServicesPostCodesEntriesEntryAdditionalDataGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleSystemsLogServicesPostCodesEntriesEntryGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
