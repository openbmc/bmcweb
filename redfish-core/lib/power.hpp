    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Chassis/<str>/Power/")
        ...
        .methods(boost::beast::http::verb::get)(
            [&app](const crow::Request& req,
                ...
                auto chassisHandler = [sensorAsyncResp](
                    ...
                    auto valueHandler =
                        [sensorAsyncResp](
                            ...
                            // PowerControl, 0, so only create the first one
                            if (tempArray.empty())
                            {
                            ...
                            // "NoAction" as default value to make it OCP
                            // Compliant.
                            ...
                            if (enabled)
                            {
                                // Redfish specification indicates PowerLimit
                                // should be null if the limit is not enabled.
                ...
                dbus::utility::getSubTreePaths("/xyz/openbmc_project/inventory",
                                               0, interfaces,
