...
inline void requestRoutesPower(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Chassis/<str>/Power/")
        ...
        BMCWEB_LOG_DEBUG("requestRoutesPower");
        ...
        auto powerHandler = [asyncResp](const boost::system::error_code& ec4,
            ...
            {
                BMCWEB_LOG_DEBUG("Power handler: found path: %s", path);
                ...
                auto powerHandler2 =
                    ...
                    {
                        BMCWEB_LOG_ERROR(
                            "unable to get power consumption value via dbus");
                    }
