                     ...
                     const std::string& powerSupplyPath)
{
    ...
    dbus::utility::getDbusObject(
        ...
        getPowerSupplyState(asyncResp, object.begin()->first, powerSupplyPath);
        getPowerSupplyHealth(asyncResp, object.begin()->first, powerSupplyPath);
        getPowerSupplyAsset(asyncResp, object.begin()->first, powerSupplyPath);
