...
void checkErrors(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                 const boost::system::error_code& ec, std::string message)
{
    ...
    {
        BMCWEB_LOG_ERROR("{} failed, Dbus error {}", message, ec);
    ...
    const boost::system::error_code& ec, double freeStorage)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetFreeStorageStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double kernelCPU)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetProcessorKernelStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double userCPU)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetProcessorUserStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double availableMemory)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetAvailableMemoryStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double bufferedAndCachedMemory)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetBufferedAndCachedMemoryStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double freeMemory)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetFreeMemoryStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double sharedMemory)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetSharedMemoryStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, double totalMemory)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetTotalMemoryStatistics");
        return;
    }
    ...
    const boost::system::error_code& ec, uint64_t bmcwebResetTime)
{
    if (ec)
    {
        checkErrors(asyncResp, ec, "afterGetManagerStartTime");
        return;
    }
