    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    collection_util::getCollectionMembers(
        ...
        chassis_utils::chassisInterfaces, "/xyz/openbmc_project/inventory");
}
    ...
    const std::string& chassisId, const std::string& chassisPath)
{
    ...
    dbus::utility::getAssociatedSubTreePaths(
        ...
        chassis_utils::chassisInterfaces,
    ...
    const std::string& chassisId)
{
    ...
    dbus::utility::getSubTree(
        "/xyz/openbmc_project/inventory", 0, chassis_utils::chassisInterfaces,
