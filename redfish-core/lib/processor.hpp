        ...
        systems_utils::getValidSystemsPath(
            ...
            [&asyncResp,
             systemName](const std::optional<std::string>& systemPath) {
                ...
                sdbusplus::message::object_path sp = systemPath.value();

                asyncResp->res.jsonValue["@odata.id"] = std::format(
                    "/redfish/v1/Systems/{}/Processors", sp.filename());

                sdbusplus::message::object_path inventorySystemPath(
                ...
                dbus::utility::getAssociatedSubTreePathsById(
                    sp.filename(), inventorySystemPath, managedHostInterface,
