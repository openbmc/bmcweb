    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath,
        ...
        [objPath, aResp{std::move(aResp)}](
            ...
            std::optional<const std::string*> serialNumber;
            std::optional<const std::string*> model;
            std::optional<const std::string*> manufacturer;
            std::optional<const std::string*> partNumber;
            std::optional<const std::string*> sparePartNumber;

            std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(
                    properties, "SerialNumber", serialNumber, "Model", model,
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath,
        ...
        [objPath, aResp{std::move(aResp)}](
            ...
            std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(properties, "Version",
                                                   version);
            ...
            json_util::assignIf(aResp->res.jsonValue, "Version", version);
        });
}
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath, "",
        [acclrtrId, aResp{std::move(aResp)}](
            ...
            std::optional<const bool*> functional;
            std::optional<const bool*> present;

            std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(
                    properties, "Functional", functional, "Present", present);
            ...
            if (functional && **functional == false)
            {
                if (state == "Enabled")
                {
                    health = "Critical";
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath,
        ...
        [aResp, cpuId, service](
            ...
            std::optional<const sdbusplus::message::object_path*> appliedConfig;
            std::optional<const bool*> baseSpeedPriorityEnabled;

            std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(
                    properties, "AppliedConfig", appliedConfig,
                    "BaseSpeedPriorityEnabled", baseSpeedPriorityEnabled);
    ...
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, objPath,
        ...
        [aResp](boost::system::error_code ec,
            ...
            std::optional<const size_t*> cores;
            std::optional<const uint32_t*> baseSpeed;
            std::optional<const uint32_t*> temp;
            std::optional<const uint32_t*> maxSpeed;
            std::optional<const uint32_t*> tdp;
            std::optional<const TurboProfileProperty*> turboList;
            std::optional<const BaseSpeedPrioritySettingsProperty*>
                baseSpeedList;

            std::optional<sdbusplus::UnpackError> error =
                sdbusplus::unpackPropertiesNoThrow(
                    properties, "AvailableCoreCount", cores, "BaseSpeed",
                    baseSpeed, "MaxJunctionTemperature", temp, "MaxSpeed",
                    maxSpeed, "PowerLimit", tdp, "TurboProfile", turboList,
            ...
            json_util::assignIf(aResp->res.jsonValue, "TotalAvailableCoreCount",
                                cores);
            json_util::assignIf(aResp->res.jsonValue, "BaseSpeedMHz",
                                baseSpeed);
            json_util::assignIf(aResp->res.jsonValue,
                                "MaxJunctionTemperatureCelsius", temp);
            json_util::assignIf(aResp->res.jsonValue, "MaxSpeedMHz", maxSpeed);
            json_util::assignIf(aResp->res.jsonValue, "TDPWatts", tdp);
            ...
            if (baseSpeedList)
            {
                ...
                {
                    baseSpeedArray.push_back({{"CoreCount", coreList.size()},
                                              {"CoreIDs", coreList},
