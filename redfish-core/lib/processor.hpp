    ...
    dbus::utility::getAllProperties(
        ...
        [acclrtrId, asyncResp{std::move(asyncResp)}](
            ...
            const bool success = sdbusplus::unpackPropertiesNoThrow(
                ...
                functional, "Present", present, "BaseSpeedInHz", baseSpeedInHz,
                "MaxSpeedInHz", maxSpeedInHz, "MinSpeedInHz", minSpeedInHz);
            ...
            json["Status"]["Health"] = health;
            json["ProcessorType"] = processor::ProcessorType::Accelerator;
