...
static std::string translateMemoryTypeToRedfish(const std::string& memoryType)
{
...
static void dimmPropToHex(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getPersistentMemoryProperties(
...
static void assembleDimmProperties(
...
static void getDimmDataByService(
...
static void assembleDimmPartitionData(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const dbus::utility::DBusPropertiesMap& properties,
...
static void getDimmPartitionData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
static void getDimmData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterGetValidDimmPath(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& dimmId, const boost::system::error_code& ec,
...
static void handleMemoryGet(App& app, const crow::Request& req,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
