    ...
    const boost::system::error_code& ec, double value)
{
    ...
    {
        BMCWEB_LOG_ERROR(
            "DBus response error on GetProperty {} for property {}", ec.value(),
            jsonPtr.to_string());
        return;
    }
    ...
    {
        BMCWEB_LOG_WARNING("Property {} is not finite", jsonPtr.to_string());
...
inline void getMetricProperty(
    ...
    const std::string& jsonPtr)
{
    dbus::utility::getProperty<double>(
        serviceName, objectPath + "/Metrics" + jsonPtr, metricInterface,
        metricProperty,
        std::bind_front(populateMetricsProperty, asyncResp,
                        nlohmann::json::json_pointer(jsonPtr)));
}

inline void handleFabicSwitchPortPathPortMetricsGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    ...
    const std::string& serviceName)
{
    ...
    asyncResp->res.jsonValue["@odata.id"] =
        std::format("/redfish/v1/Fabrics/{}/Switches/{}/Ports/{}/Metrics",
...
inline void handleFabicSwitchPortPathPortGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& fabricId, const std::string& switchId,
    ...
    [[maybe_unused]] const std::string& serviceName)
{
    ...
    asyncResp->res.jsonValue["@odata.id"] =
        std::format("/redfish/v1/Fabrics/{}/Switches/{}/Ports/{}", fabricId,
                    switchId, portId);
...
inline void afterHandleFabicSwitchPortPaths(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
inline void getFabicSwitchPortPath(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& portId,
    ...
    [[maybe_unused]] const std::string& serviceName)
{
    ...
    dbus::utility::getAssociatedSubTree(
        ...
        portInterface,
        std::bind_front(afterHandleFabicSwitchPortPaths, asyncResp, portId,
                        std::move(callback)));
}

inline void handleFabicSwitchPathPortCollection(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& fabricId, const std::string& switchId,
    const boost::system::error_code& ec,
...
inline void getFabicSwitchPortPaths(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& fabricId, const std::string& switchId,
    ...
    [[maybe_unused]] const std::string& serviceName)
{
    ...
    dbus::utility::getAssociatedSubTreePaths(
        associationPath, sdbusplus::message::object_path{inventoryPath}, 0,
        portInterface,
        std::bind_front(handleFabicSwitchPathPortCollection, asyncResp,
                        fabricId, switchId));
}
    ...
    const std::string& portId)
{
    ...
    getFabricSwitchPath(
        ...
        std::bind_front(
            getFabicSwitchPortPath, asyncResp, portId,
            std::bind_front(handleFabicSwitchPortPathPortMetricsGet, asyncResp,
                            fabricId, switchId, portId)));
}
    ...
    const std::string& portId)
{
    ...
    getFabricSwitchPath(
        ...
        std::bind_front(
            getFabicSwitchPortPath, asyncResp, portId,
            std::bind_front(handleFabicSwitchPortPathPortGet, asyncResp,
                            fabricId, switchId, portId)));
}
    ...
    const std::string& fabricId, const std::string& switchId)
{
    ...
    getFabricSwitchPath(asyncResp, fabricId, switchId,
                        std::bind_front(getFabicSwitchPortPaths, asyncResp,
                                        fabricId, switchId));
}
