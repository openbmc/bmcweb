 ...
 * @param[in] jsonKeyName - json-keyname on the assembly list output.
 * @return None.
 */
    ...
    const nlohmann::json::json_pointer& jsonKeyName)
{
    sdbusplus::asio::getProperty<std::string>(
        *crow::connections::systemBus, serviceName, assembly,
        ...
        [asyncResp, assembly, jsonKeyName](const boost::system::error_code& ec,
            ...
            asyncResp->res.jsonValue[jsonKeyName]["Location"]["PartLocation"]
                                    ["ServiceLabel"] = value;
        });
}
