...
{
    crow::connections::systemBus->async_method_call(
        [aResp, chassisPath, assemblies, setLocationIndicatorActiveFlag,
 ...
 * @return None.
 */
inline void getAssemblyEndpoints(
    const std::shared_ptr<bmcweb::AsyncResp>& aResp,
    const std::string& chassisPath, const bool& setLocationIndicatorActiveFlag,
    const std::map<std::string, bool>& locationIndicatorActiveMap)
{
 ...
 * @return None.
 */
inline void getChassis(
    const std::shared_ptr<bmcweb::AsyncResp>& aResp,
    const std::string& chassisID, const bool& setLocationIndicatorActiveFlag,
    const std::map<std::string, bool>& locationIndicatorActiveMap = {})
{
