...
{
    BMCWEB_LOG_ERROR("TEST: requestRoutesAssembly BEFORE");
    app.debugPrint();
    app.validate();
    ...
    BMCWEB_LOG_ERROR("TEST: requestRoutesAssembly AFTER");
    app.debugPrint();
    // app.validate();
}
