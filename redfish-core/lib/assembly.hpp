...
{
    crow::connections::systemBus->async_method_call(
        [aResp, chassisPath, assemblies, setLocationIndicatorActive, req](
            const boost::system::error_code ec,
                         ...
                         const crow::Request& req)
{
    ...
    // for endpoints
    crow::connections::systemBus->async_method_call(
        [aResp, chassisPath, setLocationIndicatorActive,
                             ...
                             const crow::Request& req)
{
    ...
    crow::connections::systemBus->async_method_call(
        [aResp, chassisPath, setLocationIndicatorActive, req](
            const boost::system::error_code ec,
        ...
        [aResp, chassisID, setLocationIndicatorActive,
         req](const boost::system::error_code ec,
            ...
            for (const auto& path : chassisPaths)
            {
                ...
                checkAssociation(aResp, path, setLocationIndicatorActive, req);
                return;
            }
