                              ...
                              const persistent_data::UserSession& session)
{
    ...
    res.jsonValue["@odata.type"] = schemas::sessionType;
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    asyncResp->res.jsonValue["@odata.type"] = schemas::sessionCollectionType;
...

{
    ...
    asyncResp->res.jsonValue["@odata.type"] = schemas::sessionServiceType;
