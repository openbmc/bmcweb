                        ...
                        for (auto &propertyMap : interfaceMap.second)
                        {
                            ...
                            if (propertyMap.first == "Id")
                            {
                                const uint32_t *id =
                                    sdbusplus::message::variant_ns::
                                        get_if<uint32_t>(&propertyMap.second);
                                if (id != nullptr)
                                {
                                    thisEntry["Id"] = *id;
                            ...
                            else if (propertyMap.first == "Timestamp")
                            {
                                const uint64_t *millisTimeStamp =
                                    sdbusplus::message::variant_ns::
                                        get_if<uint64_t>(&propertyMap.second);
                            ...
                            else if (propertyMap.first == "Resolved")
                            {
                                const bool *resolved =
                                    sdbusplus::message::variant_ns::
                                        get_if<bool>(&propertyMap.second);
                                if (resolved != nullptr)
                                {
...
class LogService : public Node
{
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        res.jsonValue["Id"] = "SEL"; // System Event Log
        res.jsonValue["Entries"] = {
