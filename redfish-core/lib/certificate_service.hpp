...
class CertificateActionsReplaceCertificate : public Node
{
  ...
  private:
                ...
                const std::vector<std::string> &params) override
    {
        ...
        {
            objectPath = std::string(details::httpsObjectPath) + "/" + certId;
            name = "HTTPS certificate";
        }
        else if (boost::starts_with(
                     certURI, "/redfish/v1/AccountService/LDAP/Certificates/"))
        {
            objectPath = std::string(details::ldapObjectPath) + "/" + certId;
            ...
            [asyncResp, replaceCertificate(std::move(replaceCertificate)),
             objectPath, certFile](const boost::system::error_code ec,
                ...
                crow::connections::systemBus->async_method_call(
                    ...
                    details::certReplaceIntf, "Replace",
                    certFile->getCertFilePath());
            };
        crow::connections::systemBus->async_method_call(
            std::move(getServiceName), details::mapperBusName,
            details::mapperObjectPath, details::mapperIntf, "GetObject",
                   ...
                   const std::string &csrObjPath)
{
    ...
    auto csrRead = [asyncResp, certURI](const boost::system::error_code ec,
    ...
    auto getServiceName = [asyncResp, csrRead(std::move(csrRead)),
        ...
        std::string service = resp.begin()->first;
        crow::connections::systemBus->async_method_call(
            std::move(csrRead), service, csrObjPath,
  ...
  private:
                ...
                const std::vector<std::string> &params) override
    {
        ...
        if (certURI ==
            "/redfish/v1/Managers/bmc/NetworkProtocol/HTTPS/Certificates/")
        {
            objectPath = details::httpsObjectPath;
        }
        else if (certURI == "/redfish/v1/AccountService/LDAP/Certificates/")
        {
            objectPath = details::ldapObjectPath;
        }
        else
        {
            messages::actionParameterValueFormatError(
        ...
        // Range is dependent on the algorithm type chosen, not performing any
        // basic validation.
    ...
    auto getServiceName =
        [asyncResp, getAllProperties(std::move(getAllProperties)), objectPath](
            ...
            crow::connections::systemBus->async_method_call(
                ...
                details::dbusPropIntf, "GetAll", details::certPropIntf);
        };
    crow::connections::systemBus->async_method_call(
        std::move(getServiceName), details::mapperBusName,
        details::mapperObjectPath, details::mapperIntf, "GetObject", objectPath,
  ...
  public:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        std::string certURL =
            ...
            certId;
        auto asyncResp = std::make_shared<AsyncResp>(res);
        std::string objectPath = details::httpsObjectPath;
        objectPath += "/";
        objectPath += certId;
  ...
  public:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        auto getServiceName = [asyncResp, getCertList(std::move(getCertList))](
            ...
            std::string service = resp.begin()->first;
            crow::connections::systemBus->async_method_call(
                std::move(getCertList), service, details::httpsObjectPath,
                details::dbusObjManagerIntf, "GetManagedObjects");
        };
        crow::connections::systemBus->async_method_call(
            std::move(getServiceName), details::mapperBusName,
            details::mapperObjectPath, details::mapperIntf, "GetObject",
            details::httpsObjectPath, std::array<std::string, 0>());
    }
                ...
                const std::vector<std::string> &params) override
    {
        ...
        auto installCert = [asyncResp,
            ...
            std::string name = "HTTPS Certificate";
            std::string objectPath =
                std::string(details::httpsObjectPath) + "/" + certId;
        ...
        auto getServiceName = [asyncResp, installCert(std::move(installCert)),
            ...
            std::string service = resp.begin()->first;
            crow::connections::systemBus->async_method_call(
                std::move(installCert), service, details::httpsObjectPath,
                details::certInstallIntf, "Install",
                certFile->getCertFilePath());
        };
        crow::connections::systemBus->async_method_call(
            std::move(getServiceName), details::mapperBusName,
                                    ...
                                    const std::string &path)
{
    ...
    crow::connections::systemBus->async_method_call(
        std::move(getServiceName), details::mapperBusName,
        details::mapperObjectPath, details::mapperIntf, "GetObject", path,
        std::array<std::string, 0>());
}
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        getCertificateLocations(
            asyncResp,
            "/redfish/v1/Managers/bmc/NetworkProtocol/HTTPS/Certificates/",
            details::httpsObjectPath);
        getCertificateLocations(asyncResp,
                                "/redfish/v1/AccountService/LDAP/Certificates/",
                                details::ldapObjectPath);
    }
        ...
        auto getServiceName =
            [asyncResp, getCertificateList(std::move(getCertificateList))](
                ...
                crow::connections::systemBus->async_method_call(
                    ...
                    details::ldapObjectPath, details::dbusObjManagerIntf,
                    "GetManagedObjects");
            };
        crow::connections::systemBus->async_method_call(
            std::move(getServiceName), details::mapperBusName,
            details::mapperObjectPath, details::mapperIntf, "GetObject",
            details::ldapObjectPath, std::array<std::string, 0>());
    }
                ...
                const std::vector<std::string> &params) override
    {
        ...
        auto installCertificate =
            [asyncResp, certFile](const boost::system::error_code ec) {
                ...
                std::string objectPath =
                    std::string(details::ldapObjectPath) + "/" + certId;
                getCertificateProperties(asyncResp, objectPath, certId, certURL,
                                         name);
            ...
            [asyncResp, installCertificate(std::move(installCertificate)),
             certFile](const boost::system::error_code ec,
                ...
                crow::connections::systemBus->async_method_call(
                    ...
                    details::ldapObjectPath, details::certInstallIntf,
...
class LDAPCertificate : public Node
{
  public:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        certURL += certId;
        auto asyncResp = std::make_shared<AsyncResp>(res);
        std::string objectPath = details::ldapObjectPath;
        objectPath += "/";
        objectPath += certId;
        std::string name = "LDAP Certificate";
        getCertificateProperties(asyncResp, objectPath, certId, certURL, name);
