...
class CertificateActionGenerateCSR : public Node
{
  ...
  private:
    void doPost(crow::Response &res, const crow::Request &req,
                const std::vector<std::string> &params) override
    {
        static const int MAX_KEY_BIT_LENGTH = 2048;
        ...
        std::optional<int64_t> optKeyBitLength = MAX_KEY_BIT_LENGTH;
        ...
        // check for -ve values and also is in the upper limit
        if (*optKeyBitLength < 0 || *optKeyBitLength > MAX_KEY_BIT_LENGTH)
        {
