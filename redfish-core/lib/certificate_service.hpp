    ...
    const std::string& name)
{
    ...
    crow::connections::systemBus->async_method_call(
        ...
        {
            BMCWEB_LOG_ERROR << "DBUS response error: " << ec;
            messages::resourceNotFound(asyncResp->res, "#Certificate.v1_0_0.Certificate", certId);
            return;
        }
    ...
    BMCWEB_ROUTE(
        ...
        crow::connections::systemBus->async_method_call(
            ...
            if (ec)
            {
                ...
                {
                    messages::resourceNotFound(asyncResp->res, "#Certificate.v1_0_0.Certificate", id);
                    return;
                }
                messages::internalError(asyncResp->res);
                return;
        ...
        crow::connections::systemBus->async_method_call(
            ...
            if (ec)
            {
                messages::resourceNotFound(asyncResp->res,
                                           "#Certificate.v1_0_0.Certificate", id);
                return;
            }
