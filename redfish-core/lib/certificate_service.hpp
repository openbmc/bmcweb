  ...
  public:
        ...
        Node(app, "/redfish/v1/CertificateService/")
    {
        entityPrivileges = {
            ...
            {boost::beast::http::verb::patch, {{"ConfigureComponent"}}},
            {boost::beast::http::verb::put, {{"ConfigureComponent"}}},
            {boost::beast::http::verb::delete_, {{"ConfigureComponent"}}},
            {boost::beast::http::verb::post, {{"ConfigureComponent"}}}};
    }
