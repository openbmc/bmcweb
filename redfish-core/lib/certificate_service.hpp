  ...
  public:
    ...
    CertificateFile(std::string certString)
    {
        ...
        if (dirPtr)
        {
            ...
            out << certString;
            out.close();
            BMCWEB_LOG_DEBUG << "Certificate file creation " << certificateFile;
        }
    }
    ~CertificateFile()
    {
        ...
        {
            std::remove(certificateFile.c_str());
        }
        BMCWEB_LOG_DEBUG << "Certificate file deletion " << certificateFile;
    }
