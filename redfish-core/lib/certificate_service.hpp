        ...
        crow::connections::systemBus->async_method_call(
            [asyncResp](const boost::system::error_code ec,
                ...
                crow::connections::systemBus->async_method_call(
                    ...
                    service, certs::authorityObjectPath, certs::dbusObjManagerIntf,
                    "GetManagedObjects");
            },
            certs::mapperBusName, certs::mapperObjectPath, certs::mapperIntf,
            ...
            [asyncResp, certFile](const boost::system::error_code ec,
                ...
                crow::connections::systemBus->async_method_call(
                    [asyncResp, certFile](const boost::system::error_code ec) {
                        ...
                        certURL += certId;
                        std::string objectPath =
                            std::string(certs::authorityObjectPath) + "/" + certId;
                        getCertificateProperties(asyncResp, objectPath, certId,
...
class TrustStoreCertificate : public Node
{
  public:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        objectPath += "/";
        objectPath += certId;
        getCertificateProperties(asyncResp, objectPath, certId, certURL, "TrustStore Certificate");
    }
