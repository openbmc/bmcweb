    ...
    const dbus::utility::ManagedObjectType& resp)
{
    ...
    std::ranges::sort(entriesArray, [](const nlohmann::json& left,
        ...
        return redfish::json_util::objectKeyCmp("Id", left, right);
    });
