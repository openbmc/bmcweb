...
class LogEntryCollection : public Node
{
  public:
    ...
    LogEntryCollection(CrowApp &app) :
        Node(app, "/redfish/v1/Systems/system/LogServices/Event/Entries/")
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
            {boost::beast::http::verb::head, {{"Login"}}},
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        asyncResp->res.jsonValue["@odata.context"] =
            "/redfish/v1/$metadata#LogEntryCollection.LogEntryCollection";
        asyncResp->res.jsonValue["@odata.id"] =
            "/redfish/v1/Systems/system/LogServices/Event/Entries";
        asyncResp->res.jsonValue["Description"] =
...
class LogServiceActionsClear : public Node
{
  public:
    LogServiceActionsClear(CrowApp &app) :
        Node(app, "/redfish/v1/Systems/system/LogServices/Event/Actions/"
                  "LogService.Reset")
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
...
class LogService : public Node
{
  public:
    ...
    LogService(CrowApp &app) :
        Node(app, "/redfish/v1/Systems/system/LogServices/Event/")
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
            {boost::beast::http::verb::head, {{"Login"}}},
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        res.jsonValue["Members"] = {
            {"@odata.id", "/redfish/v1/Systems/system/LogServices/Event/Entries"}};
        ...
        res.jsonValue["Actions"]["#LogService.ClearLog"]["target"] =
            "/redfish/v1/Systems/system/LogServices/Event/Actions/LogService.Reset";
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        res.jsonValue["@odata.type"] =
            "#LogServiceCollection.LogServiceCollection";
        res.jsonValue["@odata.id"] = "/redfish/v1/Systems/system/LogServices";
        res.jsonValue["@odata.context"] =
            "/redfish/v1/$metadata#LogServiceCollection.LogServiceCollection";
        ...
        logServiceArray = nlohmann::json::array();
        logServiceArray.push_back(
            {{"@odata.id", "/redfish/v1/Systems/system/LogServices/Event"}});
