    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    auto respHandler =
        ...
        {
            BMCWEB_LOG_ERROR
                << "getBMCLogServiceCollection respHandler got error " << ec;
...
inline bool setupBMCDump(crow::App& app, const crow::Request& req,
                         const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                         const std::string& dumpType)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp->res))
    ...
    if (!(dumpType == "BMC" || dumpType == "FaultLog"))
    {
...
inline void
    getBMCDumpServiceInfo(crow::App& app, const std::string& dumpType,
                          const crow::Request& req,
                          const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!setupBMCDump(app, req, asyncResp, dumpType))
    {
        return;
    }
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    asyncResp->res.jsonValue["@odata.type"] =
        "#LogEntryCollection.LogEntryCollection";
    asyncResp->res.jsonValue["@odata.id"] =
        "/redfish/v1/Managers/bmc/LogServices/" + dumpType + "/Entries";
...
inline void getBMCDumpEntry(crow::App& app, const std::string& dumpType,
                            const crow::Request& req,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& dumpId)
{
    ...
    getDumpEntryById(app, req, asyncResp, dumpId, dumpType);
}

inline void
    deleteBMCDumpEntry(crow::App& app, const std::string& dumpType,
                       const crow::Request& req,
                       const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                       const std::string& dumpId)
{
...
inline void
    createBMCDumpEntry(crow::App& app, const std::string& dumpType,
                       const crow::Request& req,
                       const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!setupBMCDump(app, req, asyncResp, dumpType))
...
inline void clearBMCDump(crow::App& app, const std::string& dumpType,
                         const crow::Request& req,
                         const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!setupBMCDump(app, req, asyncResp, dumpType))
...
inline void requestRoutesBMCDumpService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/Dump/")
        .privileges(redfish::privileges::getLogService)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(getBMCDumpServiceInfo, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpEntry(App& app)
{
    BMCWEB_ROUTE(app,
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(getBMCDumpEntry, std::ref(app), "BMC"));

    BMCWEB_ROUTE(app,
                 "/redfish/v1/Managers/bmc/LogServices/Dump/Entries/<str>/")
        .privileges(redfish::privileges::deleteLogEntry)
        .methods(boost::beast::http::verb::delete_)(
            std::bind_front(deleteBMCDumpEntry, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpEntryCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/Dump/Entries/")
        .privileges(redfish::privileges::getLogEntryCollection)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(getBMCDumpEntryCollection, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpCreate(App& app)
{
    BMCWEB_ROUTE(
        ...
        .methods(boost::beast::http::verb::post)(
            std::bind_front(createBMCDumpEntry, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpClear(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::postLogService)
        .methods(boost::beast::http::verb::post)(
            std::bind_front(clearBMCDump, std::ref(app), "BMC"));
}
...
inline void requestRoutesFaultLogDumpService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/FaultLog/")
        .privileges(redfish::privileges::getLogService)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(getBMCDumpServiceInfo, std::ref(app), "FaultLog"));
}
...
inline void requestRoutesFaultLogDumpEntry(App& app)
{
    BMCWEB_ROUTE(app,
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(getBMCDumpEntry, std::ref(app), "FaultLog"));

    BMCWEB_ROUTE(app,
                 "/redfish/v1/Managers/bmc/LogServices/FaultLog/Entries/<str>/")
        .privileges(redfish::privileges::deleteLogEntry)
        .methods(boost::beast::http::verb::delete_)(
            std::bind_front(deleteBMCDumpEntry, std::ref(app), "FaultLog"));
}
...
inline void requestRoutesFaultLogDumpEntryCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/FaultLog/Entries/")
        ...
        .methods(boost::beast::http::verb::get)(std::bind_front(
            getBMCDumpEntryCollection, std::ref(app), "FaultLog"));
}
...
inline void requestRoutesFaultLogDumpCreate(App& app)
{
    BMCWEB_ROUTE(
        app,
        "/redfish/v1/Managers/bmc/LogServices/FaultLog/Actions/LogService.CollectDiagnosticData/")
        .privileges(redfish::privileges::postLogService)
        .methods(boost::beast::http::verb::post)(
            std::bind_front(createBMCDumpEntry, std::ref(app), "FaultLog"));
}
...
inline void requestRoutesFaultLogDumpClear(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::postLogService)
        .methods(boost::beast::http::verb::post)(
            std::bind_front(clearBMCDump, std::ref(app), "FaultLog"));
}
