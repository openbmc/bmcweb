...
#include "base_message_registry.hpp"
#include "filesystem.hpp"
#include "node.hpp"
#include "openbmc_message_registry.hpp"
#include "registries.hpp"
#include "resource_event_message_registry.hpp"
...
{
    auto messageIt =
        std::lower_bound(registry.cbegin(), registry.cend(), messageKey.c_str(),
                         [](const MessageEntry lhs, const char *rhs) {
