    ...
    const sdbusplus::message::object_path& createdObjPath)
{
    ...
    crow::connections::systemBus->async_method_call(
        ...
        // Check if the created dump object has implemented Progress interface
        // to track dump completion.
        // If yes, fetch the "Status" property of the interface, modify
        // the task state accordingly.
