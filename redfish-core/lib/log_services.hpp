...
class JournalSlvNodeEventLogEntryCollection : public Node
{
  public:
    template <typename CrowApp>
    JournalSlvNodeEventLogEntryCollection(CrowApp& app) :
        Node(
            app,
...
class JournalSlvNodeEventLogEntry : public Node
{
  public:
    JournalSlvNodeEventLogEntry(CrowApp& app) :
        Node(app,
             "/redfish/v1/Systems/system/LogServices/EventLogNode<str>/Entries/"
             "<str>/",
             std::string(), std::string())
