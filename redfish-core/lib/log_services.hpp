                           ...
                           const std::string& dumpType)
{
    ...
    crow::connections::systemBus->async_method_call(
        ...
        asyncResp->res.jsonValue["@odata.type"] = logEntryCollectionType;
...
inline void requestRoutesSystemLogServiceCollection(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/LogServices/")
        ...
        asyncResp->res.jsonValue["@odata.type"] = logServiceCollectionType;
                          ...
                          nlohmann::json::object_t& logEntryJson)
{
    ...
    logEntryJson["@odata.type"] = logEntryType;
                               ...
                               nlohmann::json::object_t& bmcJournalLogEntryJson)
{
    ...
    // Fill in the log entry with the gathered data
    bmcJournalLogEntryJson["@odata.type"] = logEntryType;
                      ...
                      const std::string& logID, nlohmann::json& logEntryJson)
{
    auto getStoredLogCallback =
        ...
        logEntry["@odata.type"] = logEntryType;
        logEntry["@odata.id"] =
    ...
    const uint64_t skip = 0, const uint64_t top = 0)
{
             ...
             code : postcode)
    {
        ...
        // Format entry
        nlohmann::json::object_t bmcLogEntry;
        bmcLogEntry["@odata.type"] = logEntryType;
