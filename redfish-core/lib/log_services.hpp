...
inline void fillEventLogLogEntryFromDbusLogEntry(
    const std::string& systemName, const DbusEventLogEntry& entry,
    ...
    const dbus::utility::ManagedObjectType& resp)
{
    ...
    for (const auto& objectPath : resp)
    {
        ...
        fillEventLogLogEntryFromDbusLogEntry(systemName, *optEntry,
...
inline void afterDBusEventLogEntryGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    std::string& systemName, const std::string& entryID,
    const boost::system::error_code& ec,
    ...
    const std::string& systemName, std::string entryID)
{
    ...
    dbus::utility::getAllProperties(
        ...
        std::bind_front(afterDBusEventLogEntryGet, asyncResp, systemName,
                        entryID));
}
