...
class SystemDumpService : public Node
{
  ...
  private:
               ...
               const std::vector<std::string> &params) override
    {
        ...
        asyncResp->res.jsonValue["OverWritePolicy"] = "WrapsWhenFull";
        asyncResp->res.jsonValue["LogEntryType"] = "OEM";
        asyncResp->res.jsonValue["Entries"] = {
            {"@odata.id",
        ...
        asyncResp->res.jsonValue["Oem"]["OpenBmc"]["Actions"]["#LogService.CollectDiagnosticData"] = {
                {"target", "/redfish/v1/Systems/system/LogServices/Dump/"
                            "Actions/Oem/OpenBmc/LogService.CollectDiagnosticData"}};
    }
};
        ...
        crow::connections::systemBus->async_method_call(
            [asyncResp, entryID](const boost::system::error_code ec,
                ...
                for (auto &objectPath : resp)
                {
                    ...
                    {
                        BMCWEB_LOG_ERROR << "Can't find System Dump Entry";
                        messages::internalError(asyncResp->res);
                        return;
                    }
                    ...
                    asyncResp->res.jsonValue["Oem"]["OpenBmc"]["DiagnosticDataType"] = "OS";
                    asyncResp->res.jsonValue["Oem"]["OpenBmc"]["OEMDiagnosticDataType"] = "System";
                    asyncResp->res.jsonValue["Oem"]["OpenBmc"]["AdditionalDataSizeBytes"] =
                        size;
                    asyncResp->res.jsonValue["Oem"]["OpenBmc"]["AdditionalDataURI"] =
                        "/redfish/v1/Systems/system/LogServices/Dump/attachment/" + entryID;
                }
            },
        ...
        crow::connections::systemBus->async_method_call(
            [asyncResp,
             entryID](const boost::system::error_code ec,
                ...
                BMCWEB_LOG_ERROR << "Invalid System Dump ID";
...
class SystemDumpEntryDownload : public Node
{
  public:
    SystemDumpEntryDownload(CrowApp &app) :
        Node(app, "/redfish/v1/Systems/system/LogServices/Dump/attachment/<str>/",
             std::string())
    {
        entityPrivileges = {
            {boost::beast::http::verb::get, {{"Login"}}},
                ...
                const std::vector<std::string> &params) override
    {
        ...
        crow::connections::systemBus->async_method_call(
            [asyncResp, &req](const boost::system::error_code ec,
                ...
                BMCWEB_LOG_DEBUG << "System Dump Created. Id: " << resp;
