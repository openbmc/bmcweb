...
constexpr char const* dumpManagerIface =
    "xyz.openbmc_project.Collection.DeleteAll";
inline void handleManagersBmcLogServicesCollectionGet(
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    auto respHandler =
        ...
        {
            BMCWEB_LOG_ERROR
                << "handleManagersBmcLogServicesCollectionGet respHandler got error "
                << ec;
...
inline void requestRoutesBMCLogServiceCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/")
        ...
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleManagersBmcLogServicesCollectionGet, std::ref(app)));
}
...
inline void handleManagersBmcLogServicesDumpServiceGet(
...
inline void handleManagersBmcLogServicesDumpEntriesCollectionGet(
    crow::App& app, const std::string& dumpType, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
inline void handleManagersBmcLogServicesDumpEntryGet(
    crow::App& app, const std::string& dumpType, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
inline void handleManagersBmcLogServicesDumpEntryDelete(
    crow::App& app, const std::string& dumpType, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& dumpId)
{
...
inline void handleManagersBmcLogServicesDumpCollectDiagnosticDataPost(
    crow::App& app, const std::string& dumpType, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
inline void handleManagersBmcLogServicesDumpClearLogPost(
    crow::App& app, const std::string& dumpType, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
inline void requestRoutesBMCDumpService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/Dump/")
        .privileges(redfish::privileges::getLogService)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleManagersBmcLogServicesDumpServiceGet, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpEntryCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/Dump/Entries/")
        .privileges(redfish::privileges::getLogEntryCollection)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleManagersBmcLogServicesDumpEntriesCollectionGet, std::ref(app),
            "BMC"));
}
...
inline void requestRoutesBMCDumpEntry(App& app)
{
    BMCWEB_ROUTE(app,
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleManagersBmcLogServicesDumpEntryGet, std::ref(app), "BMC"));

    BMCWEB_ROUTE(app,
                 "/redfish/v1/Managers/bmc/LogServices/Dump/Entries/<str>/")
        .privileges(redfish::privileges::deleteLogEntry)
        .methods(boost::beast::http::verb::delete_)(std::bind_front(
            handleManagersBmcLogServicesDumpEntryDelete, std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpCreate(App& app)
{
    BMCWEB_ROUTE(
        ...
        .methods(boost::beast::http::verb::post)(std::bind_front(
            handleManagersBmcLogServicesDumpCollectDiagnosticDataPost,
            std::ref(app), "BMC"));
}
...
inline void requestRoutesBMCDumpClear(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::postLogService)
        .methods(boost::beast::http::verb::post)(
            std::bind_front(handleManagersBmcLogServicesDumpClearLogPost,
                            std::ref(app), "BMC"));
}
...
inline void requestRoutesFaultLogDumpService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Managers/bmc/LogServices/FaultLog/")
        .privileges(redfish::privileges::getLogService)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(handleManagersBmcLogServicesDumpServiceGet,
...
inline void requestRoutesFaultLogDumpEntry(App& app)
{
    BMCWEB_ROUTE(app,
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(handleManagersBmcLogServicesDumpEntryGet,
                            std::ref(app), "FaultLog"));
    ...
    BMCWEB_ROUTE(app,
        ...
        .privileges(redfish::privileges::deleteLogEntry)
        .methods(boost::beast::http::verb::delete_)(
            std::bind_front(handleManagersBmcLogServicesDumpEntryDelete,
                            std::ref(app), "FaultLog"));
}
