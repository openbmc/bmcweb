...
inline void handlePostCodeLogService(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
...
inline void handleSystemsLogServices(
    ...
    const std::string& systemName)
{
    ...
    dbus::utility::getSubTreePaths(
        "/", 0, interfaces,
        std::bind_front(handlePostCodeLogService, asyncResp));
}

inline void handleSystemsLogServicesEventLog(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void handleSystemsLogServicesEventLogEntries(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void handleSystemsLogServicesEventLogEntriesEntryGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName, const std::string& entryId)
{
...
inline void handleSystemsLogServicesEventLogEntriesEntryPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName, const std::string& entryId)
{
...
inline void handleSystemsLogServicesEventLogEntriesEntryDelete(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName, const std::string& entryId)
{
...
inline void handleSystemLogServiceCrashDump(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void handleSystemLogServiceCrashDumpClearLog(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void getStoredLogCallback(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      ...
                      const std::string& logID, nlohmann::json& logEntryJson)
{
    dbus::utility::getAllProperties(
        ...
        crashdumpInterface,
        std::bind_front(getStoredLogCallback, asyncResp, logID,
                        std::ref(logEntryJson)));
}

inline void afterGetCrashdumpPaths(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec, const std::vector<std::string>& resp)
{
    ...
    asyncResp->res.jsonValue["Description"] = "Collection of Crashdump Entries";
...
inline void handleSystemLogServiceCrashDumpEntries(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
    ...
    dbus::utility::getSubTreePaths(
        "/", 0, interfaces, std::bind_front(afterGetCrashdumpPaths, asyncResp));
}

inline void handleSystemsLogServicesCrashdumpEntry(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
inline void getStoredLogCallbackAttachment(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
        ...
        resp)
{
    ...
    parseCrashdumpParameters(resp, dbusFilename, dbusTimestamp, dbusFilepath);

    if (dbusFilename.empty() || dbusTimestamp.empty() || dbusFilepath.empty())
    {
        messages::resourceNotFound(asyncResp->res, "LogEntry", logID);
        return;
    }
    ...
    if (asyncResp->res.openFile(dbusFilepath) != crow::OpenCode::Success)
    {
        messages::resourceNotFound(asyncResp->res, "LogEntry", logID);
        return;
    }
...
inline void handleSystemsLogServicesCrashdumpEntriesEntry(
    ...
    const std::string& fileName)
{
    ...
    dbus::utility::getAllProperties(
        *crow::connections::systemBus, crashdumpObject,
        ...
        std::bind_front(getStoredLogCallbackAttachment, asyncResp, logID,
                        fileName));
}
...
inline void collectCrashdumpCallback(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    task::Payload&& payload, const std::string& taskMatchStr,
    const boost::system::error_code& ec, const std::string& /*path*/)
{
    if (ec)
    {
...
inline void handleSystemsLogServicesCrashdumpCollectDiagnosticData(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
    ...
    crow::connections::systemBus->async_method_call(
        [asyncResp, payload(task::Payload(req)),
         taskMatchStr](const boost::system::error_code& ec,
            ...
            collectCrashdumpCallback(asyncResp, std::move(payload),
                                     taskMatchStr, ec, path);
        },
...
inline void handleSystemsLogServicesEventLogActionsClearLog(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
inline void requestRoutesDBusEventLogEntryCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/LogServices/EventLog/Entries/")
        .privileges(redfish::privileges::getLogEntryCollection)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleSystemsLogServicesEventLogEntries, std::ref(app)));
}
...
inline void requestRoutesDBusEventLogEntry(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleSystemsLogServicesEventLogEntriesEntryGet, std::ref(app)));

    BMCWEB_ROUTE(
        app, "/redfish/v1/Systems/<str>/LogServices/EventLog/Entries/<str>/")
        .privileges(redfish::privileges::patchLogEntry)
        .methods(boost::beast::http::verb::patch)(std::bind_front(
            handleSystemsLogServicesEventLogEntriesEntryPatch, std::ref(app)));
    ...
    BMCWEB_ROUTE(
        ...
        .methods(boost::beast::http::verb::delete_)(std::bind_front(
            handleSystemsLogServicesEventLogEntriesEntryDelete, std::ref(app)));
}
...
inline void requestRoutesCrashdumpService(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/LogServices/Crashdump/")
        ...
        .methods(boost::beast::http::verb::get)(
            std::bind_front(handleSystemLogServiceCrashDump, std::ref(app)));
}
...
inline void requestRoutesCrashdumpClear(App& app)
{
    BMCWEB_ROUTE(
        ...
        .privileges({{"ConfigureComponents"}})
        .methods(boost::beast::http::verb::post)(std::bind_front(
            handleSystemLogServiceCrashDumpClearLog, std::ref(app)));
}
...
inline void requestRoutesCrashdumpEntryCollection(App& app)
{
    ...
    BMCWEB_ROUTE(app,
        ...
        .privileges({{"ConfigureComponents"}})
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleSystemLogServiceCrashDumpEntries, std::ref(app)));
}
...
inline void requestRoutesCrashdumpEntry(App& app)
{
    ...
    BMCWEB_ROUTE(
        ...
        .privileges({{"ConfigureComponents"}})
        .methods(boost::beast::http::verb::get)(std::bind_front(
            handleSystemsLogServicesCrashdumpEntry, std::ref(app)));
}
...
inline void requestRoutesCrashdumpCollect(App& app)
{
    ...
    BMCWEB_ROUTE(
        ...
        .privileges({{"ConfigureComponents"}})
        .methods(boost::beast::http::verb::post)(std::bind_front(
            handleSystemsLogServicesCrashdumpCollectDiagnosticData,
            std::ref(app)));
}
...
inline void requestRoutesEventLogService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/LogServices/EventLog/")
        .privileges(redfish::privileges::getLogService)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(handleSystemsLogServicesEventLog, std::ref(app)));
}
...
inline void requestRoutesSystemLogServiceCollection(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Systems/<str>/LogServices/")
        .privileges(redfish::privileges::getLogServiceCollection)
        .methods(boost::beast::http::verb::get)(
            std::bind_front(handleSystemsLogServices, std::ref(app)));
}
...
inline void requestRoutesCrashdumpFile(App& app)
{
    ...
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::getLogEntry)
        .methods(boost::beast::http::verb::get)(
            handleSystemsLogServicesCrashdumpEntriesEntry);
}
...
inline void requestRoutesDBusLogServiceActionsClear(App& app)
{
    ...
    BMCWEB_ROUTE(
        ...
        .privileges(redfish::privileges::postLogService)
        .methods(boost::beast::http::verb::post)(std::bind_front(
            handleSystemsLogServicesEventLogActionsClearLog, std::ref(app)));
}
