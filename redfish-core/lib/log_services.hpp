    ...
    for (const auto& interfaceMap : object.second)
    {
                 ...
                 "xyz.openbmc_project.Common.OriginatedBy")
        {
            for (const auto& propertyMap : interfaceMap.second)
            {
                ...
                if (propertyMap.first == "OriginatorTypes")
                {
                    ...
                    if (*type == "xyz.openbmc_project.Common.OriginatedBy.OriginatorTypes.Client")
                    {
                        originatorType = "Client";
                    }
                    else if (*type == "xyz.openbmc_project.Common.OriginatedBy.OriginatorTypes.Internal")
                    {
                        originatorType = "Internal";
                    }
                    else if (*type == "xyz.openbmc_project.Common.OriginatedBy.OriginatorTypes.SupportingService")
                    {
