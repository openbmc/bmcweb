...
inline std::string getDumpEntryPath(const std::string& dumpPath)
{
    ...
    {
        return "/redfish/v1/Systems/system/LogServices/Dump/Entries/System_";
    }
    if (dumpPath == "/xyz/openbmc_project/dump/resource/entry")
    {
        return "/redfish/v1/Systems/system/LogServices/Dump/Entries/Resource_";
    }
    return "";
}
