...
inline void getStorageControllerLocation(
    ...
    std::string_view service, std::span<const std::string> interfaces,
    size_t index)
{
        ...
        *crow::connections::systemBus, "xyz.openbmc_project.ObjectMapper",
        ...
        [asyncResp, storageId, subtree,
         health](const boost::system::error_code ec,
            ...
            std::unordered_map<
                std::string_view,
                std::pair<std::string_view, std::span<const std::string>>>
            ...
            for (const std::string& storageController : storageControllerList)
            {
                ...
                const std::string& service =
                    storageControllerService->second.first.data();
