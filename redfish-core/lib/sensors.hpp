                                      ...
                                      const std::string& chassisId)
{
    ...
    crow::utility::setFragment(url, "/PowerSupplies"_json_pointer);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        boost::urls::url url = crow::utility::urlFromPieces(
                            ...
                            sensorsAsyncResp->chassisId,
                            sensorsAsyncResp->chassisSubNode);
                        // TODO(wltu): Fix this before continuing this.
                        crow::utility::setFragment(url, "/"_json_pointer /
                                                            fieldName / "/");
