    ...
    nlohmann::json& sensorJson, InventoryItem* inventoryItem)
{
    ...
    struct PropertyJsonPair
    {
        ...
        std::string_view jsonPathToSet;
        PropertyJsonPair(std::string_view propertyNameIn,
                         std::string_view jsonPathToSetIn) :
            propertyName(propertyNameIn),
            jsonPathToSet(jsonPathToSetIn)
        {}
    };
    ...
    for (const PropertyJsonPair& p : properties)
    {
        ...
        nlohmann::json::json_pointer key(std::string(p.jsonPathToSet));
