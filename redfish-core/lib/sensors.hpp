...
using sensorPair = std::pair<std::string_view, std::span<const std::string_view>>;
static constexpr std::array<sensorPair, 3> paths = {
    {{node::power, std::span<const std::string_view>(dbus::powerPaths)},
     {node::sensors, std::span<const std::string_view>(dbus::sensorPaths)},
     {node::thermal, std::span<const std::string_view>(dbus::thermalPaths)}}};
