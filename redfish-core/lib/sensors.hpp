...
void overrideSensor(
    std::shared_ptr<SensorsAsyncResp> SensorsAsyncResp,
    const std::shared_ptr<std::map<std::string, std::string>> sensorData,
    std::shared_ptr<std::map<std::string, std::pair<double, std::string>>>
        overrideMap)
{
...
void getSensorsForChassisElement(
    ...
    const std::vector<std::pair<
        ...
        std::vector<std::pair<std::string, std::vector<std::string>>>>>&
        allSensors,
    const std::shared_ptr<std::map<std::string, std::string>> nodeSensors,
    const std::shared_ptr<boost::container::flat_set<std::string>>
        sensorGroupList)
{
            ...
            crow::connections::systemBus->async_method_call(
                [SensorsAsyncResp, culledSensorList, overrideMap](
                    ...
                    const std::shared_ptr<std::map<std::string, std::string>>
                        nodeSensorsList = std::make_shared<
                       ...
                       const std::string& chassisSubNode)
{
    ...
    std::shared_ptr<std::map<std::string, std::pair<double, std::string>>>
        overrideMap = std::make_shared<
            std::map<std::string, std::pair<double, std::string>>>();
    std::string memberId;
    double value;
