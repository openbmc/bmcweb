        ...
        crow::connections::systemBus->async_method_call(
            [asyncResp, excludeSensors](const boost::system::error_code ec,
                         ...
                         object : subtree)
                {
                    ...
                    {
                        BMCWEB_LOG_DEBUG << "Sensor excluded: " << object.first;
                        continue;
                    }
            ...
            [asyncResp, sensorName](const boost::system::error_code ec,
                ...
                auto it = std::find_if(
                    ...
                    [sensorName](
                        const std::pair<
                            ...
                            object) {
                        std::string sensor = object.first;
                        std::size_t lastPos = sensor.rfind("/");
                        if (lastPos == std::string::npos)
                        {
                ...
                crow::connections::systemBus->async_method_call(
                    [sensorName, sensorPath, asyncResp](
                        ...
                        asyncResp->res.jsonValue["Thresholds"]["UpperCritical"] =
                            {{{"Reading", *critHigh}}};
                        asyncResp->res.jsonValue["Thresholds"]["LowerCritical"] =
                            {{{"Reading", *critLow}}};
                        asyncResp->res.jsonValue["Thresholds"]["UpperCaution"] =
                            {{{"Reading", *warnHigh}}};
                        asyncResp->res.jsonValue["Thresholds"]["LowerCaution"] =
                            {{{"Reading", *warnLow}}};
                    },
