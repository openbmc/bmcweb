...
/**
 * @brief Checks whether the specified sensor is one of the types requested in
 * SensorsAsyncResp.
...
/**
 * @brief Finds all DBus sensor names asynchronously.  Invokes callback when
 * sensor names have been obtained.
 *
...
/**
 * @brief Finds all DBus object paths that implement ObjectManager.  Creates a
 * mapping from the associated connection name to the object path.
 *
...
/**
 * @brief Gets the values of the specified sensors.  Stores the results as JSON
 * in the SensorsAsyncResp.
 *
