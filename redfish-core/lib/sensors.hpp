...
inline void handlePowerMetricGet(std::shared_ptr<SensorsAsyncResp>& sensorsAsyncResp,
                     const boost::system::error_code& ec,
                     const dbus::utility::MapperGetSubTreeResponse& subtree){
    if (ec)
    {
    ...
    const std::shared_ptr<SensorsAsyncResp>& sensorsAsyncResp)
{
    ...
    dbus::utility::getSubTree("/xyz/openbmc_project/Power", 0, powerMetricIfaces,
