    ...
    const GetSubTreeType& subtree, Callback&& callback)
{
    ...
    {
        respHandler(boost::system::error_code{}, subtree);
    }
    ...
    const GetSubTreeType& subtree, Callback&& callback)
{
    ...
    getObjectsWithConnection(sensorsAsyncResp, sensorNames, subtree,
    ...
    const GetSubTreeType& subtree)
{
    ...
    getConnections(sensorsAsyncResp, sensorNames, subtree,
    ...
    getChassisData(const std::shared_ptr<SensorsAsyncResp>& sensorsAsyncResp)
{
    ...
    auto getChassisCb =
        [sensorsAsyncResp](
            ...
            processSensorList(sensorsAsyncResp, sensorNames, GetSubTreeType{});
        ...
        allCollections)
{
    ...
    auto getChassisSensorListCb = [sensorAsyncResp, overrideMap](
        ...
        getObjectsWithConnection(sensorAsyncResp, sensorNames, GetSubTreeType{},
