    ...
    nlohmann::json& sensorJson, InventoryItem* inventoryItem)
{
    ...
    if (chassisSubNode == sensors::node::sensors)
    {
        sensorJson["@odata.type"] = schemas::sensorType;
    ...
    else if (sensorType == "temperature")
    {
        ...
        sensorJson["@odata.type"] = schemas::thermalType;
    ...
    else if (sensorType == "voltage")
    {
        ...
        sensorJson["@odata.type"] = schemas::powerType;
    }
    else if (sensorType == "power")
    {
                ...
                *crow::connections::systemBus,
                ...
                sdbusplus::asio::getAllProperties(
                    *crow::connections::systemBus, owner, path,
                    ...
                    redundancy["@odata.type"] = schemas::redundancyType;
