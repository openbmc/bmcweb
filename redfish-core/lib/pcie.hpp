...
inline void fillPCIeDeviceProperties(
    crow::Response& resp, const std::string& ,
...
inline void
    getPCIeDeviceProperties(const std::shared_ptr<bmcweb::AsyncResp>& aResp,
                            ...
                            const std::string& pcieDeviceId)
{
    sdbusplus::asio::getAllProperties(
        *crow::connections::systemBus, service, pcieDevicePath,
        ...
        fillPCIeDeviceProperties(aResp->res, pcieDeviceId, pcieDevProperties);
        });
}
                                ...
                                const std::string& pcieDeviceId)
{
    ...
    getPCIeDevicePath(pcieDeviceId, aResp,
        ...
        getPCIeDeviceProperties(aResp, pcieDevicePath, service, pcieDeviceId);
    });
}
