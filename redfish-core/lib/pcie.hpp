...
static constexpr char const *peciPCIeObject = "com.intel.PCIe";
static constexpr char const *peciPCIePath = "/com/intel/PCIe";
static constexpr char const *peciPCIeDeviceInterface = "com.intel.PCIe.Device";
static constexpr char const *peciPCIeGetMapInterface = "com.intel.PCIe.GetMap";
        ...
        auto getPCIeDeviceCallback =
            [asyncResp, name,
             device](const boost::system::error_code ec,
                ...
                nlohmann::json links;
                nlohmann::json &pcieFunctionList = links["PCIeFunctions"];
