...
inline void
    addSubscriptionDBusSNMPClient(const std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                           ...
                           const std::string& id)
{
    ...
    size_t lastIndex = id.find_last_not_of("0123456789");
    std::string dbusId = id.substr(lastIndex + 1);
