                      ...
                      const std::string& id)
{
    crow::connections::systemBus->async_method_call(
        [asyncResp, id](const boost::system::error_code ec,
            ...
            // Set the default response to resourceNotFound. If a matching
            // snmp client id is found, it will be cleared.
            ...
            for (const auto& objpath : resp)
            {
                ...
                // A matching snmpid has been found, clear resourceNotFound.
                asyncResp->res.clear();
                ...
                crow::connections::systemBus->async_method_call(
                    [asyncResp](
                        ...
                        const std::vector<std::pair<
                            std::string, std::variant<std::string, uint16_t>>>&
                            propertiesList) {
                        if (ec2)
                        {
                            BMCWEB_LOG_ERROR
                    ...
                    "xyz.openbmc_project.Network.SNMP", objpath.first,
