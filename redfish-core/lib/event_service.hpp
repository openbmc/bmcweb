...
inline void requestRoutesEventService(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/EventService/")
        ...
        asyncResp->res.jsonValue["@odata.type"] = schemas::eventServiceType;
...
inline void requestRoutesEventDestinationCollection(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/EventService/Subscriptions/")
        ...
        asyncResp->res.jsonValue["@odata.type"] =
            schemas::eventDestinationCollectionType;
...
inline void requestRoutesEventDestination(App& app)
{
    BMCWEB_ROUTE(app, "/redfish/v1/EventService/Subscriptions/<str>/")
        ...
        asyncResp->res.jsonValue["@odata.type"] = schemas::eventDestinationType;
