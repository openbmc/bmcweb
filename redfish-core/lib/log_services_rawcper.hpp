...
// which links here 1:1 by entry Id via Links/RelatedLogEntries; the raw entry
// deliberately does not link back, to avoid a $expand cycle.
    ...
    const dbus::utility::ManagedObjectType& resp)
{
    ...
    for (const auto& objectPath : resp)
    {
        ...
        // xyz.openbmc_project.Logging.CPERRaw interface on the entry object;
    ...
    const dbus::utility::DBusPropertiesMap& resp)
{
    ...
    // Membership is signalled by the xyz.openbmc_project.Logging.CPERRaw
