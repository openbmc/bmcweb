...
using DimmProperties = boost::container::flat_map<
    std::string,
                                   ...
                                   const DimmProperties& properties)
{
    for (const auto& property : properties)
    {
        ...
        {
            aResp->res.jsonValue["ModuleManufacturerID"] = property.second;
        }
        ...
        {
            aResp->res.jsonValue["SubsystemVendorID"] = property.second;
        }
        else if (property.first == "SubsystemDeviceID")
        {
            aResp->res.jsonValue["SubsystemDeviceID"] = property.second;
        }
        ...
        {
            aResp->res.jsonValue["PmRegionNumberLimit"] = property.second;
        }
