 ...
 * @return None.
 */
static void getStorageLink(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void getChassisState(std::shared_ptr<bmcweb::AsyncResp> asyncResp)
{
 ...
 */
static void handlePhysicalSecurityGetSubTree(
...
static void handleChassisCollectionGet(
...
static void getChassisContainedBy(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getChassisContains(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId, const boost::system::error_code& ec,
...
static void getChassisConnectivity(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getChassisLocationCode(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getChassisUUID(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleDecoratorAssetProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleChassisGetSubTree(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId, const boost::system::error_code& ec,
    const dbus::utility::MapperGetSubTreeResponse& subtree)
{
...
static void handleChassisPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void doChassisPowerCycle(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void handleChassisResetActionInfoPost(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& /*chassisId*/)
{
