...
static bool handleCreateTask(const boost::system::error_code& ec2,
...
static void createTask(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void softwareInterfaceAdded(
...
static void afterAvailbleTimerAsyncWait(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec)
{
    cleanUp();
...
static void handleUpdateErrorType(
...
static void afterUpdateErrorMatcher(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp, const std::string& url,
...
static void doHttpsUpdate(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleUpdateServiceSimpleUpdateAction(
...
static void uploadImageFile(crow::Response& res, std::string_view body)
{
...
static bool convertApplyTime(crow::Response& res, const std::string& applyTime,
...
static std::optional<std::string> processUrl(
...
static std::optional<std::string> parseFormPartName(
...
static std::optional<MultiPartUpdate::UpdateParameters> processUpdateParameters(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static std::optional<MultiPartUpdate> extractMultipartUpdateParameters(
...
static void getSwInfo(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void updateMultipartContext(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void doHTTPUpdate(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleUpdateServicePost(
...
static void handleUpdateServiceMultipartUpdatePost(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleUpdateServiceGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleUpdateServiceFirmwareInventoryCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void getSoftwareVersion(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleUpdateServiceFirmwareInventoryGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
