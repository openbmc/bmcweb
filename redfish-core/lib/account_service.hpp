                         ...
                         const LDAPConfigData& confData)
{
    ...
    json_response[serverType]["AccountProviderType"] = "LDAPService";
    json_response[serverType]["ServiceEnabled"] = "true";

    nlohmann::json& uri_array = json_response[serverType]["ServiceAddress"];
    uri_array = nlohmann::json::array();
    uri_array.push_back(confData.uri);

    json_response[serverType]["Authentication"]["AuthenticationType"] =
        "UsernameAndPassword";
    json_response[serverType]["Authentication"]["Username"] = confData.bindDN;
    json_response[serverType]["Authentication"]["Password"] = "";

    nlohmann::json& base_array =
        json_response[serverType]["LDAPService"]["SearchSettings"]
    ...
    nlohmann::json& role_array = json_response[serverType]["RemoteRoleMapping"];
