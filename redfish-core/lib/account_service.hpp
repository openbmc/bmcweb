...
inline void handleLDAPPatch(
    ...
    std::optional<std::string> authType, std::optional<std::string> userName,
        ...
        .methods(boost::beast::http::verb::patch)(
            [](const crow::Request& req,
               const std::shared_ptr<bmcweb::AsyncResp>& asyncResp) -> void {
                ...
                handleLDAPPatch(ldapServiceAddressList, ldapServiceEnabled,
                                ldapBaseDNList, ldapUserNameAttribute,
                                ldapGroupsAttribute, ldapAuthType, ldapUserName,
                                ldapPassword, ldapRemoteRoleMap, asyncResp,
                                "LDAP");

                handleLDAPPatch(adServiceAddressList, adServiceEnabled,
                                adBaseDNList, adUserNameAttribute,
                                adGroupsAttribute, adAuthType, adUserName,
                                adPassword, adRemoteRoleMap, asyncResp,
                                "ActiveDirectory");
