...
inline void requestAccountServiceRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/")
        .privileges(accountServiceGetPrivilege)
        .methods(
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/Accounts/")
        .privileges(managerAccountCollectionGetPrivilege)
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/Accounts/")
        .privileges(managerAccountCollectionPostPrivilege)
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/Accounts/<str>/")
        .privileges(managerAccountGetPrivilege)
        .methods(
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/Accounts/<str>/")
        .privileges(managerAccountPatchPrivilege)
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/Accounts/<str>/")
        .privileges(managerAccountDeletePrivilege)
