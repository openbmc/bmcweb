...
{
    setDbusProperty(
        asyncResp, "PasswordChangeRequired", "xyz.openbmc_project.User.Manager",
        sdbusplus::object_path(dbusObjectPath),
        "xyz.openbmc_project.User.Attributes", "UserPasswordExpired", true);
}
