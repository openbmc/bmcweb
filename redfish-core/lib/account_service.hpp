...
inline void requestAccountServiceRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/AccountService/")
        ...
        .methods(boost::beast::http::verb::get)([&app](const crow::Request& req,
            ...
            json["AuthMethods"]["BasicAuth"] = authMethodsConfig.basic;
            json["AuthMethods"]["SessionToken"] =
                authMethodsConfig.sessionToken;
            json["AuthMethods"]["XToken"] = authMethodsConfig.xtoken;
            json["AuthMethods"]["Cookie"] = authMethodsConfig.cookie;
            json["AuthMethods"]["TLS"] = authMethodsConfig.tls;
