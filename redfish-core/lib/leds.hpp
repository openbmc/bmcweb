                 ...
                 const std::string& owner, const std::string& ledPath)
{
    ...
    crow::connections::systemBus->async_method_call(
                                  ...
                                  uint8_t>>& ret)
        {
            ...
            nlohmann::json* json_ptr = sensorEntry.get();
            if (state == nullptr)
            {
            ...
            {
                (*json_ptr)["IndicatorLed"] = "Lit";
            }
            else if (boost::ends_with(*state, "Blink"))
            {
                (*json_ptr)["IndicatorLed"] = "Blinking";
            }
            else if(boost::ends_with(*state, "Off"))
            {
                (*json_ptr)["IndicatorLed"] = "Off";
            }
            else
            {
                (*json_ptr)["IndicatorLed"] = "Unknown";
            }
                    ...
                    const std::string& sensorPath, std::shared_ptr<nlohmann::json> sensorEntry)
{
    ...
    crow::connections::systemBus->async_method_call(
                                ...
                                variantEndpoints)
        {
            ...
            //nlohmann::json* json_ptr = sensorEntry.get();
            //(*json_ptr)["IndicatorLed"] = "Lit";
            //sensorEntry.get()["IndicatorLED"] = "Lit"; //Crashes here
            ...
            crow::connections::systemBus->async_method_call(
                                        ...
                                        variantEndpoints)
                {
                    ...
                    crow::connections::systemBus->async_method_call(
                        [aResp, endpoint, sensorEntry, sensorPath]
