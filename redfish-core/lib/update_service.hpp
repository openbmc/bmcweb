               ...
               const std::string& swId) {
                ...
                crow::connections::systemBus->async_method_call(
                    [asyncResp, swId, writeProtected](
                        ...
                        auto foundFirmwareWithMatchingSwId = std::find_if(
                        ...
                        if (foundFirmwareWithMatchingSwId == subtree.end())
                        {
                        ...
                        crow::connections::systemBus->async_method_call(
                            ...
                            foundFirmwareWithMatchingSwId->second[0].first,
                            foundFirmwareWithMatchingSwId->first,
                            "org.freedesktop.DBus.Properties", "Set",
