...
inline void requestRoutesSoftwareInventory(App& app)
{
        ...
        crow::connections::systemBus->async_method_call(
                     ...
                     obj : subtree)
            {
                ...
                getSoftwareVersion(asyncResp, obj.second[0].first, obj.first,
                                   *swId);
                sw_util::getSoftwareSettings(asyncResp, obj.second[0].first, obj.first);
            }
            if (!found)
            {
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/UpdateService/FirmwareInventory/<str>/")
        ...
        crow::connections::systemBus->async_method_call(
            ...
            BMCWEB_LOG_DEBUG << "Patching FirmwareInventory with .WriteProtected.";
                     ...
                     obj : subtree)
            {
                ...
                setWriteProtected(asyncResp, obj.second[0].first,
                                  obj.first, writeProtected);
                return;
            }
