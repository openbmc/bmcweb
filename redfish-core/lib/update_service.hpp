    ...
    const dbus::utility::MapperGetSubTreePathsResponse& managedHostPaths)
{
    ...
    {
        if (std::find(managedHostPaths.begin(), managedHostPaths.end(),
                      assocPath) != managedHostPaths.end())
        {
