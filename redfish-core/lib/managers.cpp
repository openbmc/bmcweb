...
static void handleSetLocationIndicatorActive(
 ...
 */
static void setLocationIndicatorActiveState(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    bool locationIndicatorActive, const std::string& managerId)
{
...
static std::string getBMCUpdateServiceName()
{
...
static std::string getBMCUpdateServicePath()
{
    if constexpr (BMCWEB_REDFISH_UPDATESERVICE_USE_DBUS)
    {
 ...
 * @return none
 */
static void getLocation(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void managerGetLastResetTime(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return void
 */
static void setActiveFirmwareImage(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void setDateTime(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getManagerData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterGetManagerObject(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
