    ...
    const registries::Header& header)
{
    ...
    for (const char* privilegeItem :
         registries::privilege_registry::privilegeUsed)
    {
    ...
    for (const auto& entity : registries::privilege_registry::oemEntities)
    {
    ...
    for (const auto& entity : registries::privilege_registry::entities)
    {
        std::string entityName = entity.first;
        const auto& operationMaps = entity.second;
    ...
    const std::string& registry)
{
    ...
    const registries::Header& privilegeHeader =
        registries::privilege_registry::header;
    const char* privilegeUrl = registries::privilege_registry::url;
