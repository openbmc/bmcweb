 ...
 * @return None.
 */
static void modifyCpuPresenceState(
...
static void getProcessorProperties(
 ...
 * @return None.
 */
static void getProcessorSummary(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void processMemoryProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const dbus::utility::DBusPropertiesMap& properties)
{
...
static void afterGetUUID(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterSystemGetSubTree(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
 ...
 * @return None.
 */
static void getHostState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * cannot be done, returns an empty string.
 */
static std::string dbusToRfBootType(const std::string& dbusType)
{
 ...
 */
static std::string dbusToRfBootProgress(const std::string& dbusBootProgress)
{
 ...
 * @return None.
 */
static void getBootProgress(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    dbus::utility::getProperty<std::string>(
        "xyz.openbmc_project.State.Host", "/xyz/openbmc_project/state/host0",
 ...
 * @return None.
 */
static void getBootProgressLastStateTime(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void getBootOverrideType(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    dbus::utility::getProperty<std::string>(
...
static void getBootOverrideMode(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    dbus::utility::getProperty<std::string>(
        "xyz.openbmc_project.Settings",
...
static void getBootOverrideSource(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    dbus::utility::getProperty<std::string>(
        "xyz.openbmc_project.Settings",
...
static void processBootOverrideEnable(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getBootOverrideEnable(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    dbus::utility::getProperty<bool>(
        "xyz.openbmc_project.Settings",
 ...
 * @return None.
 */
static void getAutomaticRebootAttempts(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
static void getAutomaticRetryPolicy(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    BMCWEB_LOG_DEBUG("Get Automatic Retry policy");
...
static void setAutomaticRetryAttempts(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static computer_system::PowerRestorePolicyTypes
 ...
 * @return None.
 */
static void getPowerRestorePolicy(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
static void getStopBootOnFault(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
static void getTrustedModuleRequiredToBoot(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
static void setTrustedModuleRequiredToBoot(
 ...
 * @return Integer error code.
 */
static void setBootType(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return Integer error code.
 */
static void setBootEnable(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return Integer error code.
 */
static void setBootModeOrSource(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void setAssetTag(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
static std::optional<bool> validstopBootOnFault(
 ...
 * @return None.
 */
static void setStopBootOnFault(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static std::string dbusPowerRestorePolicyFromRedfish(std::string_view policy)
{
    if (policy == "AlwaysOn")
    {
 ...
 * @return None.
 */
static void setPowerRestorePolicy(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
static computer_system::PowerMode translatePowerModeString(
 ...
 * @return None.
 */
static void getPowerMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 */
static std::string validatePowerMode(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void setPowerMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
static void getHostWatchdogTimer(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 */
static bool parseIpsProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const dbus::utility::DBusPropertiesMap& properties)
{
    const bool* enabled = nullptr;
...
static void handleComputerSystemCollectionHead(
...
static void handleComputerSystemCollectionGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
 ...
 */
static void doNMI(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void handleComputerSystemResetActionPost(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleComputerSystemHead(
...
static void handleComputerSystemGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
static void handleComputerSystemPatch(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
static void handleSystemCollectionResetActionHead(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& /*systemName*/)
{
 ...
 * allowableValues.
 */
static void dbusToRfAllowedHostTransitions(
...
static void handleSystemCollectionResetActionGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
