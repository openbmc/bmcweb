...
static bool getHostLoggerFiles(
...
static bool getHostLoggerEntries(
...
static void fillHostLoggerEntryJson(std::string_view logEntryID,
                                    std::string_view msg,
...
static void handleSystemsLogServicesHostloggerGet(
...
static void handleSystemsLogServicesHostloggerEntriesGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
static void handleSystemsLogServicesHostloggerEntriesEntryGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
