...
static std::string getPrivilegeFromRoleId(std::string_view role)
{
 ...
 */
static bool translateUserGroup(const std::vector<std::string>& userGroups,
                               crow::Response& res)
{
 ...
 */
static bool getUserGroupFromAccountType(
...
static void userErrorMessageHandler(
...
static void parseLDAPConfigData(nlohmann::json& jsonResponse,
...
static void getLDAPConfigData(const std::string& ldapType,
...
static void handleServiceAddressPatch(
...
static void handleUserNamePatch(
...
static void handlePasswordPatch(
...
static void handleUserNameAttrPatch(
...
static void handleGroupNameAttrPatch(
...
static void handleServiceEnablePatch(
...
static void handleAuthMethodsPatch(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleLDAPPatch(LdapPatchParams&& input,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& serverType)
{
    std::string dbusObjectPath;
...
static void afterVerifyUserExists(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleAccountServiceHead(
...
static void getClientCertificates(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleAccountServiceClientCertificatesInstanceHead(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& /*id*/)
{
...
static void handleAccountServiceClientCertificatesInstanceGet(
    App& app, const crow::Request& req,
...
static void handleAccountServiceClientCertificatesHead(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleAccountServiceClientCertificatesGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static CertificateMappingAttribute getCertificateMapping(
...
static void handleAccountServiceGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleCertificateMappingAttributePatch(
...
static void handleRespondToUnauthenticatedClientsPatch(
...
static void handleAccountServicePatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleAccountCollectionHead(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleAccountCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void processAfterCreateUser(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void processAfterGetAllGroups(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& username, const std::string& password,
...
static void handleAccountCollectionPost(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
static void handleAccountDelete(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& username)
{
...
static void handleAccountPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& username)
{
