...
static void updatePowerSupplyList(
...
static void doPowerSupplyCollection(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handlePowerSupplyCollectionHead(
...
static void handlePowerSupplyCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId)
{
...
static void afterGetValidPowerSupplyPath(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getValidPowerSupplyPath(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getPowerSupplyState(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void getPowerSupplyHealth(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& service, const std::string& path)
{
    dbus::utility::getProperty<bool>(
...
static void getPowerSupplyAsset(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& service, const std::string& path)
{
...
static void getPowerSupplyFirmwareVersion(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& service, const std::string& path)
{
...
static void getPowerSupplyLocation(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& service, const std::string& path)
{
    dbus::utility::getProperty<std::string>(
...
static void handleGetEfficiencyResponse(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handlePowerSupplyAttributesSubTreeResponse(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
    const dbus::utility::MapperGetSubTreeResponse& subtree)
{
...
static void getEfficiencyPercent(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
static void handlePowerSupplyHead(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId, const std::string& powerSupplyId)
{
...
static void handlePowerSupplyGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId, const std::string& powerSupplyId)
{
...
static void doPatchPowerSupply(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handlePowerSupplyPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisId, const std::string& powerSupplyId)
{
