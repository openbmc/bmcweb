...
static VmMode parseObjectPathAndGetMode(
...
static void findAndParseObject(
 ...
 */
static void vmParseInterfaceObject(
 ...
 */
static void getVmResourceList(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
 ...
 */
static void getVmData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 *
 */
static std::optional<TransferProtocol> getTransferProtocolFromUri(
 ...
 *
 */
static std::optional<TransferProtocol> getTransferProtocolFromParam(
 ...
 *
 */
static std::string getUriWithTransferProtocol(
 ...
 */
static void doMountVmLegacy(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& service, const std::string& name,
 ...
 *
 */
static void validateParams(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                           const std::string& service,
                           const std::string& resName,
 ...
 * All BMC state properties will be retrieved before sending reset request.
 */
static void doEjectAction(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                          const std::string& service, const std::string& name,
                          bool legacy)
{
...
static void handleManagersVirtualMediaActionInsertPost(
...
static void handleManagersVirtualMediaActionEject(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleManagersVirtualMediaCollectionGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& name)
{
...
static void handleVirtualMediaGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& name, const std::string& resName)
{
