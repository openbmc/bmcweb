...
constexpr std::string_view BMCWEB_REDFISH_HOST_INTERFACE_URI_NAME = "bmc";
    ...
    const std::string& managerId)
{
    ...
    member["@odata.id"] =
        boost::urls::format("/redfish/v1/Managers/{}/HostInterfaces/{}",
                            managerId, BMCWEB_REDFISH_HOST_INTERFACE_URI_NAME);
    ...
    const std::string& managerId, const std::string& hostInterfaceId)
{
    ...
    if (hostInterfaceId != BMCWEB_REDFISH_HOST_INTERFACE_URI_NAME)
    {
