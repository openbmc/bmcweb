...
const std::map<std::string, std::string> credentialRoleIdToUserRoleId = {
...
const std::map<std::string, std::string> credentialRoleIdFromUserRoleId = {
    {"Administrator",
     "xyz.openbmc_project.HostInterface.CredentialBootstrapping.Role.Administrator"},
    {"Operator",
     "xyz.openbmc_project.HostInterface.CredentialBootstrapping.Role.Operator"},
    ...
    const dbus::utility::DBusPropertiesMap& properties)
{
    ...
    const bool success = sdbusplus::unpackPropertiesNoThrow(
        ...
        enabledAfterReset, "Enabled", enabled, "RoleId", roleId);
    if (!success)
    {
        messages::internalError(asyncResp->res);
        return;
