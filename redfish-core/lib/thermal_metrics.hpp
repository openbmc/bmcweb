    ...
    const ::dbus::utility::DBusPropertiesMap& valuesDict)
{
            ...
            "temperature", valuesDict, item))
    {
        ...
        std::sort(temperatureArray->begin(), temperatureArray->end(),
                  [](const nlohmann::json& c1, const nlohmann::json& c2) {
                      return AlphanumLess<std::string>()(c1["DataSourceUri"],
                                                         c2["DataSourceUri"]);
                  });
    }
}
            ...
            *crow::connections::systemBus, service, sensorPath,
            ...
            [asyncResp, chassisId,
             sensorPath](const boost::system::error_code& ec,
                ...
                afterGetTemperatureValue(asyncResp, chassisId, sensorPath, ec,
                                         properties);
            });
    }
}
    ...
    const std::string& validChassisPath, const std::string& chassisId)
{
    ...
    sensor_utils::getAllSensorObjects(
        asyncResp, validChassisPath, "/xyz/openbmc_project/sensors/temperature",
        interfaces, 1,
