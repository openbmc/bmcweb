...
static triggers::TriggerActionEnum toRedfishTriggerAction(
...
static std::string toDbusTriggerAction(std::string_view redfishValue)
{
...
static std::string toDbusSeverity(std::string_view redfishValue)
{
    if (redfishValue == "OK")
    {
...
static resource::Health toRedfishSeverity(std::string_view dbusValue)
{
...
static std::string toRedfishThresholdName(std::string_view dbusValue)
{
...
static std::string toDbusActivation(std::string_view redfishValue)
{
...
static triggers::ThresholdActivation toRedfishActivation(
    std::string_view dbusValue)
{
...
static std::optional<sdbusplus::message::object_path>
...
static std::optional<MetricType> getMetricType(const std::string& metricType)
{
...
static std::optional<DiscreteCondition> getDiscreteCondition(
...
static bool parseThreshold(crow::Response& res,
...
static bool parseNumericThresholds(
...
static bool parseDiscreteTriggers(
    crow::Response& res,
...
static bool parseTriggerThresholds(
    crow::Response& res,
    std::optional<std::vector<nlohmann::json::object_t>>& discreteTriggers,
...
static bool parseLinks(crow::Response& res,
...
static bool parseMetricProperties(crow::Response& res, Context& ctx)
{
...
static bool parsePostTriggerParams(crow::Response& res,
...
static void afterCreateTrigger(
...
static std::optional<nlohmann::json::array_t> getTriggerActions(
...
static std::optional<nlohmann::json::array_t> getDiscreteTriggers(
...
static std::optional<nlohmann::json::object_t> getNumericThresholds(
...
static std::optional<nlohmann::json> getMetricReportDefinitions(
...
static std::vector<std::string> getMetricProperties(
...
static bool fillTrigger(nlohmann::json& json, const std::string& id,
...
static void handleTriggerCollectionPost(
