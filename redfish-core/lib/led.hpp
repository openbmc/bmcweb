                        ...
                        const std::string& ledGroup)
{
    ...
    dbus::utility::getDbusObject(ledGroup, std::move(respHanler));
}
...
inline void getLedGroup(const std::string& objPath,
                        const std::function<void(const std::string&)>& callback)
{
    ...
    dbus::utility::getDbusObject(objPath, std::move(respHandler));
}
