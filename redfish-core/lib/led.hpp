                                       ...
                                       const std::string& objPath)
{
    ...
    crow::connections::systemBus->async_method_call(
        [objPath, aResp{std::move(aResp)}](
            ...
            std::string ledTpye = "fault_led_group";
            ...
            crow::connections::systemBus->async_method_call(
                [aResp, groupPath](const boost::system::error_code ec,
                                   const std::variant<bool> asserted) {
                    if (ec)
                    {
                        messages::internalError(aResp->res);
                                       ...
                                       bool locationIndicatorActive)
{
    ...
    crow::connections::systemBus->async_method_call(
        [objPath, aResp{std::move(aResp)}, locationIndicatorActive](
            const boost::system::error_code ec,
            const std::variant<
                std::vector<std::tuple<std::string, std::string, std::string>>>
                associationList) {
            ...
            crow::connections::systemBus->async_method_call(
                [aResp, groupPath,
                 locationIndicatorActive](const boost::system::error_code ec) {
                    if (ec)
                    {
                        messages::internalError(aResp->res);
                        return;
