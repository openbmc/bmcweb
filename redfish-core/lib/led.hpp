...
inline void afterGetLocationIndicatorAsserted(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
inline void afterGetLocationIndicatorBlinking(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec, const bool blinking)
{
    ...
    dbus::utility::getProperty<bool>(
        ...
        "/xyz/openbmc_project/led/groups/enclosure_identify",
        "xyz.openbmc_project.Led.Group", "Asserted",
        std::bind_front(afterGetLocationIndicatorAsserted, asyncResp));
}
    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    dbus::utility::getProperty<bool>(
        ...
        "/xyz/openbmc_project/led/groups/enclosure_identify_blink",
        "xyz.openbmc_project.Led.Group", "Asserted",
        std::bind_front(afterGetLocationIndicatorBlinking, asyncResp));
}
