                         ...
                         const std::string& ledState)
{
    ...
    sdbusplus::asio::setProperty(
        *crow::connections::systemBus, "xyz.openbmc_project.LED.GroupManager",
        ...
        setDbusProperty(asyncResp, "xyz.openbmc_project.LED.GroupManager",
                    sdbusplus::message::object_path(("/xyz/openbmc_project/led/groups/enclosure_identify"),
                    "xyz.openbmc_project.Led.Group", "Asserted", "IndicatorLED", ledBlinkng);
    });
}
    ...
    sdbusplus::asio::setProperty(
        *crow::connections::systemBus, "xyz.openbmc_project.LED.GroupManager",
        ...
        if (ec)
        {
            ...
            setDbusProperty(asyncResp, "xyz.openbmc_project.LED.GroupManager",
                    sdbusplus::message::object_path(("/xyz/openbmc_project/led/groups/enclosure_identify"),
                    "xyz.openbmc_project.Led.Group", "Asserted", "LocationIndicatorActive", ledState);
        }
    });
}
} // namespace redfish
