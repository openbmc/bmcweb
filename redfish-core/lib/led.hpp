        ...
        *crow::connections::systemBus, "xyz.openbmc_project.LED.GroupManager",
        ...
        sdbusplus::asio::getProperty<bool>(
            *crow::connections::systemBus,
            ...
            "xyz.openbmc_project.Led.Group", "Asserted",
            [asyncResp](const boost::system::error_code& ec2, const bool ledOn) {
                         ...
                         const std::string& ledState)
{
    ...
    {
        messages::propertyValueNotInList(asyncResp->res, ledState, "IndicatorLED");
        return;
    }
 ...
 */
inline void
    getLocationIndicatorActive(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 */
inline void
    setLocationIndicatorActive(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                               const bool ledState)
{
