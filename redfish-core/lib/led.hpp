 ...
 * @param[in] ledPtr    Json pointer to the Led resource
 *
 * @return None.
 */
...
inline void getIndicatorLedState(
    ...
    const nlohmann::json::json_pointer& ledPtr = ""_json_pointer)
{
    ...
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.LED.GroupManager",
        ...
        [aResp, ledPtr](const boost::system::error_code& ec,
                        const bool blinking) {
        ...
        if (!ec && blinking)
        {
            aResp->res.jsonValue[ledPtr]["IndicatorLED"] = "Blinking";
            return;
        }
        ...
        sdbusplus::asio::getProperty<bool>(
            *crow::connections::systemBus,
            ...
            "xyz.openbmc_project.Led.Group", "Asserted",
            [aResp, ledPtr](const boost::system::error_code& ec2,
                            const bool ledOn) {
            ...
            if (ledOn)
            {
                aResp->res.jsonValue[ledPtr]["IndicatorLED"] = "Lit";
            }
            else
            {
                aResp->res.jsonValue[ledPtr]["IndicatorLED"] = "Off";
            }
            });
        });
}
    ...
    const nlohmann::json::json_pointer& ledPtr = ""_json_pointer)
{
    ...
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.LED.GroupManager",
        ...
        if (!ec && blinking)
        {
            aResp->res.jsonValue[ledPtr]["LocationIndicatorActive"] = true;
            return;
        }
        ...
        sdbusplus::asio::getProperty<bool>(
            *crow::connections::systemBus,
            ...
            aResp->res.jsonValue[ledPtr]["LocationIndicatorActive"] = ledOn;
            });
        });
}
