    ...
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    ...
    dbus::utility::getManagedObjects(
        ...
        [asyncResp, currentProfile, supportedProfiles](
            ...
            fans["@odata.type"] =
                "#OpenBMCManager.v1_0_1.Manager.FanControllers";
            ...
            pids["@odata.type"] =
                "#OpenBMCManager.v1_0_1.Manager.PidControllers";
            ...
            stepwise["@odata.type"] =
                "#OpenBMCManager.v1_0_1.Manager.StepwiseControllers";
            ...
            zones["@odata.id"] = boost::urls::format(
                ...
                BMCWEB_REDFISH_MANAGER_URI_NAME);
            zones["@odata.type"] = "#OpenBMCManager.v1_0_1.Manager.FanZones";
            configRoot["@odata.id"] =
                boost::urls::format("/redfish/v1/Managers/{}#/Oem/OpenBmc/Fan",
                                    BMCWEB_REDFISH_MANAGER_URI_NAME);
            configRoot["@odata.type"] = "#OpenBMCManager.v1_0_1.Manager.Fan";
            ...
            for (const auto& pathPair : managedObj)
            {
                for (const auto& intfPair : pathPair.second)
                {
                    ...
                    if (intfPair.first == pidZoneConfigurationIface)
                    {
                        ...
                        zone["@odata.type"] =
                            "#OpenBMCManager.v1_0_1.Manager.FanZone";
                        config = &zone;
                    }
                    ...
                    else if (intfPair.first == stepwiseConfigurationIface)
                    {
                        ...
                        controller["@odata.type"] =
                            "#OpenBMCManager.v1_0_1.Manager.StepwiseController";
                    ...
                    else if (intfPair.first == pidConfigurationIface)
                    {
                        ...
                        if (isFan)
                        {
                            ...
                            element["@odata.type"] =
                                "#OpenBMCManager.v1_0_1.Manager.FanController";
                        }
                        else
                        {
                            url.set_fragment(
                            ...
                            element["@odata.id"] = std::move(url);
                            element["@odata.type"] =
                                "#OpenBMCManager.v1_0_1.Manager.PidController";
                        }
                    }
                    else
                    {
    ...
    const std::string& /*managerId*/)
{
    ...
    oemOpenbmc["@odata.type"] = "#OpenBMCManager.v1_0_1.Manager";
    oemOpenbmc["@odata.id"] =
