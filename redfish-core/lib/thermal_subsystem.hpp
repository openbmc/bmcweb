...
//         Node(app, "/redfish/v1/Chassis/<str>/ThermalSubsystem/",
//         std::string())
//     {
//         entityPrivileges = {
...
//                const crow::Request&, const std::vector<std::string>& params)
//         override
//     {
//         if (params.size() != 1)
//         {
...
//                 {
//                     BMCWEB_LOG_ERROR << "Not a valid chassis ID" <<
//                     chassisId; messages::resourceNotFound(asyncResp->res,
//                     "Chassis",
//                                                chassisId);
//                     return;
//                 }
