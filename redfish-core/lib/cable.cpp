 ...
 */
static void fillCableProperties(
...
static void fillCableHealthState(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
static void getCableProperties(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void afterHandleCableGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleCableGet(App& app, const crow::Request& req,
                           const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void handleCableCollectionGet(
