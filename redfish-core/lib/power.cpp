...
static void afterGetPowerCapEnable(
...
static void afterGetChassisPath(
    const std::shared_ptr<SensorsAsyncResp>& sensorsAsyncResp,
...
static void afterPowerCapSettingGet(
...
static void handleChassisPowerGet(
...
static void handleChassisPowerPatch(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& chassisName)
{
