...
{
    return getLog(redfish::registries::Base::Index::propertyDuplicate, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyUnknown, std::to_array({arg1}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueTypeError, std::to_array<std::string_view>({arg1Str, arg2}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueFormatError, std::to_array<std::string_view>({arg1Str, arg2}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueNotInList, std::to_array<std::string_view>({arg1Str, arg2}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueOutOfRange, std::to_array<std::string_view>({arg1Str, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyValueError, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyNotWritable, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyNotUpdated, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyMissing, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::invalidJSON, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionNotSupported, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterMissing, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterDuplicate, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterUnknown, std::to_array({arg1, arg2}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::actionParameterValueTypeError, std::to_array<std::string_view>({arg1Str, arg2, arg3}));
}

void actionParameterValueTypeError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2, std::string_view arg3)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, actionParameterValueTypeError(arg1, arg2, arg3));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::actionParameterValueFormatError, std::to_array<std::string_view>({arg1Str, arg2, arg3}));
}
...
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, actionParameterValueFormatError(arg1, arg2, arg3));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterValueNotInList, std::to_array({arg1, arg2, arg3}));
}

void actionParameterValueNotInList(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, actionParameterValueNotInList(arg1, arg2, arg3));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterValueOutOfRange, std::to_array({arg1, arg2, arg3}));
}

void actionParameterValueOutOfRange(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, actionParameterValueOutOfRange(arg1, arg2, arg3));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::actionParameterValueError, std::to_array<std::string_view>({arg1Str, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterNotSupported, std::to_array({arg1, arg2}));
}
...
std::string arg2Str = std::to_string(arg2);
    return getLog(redfish::registries::Base::Index::arraySizeTooLong, std::to_array<std::string_view>({arg1, arg2Str}));
}
...
{
    return getLog(redfish::registries::Base::Index::arraySizeTooShort, std::to_array({arg1, arg2}));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::queryParameterValueTypeError, std::to_array<std::string_view>({arg1Str, arg2}));
}

void queryParameterValueTypeError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, queryParameterValueTypeError(arg1, arg2));
}
...
{
std::string arg1Str = arg1.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::queryParameterValueFormatError, std::to_array<std::string_view>({arg1Str, arg2}));
}

void queryParameterValueFormatError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, queryParameterValueFormatError(arg1, arg2));
}
...
{
    return getLog(redfish::registries::Base::Index::queryParameterValueError, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::queryParameterOutOfRange, std::to_array({arg1, arg2, arg3}));
}

void queryParameterOutOfRange(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, queryParameterOutOfRange(arg1, arg2, arg3));
}
...
{
    return getLog(redfish::registries::Base::Index::queryParameterUnsupported, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::eventSubscriptionLimitExceeded, {});
}
...
{
    return getLog(redfish::registries::Base::Index::resourceAlreadyExists, std::to_array({arg1, arg2, arg3}));
}

void resourceAlreadyExists(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToJson(res.jsonValue, resourceAlreadyExists(arg1, arg2, arg3), arg2);
}
...
{
    return getLog(redfish::registries::Base::Index::resourceNotFound, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::invalidURI, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::createFailedMissingReqProperties, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::accountForSessionNoLongerExists, {});
}
...
{
    return getLog(redfish::registries::Base::Index::invalidObject, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceMissingAtURI, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceAtUriInUnknownFormat, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceAtUriUnauthorized, std::to_array<std::string_view>({arg1.buffer(), arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::couldNotEstablishConnection, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::sourceDoesNotSupportProtocol, std::to_array<std::string_view>({arg1.buffer(), arg2}));
}

void sourceDoesNotSupportProtocol(crow::Response& res, const boost::urls::url_view_base& arg1, std::string_view arg2)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, sourceDoesNotSupportProtocol(arg1, arg2));
}
...
{
    return getLog(redfish::registries::Base::Index::accessDenied, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::serviceTemporarilyUnavailable, std::to_array({arg1}));
}

void serviceTemporarilyUnavailable(crow::Response& res, std::string_view arg1)
{
res.addHeader(boost::beast::http::field::retry_after, arg1);    res.result(boost::beast::http::status::service_unavailable);
...
std::string arg1Str = std::to_string(arg1);
    return getLog(redfish::registries::Base::Index::invalidIndex, std::to_array<std::string_view>({arg1Str}));
}
...
{
std::string arg2Str = arg2.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueModified, std::to_array<std::string_view>({arg1, arg2Str}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceExhaustion, std::to_array({arg1}));
}
...
{
std::string arg2Str = std::to_string(arg2);
    return getLog(redfish::registries::Base::Index::stringValueTooLong, std::to_array<std::string_view>({arg1, arg2Str}));
}
...
{
    return getLog(redfish::registries::Base::Index::stringValueTooShort, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceTypeIncompatible, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::passwordChangeRequired, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::resetRequired, std::to_array<std::string_view>({arg1.buffer(), arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::resetRecommended, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::chassisPowerStateOnRequired, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::chassisPowerStateOffRequired, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyValueConflict, std::to_array({arg1, arg2}));
}
...
{
std::string arg2Str = arg2.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueResourceConflict, std::to_array<std::string_view>({arg1, arg2Str, arg3.buffer()}));
}
...
void propertyValueResourceConflict(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2, const boost::urls::url_view_base& arg3)
{
    ...
    addMessageToErrorJson(res.jsonValue, propertyValueResourceConflict(arg1, arg2, arg3));
}
...
{
std::string arg2Str = arg2.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueExternalConflict, std::to_array<std::string_view>({arg1, arg2Str}));
}

void propertyValueExternalConflict(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2)
{
    res.result(boost::beast::http::status::conflict);
    addMessageToErrorJson(res.jsonValue, propertyValueExternalConflict(arg1, arg2));
}
...
{
std::string arg2Str = arg2.dump(-1, ' ', true, nlohmann::json::error_handler_t::replace);
    return getLog(redfish::registries::Base::Index::propertyValueIncorrect, std::to_array<std::string_view>({arg1, arg2Str}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceCreationConflict, std::to_array<std::string_view>({arg1.buffer()}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionParameterValueConflict, std::to_array({arg1, arg2}));
}

void actionParameterValueConflict(crow::Response& res, std::string_view arg1, std::string_view arg2)
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, actionParameterValueConflict(arg1, arg2));
}
...
{
    return getLog(redfish::registries::Base::Index::headerMissing, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::headerInvalid, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::undeterminedFault, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::restrictedRole, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::restrictedPrivilege, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::strictAccountTypes, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyDeprecated, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::resourceDeprecated, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::propertyValueDeprecated, std::to_array({arg1, arg2}));
}
...
{
    return getLog(redfish::registries::Base::Index::actionDeprecated, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::networkNameResolutionNotConfigured, {});
}
...
{
    return getLog(redfish::registries::Base::Index::networkNameResolutionNotSupported, {});
}
...
{
    return getLog(redfish::registries::Base::Index::serviceDisabled, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::oneTimePasscodeSent, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::licenseRequired, std::to_array({arg1}));
}
...
{
    return getLog(redfish::registries::Base::Index::generateSecretKeyRequired, std::to_array<std::string_view>({arg1.buffer()}));
}
