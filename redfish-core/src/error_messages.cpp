...
void resourceAtUriUnauthorized(crow::Response& res, const boost::urls::url_view arg1,
                               const std::string& arg2)
{
...
void resourceAtUriInUnknownFormat(crow::Response& res, const boost::urls::url_view arg1)
{
    res.result(boost::beast::http::status::bad_request);
 ...
 * @endinternal
 */
nlohmann::json resetRequired(const boost::urls::url_view arg1, const std::string& arg2)
{
    std::string url(arg1.data(), arg1.size());
    return nlohmann::json{
        {"@odata.type", "#Message.v1_1_1.Message"},
...
void resourceCreationConflict(crow::Response& res, const boost::urls::url_view arg1)
{
    res.result(boost::beast::http::status::bad_request);
...
void couldNotEstablishConnection(crow::Response& res, const boost::urls::url_view arg1)
{
    res.result(boost::beast::http::status::not_found);
 ...
 * @endinternal
 */
void passwordChangeRequired(crow::Response& res, const boost::urls::url_view arg1)
{
    std::string url(arg1.data(), arg1.size());
