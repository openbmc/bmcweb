...
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, propertyValueFormatError(arg1, arg2), arg2);
}
...
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, propertyValueNotInList(arg1, arg2), arg2);
}
...
{
    res.result(boost::beast::http::status::bad_request);
    addMessageToErrorJson(res.jsonValue, propertyValueTypeError(arg1, arg2), arg2);
}
...
{
    res.result(boost::beast::http::status::ok);
    addMessageToErrorJson(res.jsonValue, propertyValueModified(arg1, arg2), arg1);
}
