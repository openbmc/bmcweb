...
static std::string toString(filter_ast::ComparisonOperator rel)
{
    switch (rel)
    {
...
std::string FilterExpressionPrinter::operator()(
    const filter_ast::RelationalComparison& x) const
{
...
std::string FilterExpressionPrinter::operator()(
    const filter_ast::BooleanOperation& operation) const
{
