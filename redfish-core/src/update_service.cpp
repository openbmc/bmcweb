...
void monitorForSoftwareAvailable(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const crow::Request& req, const std::string& url, int timeoutTimeSeconds)
{
...
static void addRelatedItem(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                           std::string url)
{
...
static void addRelatedItemMultihost(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
static void addRelatedItemFromAssociation(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                     ...
                     const std::string& swid, const std::string& purpose)
{
    ...
    {
        addRelatedItem(asyncResp, std::format("/redfish/v1/Managers/{}",
                                              BMCWEB_REDFISH_MANAGER_URI_NAME));
    }
