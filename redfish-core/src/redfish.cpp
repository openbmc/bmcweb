...
RedfishService::RedfishService(App& app)
{
    ...
    if constexpr (bmcweb::REDFISH_ALLOW_DEPRECATED_POWER_THERMAL)
    {
        requestRoutesThermal(app);
        requestRoutesPower(app);
    }
    if constexpr (bmcweb::REDFISH_NEW_POWERSUBSYSTEM_THERMALSUBSYSTEM)
    {
    ...
    if constexpr (bmcweb::REDFISH_DUMP_LOG)
    {
    ...
    if constexpr (bmcweb::REDFISH_BMC_JOURNAL)
    {
    ...
    if constexpr (bmcweb::REDFISH_CPU_LOG)
    {
    ...
    if constexpr (bmcweb::REDFISH_HOST_LOGGER)
    {
