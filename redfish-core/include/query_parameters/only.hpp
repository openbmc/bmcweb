...
class OnlyMemberQuery : public Parameter
{
  public:
    ...
    OnlyMemberQuery(const OnlyMemberQuery& other) = default;
    OnlyMemberQuery& operator=(const OnlyMemberQuery& other) = default;
    OnlyMemberQuery(OnlyMemberQuery&& other) = default;
    OnlyMemberQuery& operator=(OnlyMemberQuery&& other) = default;
