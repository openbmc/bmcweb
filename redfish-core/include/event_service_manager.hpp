...
class Subscription : public std::enable_shared_from_this<Subscription>
{
  public:
                     ...
                     const boost::system::error_code& ec)
    {
        ...
        {
            sendHeartbeatEventToSubscriber();
    ...
    void sendHeartbeatEventToSubscriber()
    {
        nlohmann::json::object_t eventMessage =
            messages::redfishServiceFunctional();
        eventMessage["EventId"] = eventSeqNum;
        ...
        msgJson["Id"] = std::to_string(eventSeqNum);
