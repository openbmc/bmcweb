...
inline void handleCollectionMembers(
    ...
    const boost::urls::url& collectionPath, const std::string& jsonKeyName,
    ...
    const dbus::utility::MapperGetSubTreePathsResponse& objects)
{
    if (ec == boost::system::errc::io_error)
    {
        ...
        asyncResp->res.jsonValue[jsonKeyName + "@odata.count"] = 0;
        return;
    }
    ...
    asyncResp->res.jsonValue[jsonKeyName + "@odata.count"] = members.size();
}
