...
/**
 * @brief Sort the associated collection "Members"
 *
 * @param[i,o] aResp  Async response object
 * @param[i]   objects Collection of associated objects
 * @param[i]   collectionPath  Redfish collection path which is used for the
 *             Members Redfish Path
...
inline void sortAssociatedCollectionMembers(
    ...
    const dbus::utility::MapperGetSubTreePathsResponse& subTreePaths)
{
    ...
    // required members.
    std::set_intersection(objects.begin(), objects.end(), subTreePaths.begin(),
                          subTreePaths.end(), std::back_inserter(objectPaths));
...
inline void getAssociatedCollectionMembers(
    const std::shared_ptr<bmcweb::AsyncResp>& aResp,
    const boost::urls::url& collectionPath,
    std::vector<std::string>& interfaces, const char* associationEndPointPath)
{
    ...
    sdbusplus::asio::getProperty<std::vector<std::string>>(
        *crow::connections::systemBus, "xyz.openbmc_project.ObjectMapper",
        ...
        dbus::utility::getSubTreePaths(
            ...
            std::bind_front(sortAssociatedCollectionMembers, aResp, objects,
                            collectionPath));
        });
}
