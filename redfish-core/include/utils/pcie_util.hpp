                      ...
                      const nlohmann::json::json_pointer& jsonKeyName)
{
    ...
    static const boost::urls::url pcieDeviceUrl = boost::urls::url("/redfish/v1/Systems/system/PCIeDevices");

    collection_util::getCollectionToKey(
        asyncResp, pcieDeviceUrl,
        pcieDeviceInterface, "/xyz/openbmc_project/inventory", jsonKeyName);
}
