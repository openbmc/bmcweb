...
{
    sdbusplus::object_path hostPath("/xyz/openbmc_project/state");
...
inline sdbusplus::object_path getChassisStateObjectPath(
    const uint64_t computerSystemIndex)
{
    sdbusplus::object_path chassisPath("/xyz/openbmc_project/state");
...
inline sdbusplus::object_path getControlObjectPath(
    const uint64_t computerSystemIndex)
{
    sdbusplus::object_path controlPath("/xyz/openbmc_project/control");
