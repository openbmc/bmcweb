...
inline std::string_view getMetricReportDefinitionUri(const std::string& id)
{
...
inline std::string_view getMetricReportUri(const std::string& id)
{
    boost::urls::url url = crow::utility::urlFromPieces(
...
inline std::string_view getTriggerUri(const std::string& id)
{
    boost::urls::url url = crow::utility::urlFromPieces(
