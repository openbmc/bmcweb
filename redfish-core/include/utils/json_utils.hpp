...
bool handleEmpty(crow::Response& res, ValueType&)
{
...
bool handleEmpty(crow::Response& res, ValueType& val, UnpackTypes&... in)
{
    return details::handleEmpty(res, val) && details::handleEmpty(res, in...);
}
} // namespace details
