...
using UnpackVariant = std::variant<
    ...
    std::optional<NullOr<int16_t>>*,
    std::optional<NullOr<uint16_t>>*,
    std::optional<NullOr<int32_t>>*,
    std::optional<NullOr<uint32_t>>*,
    std::optional<NullOr<int64_t>>*,
    std::optional<NullOr<uint64_t>>*,
    std::optional<NullOr<double>>*,
    std::optional<NullOr<bool>>*,
    std::optional<std::vector<NullOr<nlohmann::json::object_t>>>*,
    std::optional<NullOr<nlohmann::json::object_t>>*
>;
// clang-format on
