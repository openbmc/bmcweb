...
inline void getResourceState(
    ...
    const std::string& service, const std::string& path)
{
    getResourceState(asyncResp, service, path, ""_json_pointer);
}
    ...
    dbus::utility::getProperty<bool>(
        *crow::connections::systemBus, service, path,
        ...
        [asyncResp, jsonPtr](const boost::system::error_code& ec,
            ...
            determineResourceHealth(asyncResp, jsonPtr, value);
        });
}
...
inline void getResourceHealth(
    ...
    const std::string& service, const std::string& path)
{
    getResourceHealth(asyncResp, service, path, ""_json_pointer);
}
