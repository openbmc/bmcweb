...
namespace redfish
{
inline crow::Request createNewRequest(
    const crow::Request& localReq)
{
    boost::system::error_code ec;
    // Note, this is an expensive copy.  It ideally shouldn't be done, but no option at this point.
