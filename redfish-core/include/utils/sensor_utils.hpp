    ...
    const std::string& sensorPhysicalContext)
{
    ...
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ACInput")
    {
        return physical_context::PhysicalContext::ACInput;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType."
        "ACMaintenanceBypassInput")
    {
        return physical_context::PhysicalContext::ACMaintenanceBypassInput;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ACOutput")
    {
        return physical_context::PhysicalContext::ACOutput;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ACStaticBypassInput")
    {
        return physical_context::PhysicalContext::ACStaticBypassInput;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ACUtilityInput")
    {
        return physical_context::PhysicalContext::ACUtilityInput;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ASIC")
    {
        return physical_context::PhysicalContext::ASIC;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Back")
    {
        return physical_context::PhysicalContext::Back;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Backplane")
    {
        return physical_context::PhysicalContext::Backplane;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Battery")
    {
        return physical_context::PhysicalContext::Battery;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Board")
    {
        return physical_context::PhysicalContext::Board;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Chassis")
    {
        return physical_context::PhysicalContext::Chassis;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ComputeBay")
    {
        return physical_context::PhysicalContext::ComputeBay;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.CoolingSubsystem")
    {
        return physical_context::PhysicalContext::CoolingSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.CPU")
    {
        return physical_context::PhysicalContext::CPU;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.CPUSubsystem")
    {
        return physical_context::PhysicalContext::CPUSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.DCBus")
    {
        return physical_context::PhysicalContext::DCBus;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Exhaust")
    {
        return physical_context::PhysicalContext::Exhaust;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ExpansionBay")
    {
        return physical_context::PhysicalContext::ExpansionBay;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.ExpansionSubsystem")
    {
        return physical_context::PhysicalContext::ExpansionSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Fan")
    {
        return physical_context::PhysicalContext::Fan;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Filter")
    {
        return physical_context::PhysicalContext::Filter;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.FPGA")
    {
        return physical_context::PhysicalContext::FPGA;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Front")
    {
    ...
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.GPUSubsystem")
    {
        return physical_context::PhysicalContext::GPUSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Intake")
    {
        return physical_context::PhysicalContext::Intake;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.LiquidInlet")
    {
        return physical_context::PhysicalContext::LiquidInlet;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.LiquidOutlet")
    {
        return physical_context::PhysicalContext::LiquidOutlet;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Lower")
    {
    ...
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Memory")
    {
        return physical_context::PhysicalContext::Memory;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.MemorySubsystem")
    {
        return physical_context::PhysicalContext::MemorySubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Motor")
    {
        return physical_context::PhysicalContext::Motor;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.NetworkBay")
    {
        return physical_context::PhysicalContext::NetworkBay;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.NetworkingDevice")
    {
        return physical_context::PhysicalContext::NetworkingDevice;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.PowerOutlet")
    {
        return physical_context::PhysicalContext::PowerOutlet;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.PowerSubsystem")
    {
        return physical_context::PhysicalContext::PowerSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.PowerSupply")
    {
        return physical_context::PhysicalContext::PowerSupply;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.PowerSupplyBay")
    {
        return physical_context::PhysicalContext::PowerSupplyBay;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Pump")
    {
        return physical_context::PhysicalContext::Pump;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Rectifier")
    {
        return physical_context::PhysicalContext::Rectifier;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Reservoir")
    {
        return physical_context::PhysicalContext::Reservoir;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Room")
    {
        return physical_context::PhysicalContext::Room;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.StorageBay")
    {
        return physical_context::PhysicalContext::StorageBay;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.StorageDevice")
    {
        return physical_context::PhysicalContext::StorageDevice;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.StorageSubsystem")
    {
        return physical_context::PhysicalContext::StorageSubsystem;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Switch")
    {
        return physical_context::PhysicalContext::Switch;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.SystemBoard")
    {
        return physical_context::PhysicalContext::SystemBoard;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Transceiver")
    {
        return physical_context::PhysicalContext::Transceiver;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Transformer")
    {
        return physical_context::PhysicalContext::Transformer;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.TrustedModule")
    {
        return physical_context::PhysicalContext::TrustedModule;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.Upper")
    {
        return physical_context::PhysicalContext::Upper;
    }
    if (sensorPhysicalContext ==
        "xyz.openbmc_project.Common.PhysicalContext.PhysicalContextType.VoltageRegulator")
    {
