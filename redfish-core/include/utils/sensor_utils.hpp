...
{
    environmentMetricsNode, // isExcerpt
    powerNode,              // deprecated Power
    sensorsNode,
    thermalNode,            // deprecated Thermal
    thermalMetricsNode,     // isExcerpt
    unknownNode,
};
...
inline void fillDeprecatedIdentity(
    std::string_view sensorName, std::string_view sensorType,
    nlohmann::json& sensorJson, InventoryItem* inventoryItem,
    ...
    nlohmann::json& sensorJson, InventoryItem* inventoryItem)
{
    ...
    if (!isExcerpt)
    {
        ...
        {
            fillDeprecatedIdentity(sensorName, sensorType, sensorJson,
    ...
    if (!isExcerpt)
    {
        ...
        mapPropertiesBySubnode(sensorType, chassisSubNode, properties);
    }
