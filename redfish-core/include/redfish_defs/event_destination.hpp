...
NLOHMANN_JSON_SERIALIZE_ENUM(EventFormatType, { //NOLINT
    {EventFormatType::Invalid, "Invalid"},
    {EventFormatType::Event, "Event"},
    {EventFormatType::MetricReport, "MetricReport"},
});

NLOHMANN_JSON_SERIALIZE_ENUM(EventDestinationProtocol, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SubscriptionType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(DeliveryRetryPolicy, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SNMPAuthenticationProtocols, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SNMPEncryptionProtocols, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SyslogSeverity, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SyslogFacility, { //NOLINT
