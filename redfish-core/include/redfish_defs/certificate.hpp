...
NLOHMANN_JSON_SERIALIZE_ENUM(CertificateType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(KeyUsage, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(CertificateUsageType, { //NOLINT
