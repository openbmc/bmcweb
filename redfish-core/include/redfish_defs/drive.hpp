...
NLOHMANN_JSON_SERIALIZE_ENUM(HotspareType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(EncryptionAbility, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(EncryptionStatus, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(StatusIndicator, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(HotspareReplacementModeType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(DataSanitizationType, { //NOLINT
