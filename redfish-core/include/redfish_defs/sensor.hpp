...
NLOHMANN_JSON_SERIALIZE_ENUM(VoltageType, { //NOLINT
    {VoltageType::Invalid, "Invalid"},
    {VoltageType::AC, "AC"},
    {VoltageType::DC, "DC"},
});

NLOHMANN_JSON_SERIALIZE_ENUM(ElectricalContext, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(ReadingType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(ImplementationType, { //NOLINT
