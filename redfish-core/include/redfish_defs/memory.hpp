...
NLOHMANN_JSON_SERIALIZE_ENUM(MemoryType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(MemoryDeviceType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(BaseModuleType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(MemoryMedia, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SecurityStates, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(ErrorCorrection, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(MemoryClassification, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(OperatingMemoryModes, { //NOLINT
