...
NLOHMANN_JSON_SERIALIZE_ENUM(PCIeTypes, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(DeviceType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(SlotType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(LaneSplittingType, { //NOLINT
