...
NLOHMANN_JSON_SERIALIZE_ENUM(ProcessorType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(ProcessorMemoryType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(FpgaType, { //NOLINT
    {FpgaType::Invalid, "Invalid"},
    {FpgaType::Integrated, "Integrated"},
    {FpgaType::Discrete, "Discrete"},
});

NLOHMANN_JSON_SERIALIZE_ENUM(SystemInterfaceType, { //NOLINT
