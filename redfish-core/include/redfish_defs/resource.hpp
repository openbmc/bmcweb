...
NLOHMANN_JSON_SERIALIZE_ENUM(State, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(Health, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(ResetType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(DurableNameFormat, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(RackUnits, { //NOLINT
    {RackUnits::Invalid, "Invalid"},
    {RackUnits::OpenU, "OpenU"},
    {RackUnits::EIA_310, "EIA_310"},
});

NLOHMANN_JSON_SERIALIZE_ENUM(LocationType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(Reference, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(Orientation, { //NOLINT
