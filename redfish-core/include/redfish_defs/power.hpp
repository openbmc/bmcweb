...
NLOHMANN_JSON_SERIALIZE_ENUM(PowerLimitException, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(PowerSupplyType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(LineInputVoltageType, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(InputType, { //NOLINT
