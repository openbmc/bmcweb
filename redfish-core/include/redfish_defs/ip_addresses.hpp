...
NLOHMANN_JSON_SERIALIZE_ENUM(IPv4AddressOrigin, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(IPv6AddressOrigin, { //NOLINT
...
NLOHMANN_JSON_SERIALIZE_ENUM(AddressState, { //NOLINT
