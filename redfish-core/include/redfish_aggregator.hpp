...
static inline void addPrefixToItem(nlohmann::json& item, std::string_view prefix)
{
...
static inline void addLinksToAggregatedResponse(crow::Response& asyncResp,
                                  crow::Response& resp)
{
...
static inline void addHeaderPrefixes(crow::Response& resp, std::string_view prefix)
{
