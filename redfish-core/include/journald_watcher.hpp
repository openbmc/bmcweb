...
class JournalWatcher : public std::enable_shared_from_this<JournalWatcher>
{
  ...
  public:
    JournalWatcher(
        ...
        ioc(iocIn), stream(iocIn), timer(iocIn), handler(std::move(handlerIn))
    {
    ...
    JournalWatcher(JournalWatcher&&) = delete;
    JournalWatcher(const JournalWatcher&) = delete;
    JournalWatcher& operator=(JournalWatcher&&) = delete;
    JournalWatcher& operator=(const JournalWatcher&) = delete;
