...
namespace redfish
{
    constexpr std::unordered_set<std::string> topCollections({
        "/redfish/v1/AccountService/Accounts",
        "/redfish/v1/AccountService/AdditionalExternalAccountProviders",
        "/redfish/v1/AccountService/Certificates",
    ...
    constexpr std::unordered_map<std::string, std::unordered_set<std::string>> topCollectionsParents = {
        {"/redfish/v1", {
