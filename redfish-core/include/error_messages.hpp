...
* Message body: "A general error has occurred.  See Resolution for information on how to resolve the error, or @Message.ExtendedInfo if Resolution is not provided."
*
*
...
* Message body: "The request body submitted contain no data to act upon and no changes to the resource took place."
*
*
...
* Message body: "The property <arg1> is not in the list of valid properties for the resource."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The value <arg1> for the property <arg2> is not a type that the property can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueTypeError formatted to JSON */
nlohmann::json::object_t propertyValueTypeError(const nlohmann::json& arg1, std::string_view arg2);

void propertyValueTypeError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);

/**
* @brief Formats PropertyValueFormatError message into JSON
* Message body: "The value <arg1> for the property <arg2> is not a format that the property can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueFormatError formatted to JSON */
nlohmann::json::object_t propertyValueFormatError(const nlohmann::json& arg1, std::string_view arg2);

void propertyValueFormatError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);

/**
* @brief Formats PropertyValueNotInList message into JSON
* Message body: "The value <arg1> for the property <arg2> is not in the list of acceptable values."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueNotInList formatted to JSON */
nlohmann::json::object_t propertyValueNotInList(const nlohmann::json& arg1, std::string_view arg2);

void propertyValueNotInList(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);

/**
* @brief Formats PropertyValueOutOfRange message into JSON
* Message body: "The value <arg1> for the property <arg2> is not in the supported range of acceptable values."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueOutOfRange formatted to JSON */
nlohmann::json::object_t propertyValueOutOfRange(const nlohmann::json& arg1, std::string_view arg2);

void propertyValueOutOfRange(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);
...
* Message body: "The property <arg1> is a read-only property and cannot be assigned a value."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The property <arg1> was not updated due to an internal service error.  The service is still operational."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The property <arg1> is a required property and must be included in the request."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The request body submitted was malformed JSON and could not be parsed by the receiving service."
*
*
...
* Message body: "The request body submitted is invalid JSON starting at line <arg1> and could not be parsed by the receiving service."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The request body submitted contained an empty JSON object and the service is unable to process it."
*
*
...
* Message body: "The action <arg1> requires the parameter <arg2> to be present in the request body."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterMissing formatted to JSON */
nlohmann::json::object_t actionParameterMissing(std::string_view arg1, std::string_view arg2);

void actionParameterMissing(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats ActionParameterDuplicate message into JSON
* Message body: "The action <arg1> was submitted with more than one value for the parameter <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterDuplicate formatted to JSON */
nlohmann::json::object_t actionParameterDuplicate(std::string_view arg1, std::string_view arg2);

void actionParameterDuplicate(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats ActionParameterUnknown message into JSON
* Message body: "The action <arg1> was submitted with the invalid parameter <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterUnknown formatted to JSON */
nlohmann::json::object_t actionParameterUnknown(std::string_view arg1, std::string_view arg2);

void actionParameterUnknown(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats ActionParameterValueTypeError message into JSON
* Message body: "The value <arg1> for the parameter <arg2> in the action <arg3> is not a type that the parameter can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
...
nlohmann::json::object_t actionParameterValueTypeError(const nlohmann::json& arg1, std::string_view arg2, std::string_view arg3);

void actionParameterValueTypeError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2, std::string_view arg3);

/**
* @brief Formats ActionParameterValueFormatError message into JSON
* Message body: "The value <arg1> for the parameter <arg2> in the action <arg3> is not a format that the parameter can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t actionParameterValueFormatError(const nlohmann::json& arg1, std::string_view arg2, std::string_view arg3);

void actionParameterValueFormatError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2, std::string_view arg3);

/**
* @brief Formats ActionParameterValueNotInList message into JSON
* Message body: "The value <arg1> for the parameter <arg2> in the action <arg3> is not in the list of acceptable values."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t actionParameterValueNotInList(std::string_view arg1, std::string_view arg2, std::string_view arg3);

void actionParameterValueNotInList(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3);

/**
* @brief Formats ActionParameterValueOutOfRange message into JSON
* Message body: "The value <arg1> for the parameter <arg2> in the action <arg3> is not in the supported range of acceptable values."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t actionParameterValueOutOfRange(std::string_view arg1, std::string_view arg2, std::string_view arg3);

void actionParameterValueOutOfRange(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3);

/**
* @brief Formats ActionParameterValueError message into JSON
* Message body: "The value for the parameter <arg1> in the action <arg2> is invalid."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterValueError formatted to JSON */
nlohmann::json::object_t actionParameterValueError(const nlohmann::json& arg1, std::string_view arg2);

void actionParameterValueError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);

/**
* @brief Formats ActionParameterNotSupported message into JSON
* Message body: "The parameter <arg1> for the action <arg2> is not supported on the target resource."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterNotSupported formatted to JSON */
nlohmann::json::object_t actionParameterNotSupported(std::string_view arg1, std::string_view arg2);

void actionParameterNotSupported(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats ArraySizeTooLong message into JSON
* Message body: "The array provided for property <arg1> exceeds the size limit <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
...
* Message body: "The array provided for property <arg1> is under the minimum size limit <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ArraySizeTooShort formatted to JSON */
nlohmann::json::object_t arraySizeTooShort(std::string_view arg1, std::string_view arg2);

void arraySizeTooShort(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats QueryParameterValueTypeError message into JSON
* Message body: "The value <arg1> for the query parameter <arg2> is not a type that the parameter can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message QueryParameterValueTypeError formatted to JSON */
nlohmann::json::object_t queryParameterValueTypeError(const nlohmann::json& arg1, std::string_view arg2);

void queryParameterValueTypeError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);

/**
* @brief Formats QueryParameterValueFormatError message into JSON
* Message body: "The value <arg1> for the parameter <arg2> is not a format that the parameter can accept."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message QueryParameterValueFormatError formatted to JSON */
nlohmann::json::object_t queryParameterValueFormatError(const nlohmann::json& arg1, std::string_view arg2);

void queryParameterValueFormatError(crow::Response& res, const nlohmann::json& arg1, std::string_view arg2);
...
* Message body: "The value <arg1> for the query parameter <arg2> is out of range <arg3>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t queryParameterOutOfRange(std::string_view arg1, std::string_view arg2, std::string_view arg3);

void queryParameterOutOfRange(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3);
...
* Message body: "Two or more query parameters in the request cannot be used together."
*
*
...
* Message body: "The session establishment failed due to the number of simultaneous sessions exceeding the limit of the implementation."
*
*
...
* Message body: "The event subscription failed due to the number of simultaneous subscriptions exceeding the limit of the implementation."
*
*
...
* Message body: "The delete request failed because the resource requested cannot be deleted."
*
*
...
* Message body: "The change to the requested resource failed because the resource is in use or in transition."
*
*
...
* Message body: "The requested resource of type <arg1> with the property <arg2> with the value <arg3> already exists."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t resourceAlreadyExists(std::string_view arg1, std::string_view arg2, std::string_view arg3);

void resourceAlreadyExists(crow::Response& res, std::string_view arg1, std::string_view arg2, std::string_view arg3);

/**
* @brief Formats ResourceNotFound message into JSON
* Message body: "The requested resource of type <arg1> named <arg2> was not found."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ResourceNotFound formatted to JSON */
nlohmann::json::object_t resourceNotFound(std::string_view arg1, std::string_view arg2);

void resourceNotFound(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats PayloadTooLarge message into JSON
* Message body: "The supplied payload exceeds the maximum size supported by the service."
*
*
...
* Message body: "Insufficient storage or memory available to complete the request."
*
*
...
* Message body: "The multipart request contains malformed parts or is missing required parts."
*
*
...
* Message body: "The create operation failed because the required property <arg1> was missing from the request."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
void createFailedMissingReqProperties(crow::Response& res, std::string_view arg1);

/**
* @brief Formats CreateLimitReachedForResource message into JSON
* Message body: "The create operation failed because the resource has reached the limit of possible resources."
*
*
...
* Message body: "The operation failed because the service is shutting down and can no longer take incoming requests."
*
*
...
* Message body: "The operation failed because the service is in an unknown state and can no longer take incoming requests."
*
*
...
* Message body: "There is no valid session established with the implementation."
*
*
...
* Message body: "There are insufficient privileges for the account or credentials associated with the current session to perform the requested operation."
*
*
...
* Message body: "The account for the current session was removed, and so the current session was removed as well."
*
*
...
* Message body: "The request failed due to an internal service error.  The service is still operational."
*
*
* @returns Message InternalError formatted to JSON */
nlohmann::json::object_t internalError();

void internalError(crow::Response& res, std::source_location location = std::source_location::current());

/**
* @brief Formats UnrecognizedRequestBody message into JSON
* Message body: "The service detected a malformed request body that it was unable to interpret."
*
*
...
nlohmann::json::object_t resourceMissingAtURI(const boost::urls::url_view_base& arg1);
...
* Message body: "The resource at <arg1> is in a format not recognized by the service."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
* @returns Message ResourceAtUriInUnknownFormat formatted to JSON */
nlohmann::json::object_t resourceAtUriInUnknownFormat(const boost::urls::url_view_base& arg1);
...
* Message body: "While accessing the resource at <arg1>, the service received an authorization error <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ResourceAtUriUnauthorized formatted to JSON */
nlohmann::json::object_t resourceAtUriUnauthorized(const boost::urls::url_view_base& arg1, std::string_view arg2);

void resourceAtUriUnauthorized(crow::Response& res, const boost::urls::url_view_base& arg1, std::string_view arg2);

/**
* @brief Formats CouldNotEstablishConnection message into JSON
* Message body: "The service failed to establish a connection with the URI <arg1>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
* @returns Message CouldNotEstablishConnection formatted to JSON */
nlohmann::json::object_t couldNotEstablishConnection(const boost::urls::url_view_base& arg1);
...
* Message body: "The other end of the connection at <arg1> does not support the specified protocol <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message SourceDoesNotSupportProtocol formatted to JSON */
nlohmann::json::object_t sourceDoesNotSupportProtocol(const boost::urls::url_view_base& arg1, std::string_view arg2);

void sourceDoesNotSupportProtocol(crow::Response& res, const boost::urls::url_view_base& arg1, std::string_view arg2);

/**
* @brief Formats AccessDenied message into JSON
* Message body: "While attempting to establish a connection to <arg1>, the service denied access."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The service is temporarily unavailable.  Retry in <arg1> seconds."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The property <arg1> was assigned the value <arg2> due to modification by the service."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueModified formatted to JSON */
nlohmann::json::object_t propertyValueModified(std::string_view arg1, const nlohmann::json& arg2);

void propertyValueModified(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2);

/**
* @brief Formats ResourceInStandby message into JSON
* Message body: "The request could not be performed because the resource is in standby."
*
*
...
* Message body: "The resource <arg1> was unable to satisfy the request due to unavailability of resources."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
nlohmann::json::object_t stringValueTooLong(std::string_view arg1, uint64_t arg2);

void stringValueTooLong(crow::Response& res, std::string_view arg1, uint64_t arg2);

/**
* @brief Formats StringValueTooShort message into JSON
* Message body: "The string <arg1> was under the minimum required length <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message StringValueTooShort formatted to JSON */
nlohmann::json::object_t stringValueTooShort(std::string_view arg1, std::string_view arg2);

void stringValueTooShort(crow::Response& res, std::string_view arg1, std::string_view arg2);
...
* Message body: "The @odata.type of the request body <arg1> is incompatible with the @odata.type of the resource, which is <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ResourceTypeIncompatible formatted to JSON */
nlohmann::json::object_t resourceTypeIncompatible(std::string_view arg1, std::string_view arg2);

void resourceTypeIncompatible(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats PasswordChangeRequired message into JSON
* Message body: "The password provided for this account must be changed before access is granted.  PATCH the Password property for this account located at the target URI <arg1> to complete this process."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
* @returns Message PasswordChangeRequired formatted to JSON */
nlohmann::json::object_t passwordChangeRequired(const boost::urls::url_view_base& arg1);

void passwordChangeRequired(crow::Response& res, const boost::urls::url_view_base& arg1);

/**
* @brief Formats ResetRequired message into JSON
* Message body: "In order to apply changes, recover from errors, or complete the operation, a component reset is required with the Reset action URI <arg1> and ResetType <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ResetRequired formatted to JSON */
nlohmann::json::object_t resetRequired(const boost::urls::url_view_base& arg1, std::string_view arg2);

void resetRequired(crow::Response& res, const boost::urls::url_view_base& arg1, std::string_view arg2);

/**
* @brief Formats ResetRecommended message into JSON
* Message body: "In order to recover from errors, a component reset is recommended with the Reset action URI <arg1> and ResetType <arg2>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ResetRecommended formatted to JSON */
nlohmann::json::object_t resetRecommended(std::string_view arg1, std::string_view arg2);

void resetRecommended(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats ChassisPowerStateOnRequired message into JSON
* Message body: "The chassis with Id <arg1> is required to be powered on to perform this request."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The chassis with Id <arg1> is required to be powered off to perform this request."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The property <arg1> could not be written because its value would conflict with the value of the <arg2> property."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueConflict formatted to JSON */
nlohmann::json::object_t propertyValueConflict(std::string_view arg1, std::string_view arg2);

void propertyValueConflict(crow::Response& res, std::string_view arg1, std::string_view arg2);

/**
* @brief Formats PropertyValueResourceConflict message into JSON
* Message body: "The property <arg1> with the requested value of <arg2> could not be written because the value conflicts with the state or configuration of the resource at <arg3>."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
* @param[in] arg3 Parameter of message that will replace %3 in its body.
...
nlohmann::json::object_t propertyValueResourceConflict(std::string_view arg1, const nlohmann::json& arg2, const boost::urls::url_view_base& arg3);

void propertyValueResourceConflict(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2, const boost::urls::url_view_base& arg3);

/**
* @brief Formats PropertyValueExternalConflict message into JSON
* Message body: "The property <arg1> with the requested value of <arg2> could not be written because the value is not available due to a configuration conflict."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueExternalConflict formatted to JSON */
nlohmann::json::object_t propertyValueExternalConflict(std::string_view arg1, const nlohmann::json& arg2);

void propertyValueExternalConflict(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2);

/**
* @brief Formats PropertyValueIncorrect message into JSON
* Message body: "The property <arg1> with the requested value of <arg2> could not be written because the value does not meet the constraints of the implementation."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message PropertyValueIncorrect formatted to JSON */
nlohmann::json::object_t propertyValueIncorrect(std::string_view arg1, const nlohmann::json& arg2);

void propertyValueIncorrect(crow::Response& res, std::string_view arg1, const nlohmann::json& arg2);

/**
* @brief Formats ResourceCreationConflict message into JSON
* Message body: "The resource could not be created.  The service has a resource at URI <arg1> that conflicts with the creation request."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
* @returns Message ResourceCreationConflict formatted to JSON */
nlohmann::json::object_t resourceCreationConflict(const boost::urls::url_view_base& arg1);
...
* Message body: "The parameter <arg1> with the requested value of <arg2> does not meet the constraints of the implementation."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
* @param[in] arg2 Parameter of message that will replace %2 in its body.
*
* @returns Message ActionParameterValueConflict formatted to JSON */
nlohmann::json::object_t actionParameterValueConflict(std::string_view arg1, std::string_view arg2);

void actionParameterValueConflict(crow::Response& res, std::string_view arg1, std::string_view arg2);
...
* Message body: "The ETag supplied did not match the ETag required to change this resource."
*
*
...
* Message body: "A precondition header or annotation is required to change this resource."
*
*
...
* Message body: "An error occurred internal to the service as part of the overall request.  Partial results may have been returned."
*
*
...
* Message body: "A timeout internal to the service occurred as part of the request.  Partial results may have been returned."
*
*
...
* Message body: "One or more conditions exist in a related resource.  See the OriginOfCondition property."
*
*
...
* Message body: "The operation was not successful because the privilege <arg1> is restricted."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The request could not be fulfilled with the account types included in property <arg1> because the property StrictAccountTypes is set to true."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The deprecated property <arg1> was included in the request body."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
nlohmann::json::object_t propertyValueDeprecated(std::string_view arg1, std::string_view arg2);

void propertyValueDeprecated(crow::Response& res, std::string_view arg1, std::string_view arg2);
...
* Message body: "Resolution of network-based names is not supported by this service."
*
*
...
* Message body: "The operation failed because the service at <arg1> is disabled and cannot accept requests."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "Undelivered events may have been lost due to exceeding the event buffer."
*
*
...
* Message body: "The request could not be performed because an authentication token was not provided."
*
*
...
* Message body: "A one-time passcode was sent to: <arg1>.  Supply the passcode as the `Token` property in the request to create a session."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
...
* Message body: "The Time-based One-Time Password (TOTP) secret key for this account must be generated before access is granted.  Perform the GenerateSecretKey action at URI <arg1> and retain the secret key from the response."
*
* @param[in] arg1 Parameter of message that will replace %1 in its body.
*
* @returns Message GenerateSecretKeyRequired formatted to JSON */
nlohmann::json::object_t generateSecretKeyRequired(const boost::urls::url_view_base& arg1);

void generateSecretKeyRequired(crow::Response& res, const boost::urls::url_view_base& arg1);
