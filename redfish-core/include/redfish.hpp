...
class RedfishService
{
  public:
    ...
    RedfishService(App& app)
    {
        ...
        nodes.emplace_back(std::make_unique<ResourceDumpService>(app));
        nodes.emplace_back(std::make_unique<ResourceDumpEntryCollection>(app));
        nodes.emplace_back(std::make_unique<ResourceDumpEntry>(app));
        nodes.emplace_back(std::make_unique<ResourceDumpCreate>(app));
        nodes.emplace_back(std::make_unique<ResourceDumpClear>(app));
#endif
