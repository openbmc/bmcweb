...
class RedfishService
{
  public:
    ...
    RedfishService(CrowApp& app)
    {
        ...
        nodes.emplace_back(std::make_unique<SlvNodeLogService>(app));
        nodes.emplace_back(
            std::make_unique<JournalSlvNodeEventLogEntryCollection>(app));
        nodes.emplace_back(std::make_unique<JournalSlvNodeEventLogEntry>(app));
        nodes.emplace_back(std::make_unique<JournalSlvNodeEventLogClear>(app));
#endif
