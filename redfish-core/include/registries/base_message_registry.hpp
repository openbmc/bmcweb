...
enum class Index
{
    ...
    queryParameterValueError = 73,
    queryParameterValueFormatError = 74,
    queryParameterValueTypeError = 75,
    resetRecommended = 76,
    resetRequired = 77,
    resourceAlreadyExists = 78,
    resourceAtUriInUnknownFormat = 79,
    resourceAtUriUnauthorized = 80,
    resourceCannotBeDeleted = 81,
    resourceCreationConflict = 82,
    resourceDeprecated = 83,
    resourceExhaustion = 84,
    resourceInStandby = 85,
    resourceInUse = 86,
    resourceMissingAtURI = 87,
    resourceNotFound = 88,
    resourceTypeIncompatible = 89,
    restrictedPrivilege = 90,
    restrictedRole = 91,
    serviceDisabled = 92,
    serviceInUnknownState = 93,
    serviceShuttingDown = 94,
    serviceTemporarilyUnavailable = 95,
    sessionLimitExceeded = 96,
    sessionTerminated = 97,
    sourceDoesNotSupportProtocol = 98,
    strictAccountTypes = 99,
    stringValueTooLong = 100,
    subscriptionTerminated = 101,
    success = 102,
    undeterminedFault = 103,
    unrecognizedRequestBody = 104,
};
} // namespace redfish::registries::base
