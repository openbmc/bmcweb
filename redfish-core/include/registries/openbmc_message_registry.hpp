...
constexpr std::array<MessageEntry, 145> registry = {
    MessageEntry{
        "ADDDCCorrectable",
        {
    ...
    MessageEntry{"CPUMemoryThermalTrip",
                 {
                     "Indicates that the specified CPU Memory thermal "
                     "trip has been asserted.",
                     "CPU %1 Memory Thermal Trip.",
                     "Critical",
                     1,
                     {"number"},
                     "None.",
