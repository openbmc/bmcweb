...
/*
   ...
   this involves not using terms like "CPU", "Drive", "Backplane", ect in the
   ...
   sentence.  This generally involves placing the strings in the appropriate
   place in the string.
   ...
   from the OpenBMC upstream maintained one.
*/
