...
constexpr std::array<MessageEntry, 188> registry = {
    ...
    MessageEntry{"BMCTimeSyncDone",
                 {
                     "Indicates that BMC time sync is done via NTP/Manual.",
                     "BMC time has been set successfully via %1. "
                     "BMC Date Time is set to %2 from %3.",
                     "OK",
                     "OK",
                     3,
