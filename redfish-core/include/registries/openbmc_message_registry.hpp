    ...
    MessageEntry{"SystemInterfaceDisabledProvisioned",
                 {
                     ...
                     "The system interface is in disabled provisioned state.",
                     "OK",
                     0,
                     {},
                     "None.",
    ...
    MessageEntry{"SystemInterfaceUnprovisioned",
                 {
                     ...
                     "state. All commands are permitted to execute through "
                     "the system interface.",
                     "The system interface is in unprovisioned state.",
                     "Critical",
                     0,
                     {},
                     "None.",
    ...
    MessageEntry{"SystemInterfaceWhitelistProvisioned",
                 {
                     ...
                     "The system interface is in whitelist provisioned state.",
                     "Warning",
                     0,
                     {},
                     "None.",
