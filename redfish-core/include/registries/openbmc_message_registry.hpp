...
static constexpr std::array registry =
{
    ...
    MessageEntry{
        "FirmwareUpdateAwaitingActivation",
        {
            "Indicates a firmware update was applied but requires a manual action to become active.",
            "Firmware update to %2 is awaiting %1 to activate.",
            "Warning",
            2,
            {
                "string",
            ...
            "Perform the indicated action (AC power cycle, DC power cycle, system reboot, or medium-specific reset) to activate the newly installed firmware.",
        }},
    MessageEntry{
...
enum class Index
{
    ...
    firmwareUpdateAwaitingActivation = 45,
    firmwareUpdateCompleted = 46,
    firmwareUpdateFailed = 47,
    firmwareUpdateStaged = 48,
    firmwareUpdateStarted = 49,
    generalFirmwareSecurityViolation = 50,
    iPMIWatchdog = 51,
    ...
    powerButtonLongPressed = 135,
    powerButtonPressed = 136,
    powerRestorePolicyApplied = 137,
    powerSupplyConfigurationError = 138,
    powerSupplyConfigurationErrorRecovered = 139,
    powerSupplyFailed = 140,
    powerSupplyFailurePredicted = 141,
    powerSupplyFanFailed = 142,
    powerSupplyFanRecovered = 143,
    powerSupplyInserted = 144,
    powerSupplyPowerGoodFailed = 145,
    powerSupplyPowerLost = 146,
    powerSupplyPowerRestored = 147,
    powerSupplyPredictedFailureRecovered = 148,
    powerSupplyRecovered = 149,
    powerSupplyRemoved = 150,
    powerUnitDegradedFromNonRedundant = 151,
    powerUnitDegradedFromRedundant = 152,
    powerUnitNonRedundantFromInsufficient = 153,
    powerUnitNonRedundantInsufficient = 154,
    powerUnitNonRedundantSufficient = 155,
    powerUnitRedundancyDegraded = 156,
    powerUnitRedundancyLost = 157,
    powerUnitRedundancyRegained = 158,
    resetButtonPressed = 159,
    sELEntryAdded = 160,
    securityBoot2ndFlashEnabled = 161,
    securityP2aBridgeEnabled = 162,
    securityUartPortDebugEnabled = 163,
    securityUserNonRootUidZeroAssigned = 164,
    securityUserNonRootUidZeroRemoved = 165,
    securityUserRootDisabled = 166,
    securityUserRootEnabled = 167,
    securityUserStrongHashAlgoRestored = 168,
    securityUserUnsupportedShellEnabled = 169,
    securityUserUnsupportedShellRemoved = 170,
    securityUserWeakHashAlgoEnabled = 171,
    sensorThresholdCriticalHighGoingHigh = 172,
    sensorThresholdCriticalHighGoingLow = 173,
    sensorThresholdCriticalLowGoingHigh = 174,
    sensorThresholdCriticalLowGoingLow = 175,
    sensorThresholdWarningHighGoingHigh = 176,
    sensorThresholdWarningHighGoingLow = 177,
    sensorThresholdWarningLowGoingHigh = 178,
    sensorThresholdWarningLowGoingLow = 179,
    serviceFailure = 180,
    serviceStarted = 181,
    sparingRedundancyDegraded = 182,
    sparingRedundancyFull = 183,
    ssbThermalTrip = 184,
    systemInterfaceDisabledProvisioned = 185,
    systemInterfaceUnprovisioned = 186,
    systemInterfaceWhitelistProvisioned = 187,
    systemPowerGoodFailed = 188,
    systemPowerLost = 189,
    systemPowerOffFailed = 190,
    systemPowerOnFailed = 191,
