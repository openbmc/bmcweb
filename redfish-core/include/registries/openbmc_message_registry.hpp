...
enum class Index
{
    ...
    memoryParityCommandAndAddress = 97,
    memoryParityNotKnown = 98,
    memoryRASConfigurationDisabled = 99,
    memoryRASConfigurationEnabled = 100,
    memoryRASModeDisabled = 101,
    memoryRASModeEnabled = 102,
    memoryThermTrip = 103,
    mirroringRedundancyDegraded = 104,
    mirroringRedundancyFull = 105,
    nMIButtonPressed = 106,
    nMIDiagnosticInterrupt = 107,
    pCIeCorrectableAdvisoryNonFatal = 108,
    pCIeCorrectableBadDLLP = 109,
    pCIeCorrectableBadTLP = 110,
    pCIeCorrectableHeaderLogOverflow = 111,
    pCIeCorrectableInternal = 112,
    pCIeCorrectableLinkBWChanged = 113,
    pCIeCorrectableReceiverError = 114,
    pCIeCorrectableReplayNumRollover = 115,
    pCIeCorrectableReplayTimerTimeout = 116,
    pCIeCorrectableUnspecifiedAERError = 117,
    pCIeFatalACSViolation = 118,
    pCIeFatalAtomicEgressBlocked = 119,
    pCIeFatalCompleterAbort = 120,
    pCIeFatalCompletionTimeout = 121,
    pCIeFatalDataLinkLayerProtocol = 122,
    pCIeFatalECRCError = 123,
    pCIeFatalFlowControlProtocol = 124,
    pCIeFatalMCBlockedTLP = 125,
    pCIeFatalMalformedTLP = 126,
    pCIeFatalPoisonedTLP = 127,
    pCIeFatalReceivedErrNonFatalMessage = 128,
    pCIeFatalReceivedFatalMessageFromDownstream = 129,
    pCIeFatalReceiverBufferOverflow = 130,
    pCIeFatalSurpriseLinkDown = 131,
    pCIeFatalTLPPrefixBlocked = 132,
    pCIeFatalUncorrectableInternal = 133,
    pCIeFatalUnexpectedCompletion = 134,
    pCIeFatalUnspecifiedNonAERFatalError = 135,
    pCIeFatalUnsupportedRequest = 136,
