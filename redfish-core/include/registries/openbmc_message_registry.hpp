...
const std::array registry = {
    ...
    MessageEntry{
        "PowerSupplyConfigurationErrorDeassert",
        {
            .description =
                "Indicates an power supply configuration error is recovered.",
    ...
    MessageEntry{"PowerSupplyFailedDeassert",
                 {
                     .description =
    ...
    MessageEntry{
        "PowerSupplyFailurePredictedDeassert",
        {
