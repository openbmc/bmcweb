...
enum class EntityTag {
    ...
    tagCollectionCapabilities,
    tagComponentIntegrity,
    tagComponentIntegrityCollection,
    ...
    tagProtocol,
    tagRedfishError,
    tagRedfishExtensions,
    tagRedundancy,
    tagRegisteredClient,
    tagRegisteredClientCollection,
    tagResource,
    tagResourceBlock,
