...
{
const std::vector<Privileges> privilegeSetLogin = {{{"Login"}}};
...
const std::vector<Privileges> privilegeSetLoginOrNoAuth = {{{"Login"}, {}}};
...
inline const std::vector<Privileges>
    getPrivilegesFromUrlAndMethod(std::string_view url, HttpVerb method)
{
