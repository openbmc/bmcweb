...
std::map<HttpVerb, std::vector<Privileges>> tagAccelerationFunctionMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureComponents.begin(),privilegeSetConfigureComponents.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureComponents.begin(),privilegeSetConfigureComponents.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureComponents.begin(),privilegeSetConfigureComponents.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureComponents.begin(),privilegeSetConfigureComponents.end())},
};
...
std::map<HttpVerb, std::vector<Privileges>> tagAccountServiceMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
};
...
std::map<HttpVerb, std::vector<Privileges>> tagActionInfoMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
};
...
std::map<HttpVerb, std::vector<Privileges>> tagAggregateMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureComponents.begin(),privilegeSetConfigureManagerOrConfigureComponents.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureComponents.begin(),privilegeSetConfigureManagerOrConfigureComponents.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureComponents.begin(),privilegeSetConfigureManagerOrConfigureComponents.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureComponents.begin(),privilegeSetConfigureManagerOrConfigureComponents.end())},
};
...
std::map<HttpVerb, std::vector<Privileges>> tagCertificateMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
...
std::map<HttpVerb, std::vector<Privileges>> tagEventDestinationMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureSelf.begin(),privilegeSetConfigureManagerOrConfigureSelf.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureSelf.begin(),privilegeSetConfigureManagerOrConfigureSelf.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureSelf.begin(),privilegeSetConfigureManagerOrConfigureSelf.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureSelf.begin(),privilegeSetConfigureManagerOrConfigureSelf.end())},
};
...
std::map<HttpVerb, std::vector<Privileges>> tagManagerAccountMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetConfigureManagerOrConfigureUsersOrConfigureSelf.begin(),privilegeSetConfigureManagerOrConfigureUsersOrConfigureSelf.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureUsers.begin(),privilegeSetConfigureUsers.end())},
...
std::map<HttpVerb, std::vector<Privileges>> tagServiceRootMap =  {
	{HttpVerb::Get, std::vector<Privileges>(privilegeSetLoginOrNoAuth.begin(),privilegeSetLoginOrNoAuth.end())},
	{HttpVerb::Head, std::vector<Privileges>(privilegeSetLoginOrNoAuth.begin(),privilegeSetLoginOrNoAuth.end())},
	{HttpVerb::Patch, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
...
std::map<HttpVerb, std::vector<Privileges>> tagSessionCollectionMap =  {
	...
	{HttpVerb::Put, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Delete, std::vector<Privileges>(privilegeSetConfigureManager.begin(),privilegeSetConfigureManager.end())},
	{HttpVerb::Post, std::vector<Privileges>(privilegeSetLogin.begin(),privilegeSetLogin.end())},
};
