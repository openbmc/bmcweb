...
TEST(containsSubordinateCollection, validURIs)
{
    ...
    EXPECT_TRUE(containsSubordinateCollection("/redfish/v1/AggregationService"));
    EXPECT_TRUE(containsSubordinateCollection("/redfish/v1/CompositionService/"));
    ...
    EXPECT_TRUE(containsSubordinateCollection("/redfish/v1/TelemetryService/LogService/"));
...
TEST(containsSubordinateCollection, invalidURIs)
{
    ...
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/AggregationService/Aggregates"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/AggregationService/AggregationSources/"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/Cables/"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/Chassis/chassisId"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/Fake"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/TelemetryService/LogService/Entries"));
    EXPECT_FALSE(containsSubordinateCollection("/redfish/v1/UpdateService/SoftwareInventory/"));
}
