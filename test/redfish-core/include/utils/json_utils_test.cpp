...
TEST(SortJsonArrayByKey, ElementMissingKeyReturnsFalseArrayIsPartlySorted)
{
    ...
    EXPECT_EQ(
        array,
        R"([{"@odata.id": "/redfish/v1/1"}, {"@odata.id" : "/redfish/v1/20"}, {"@odata.id" : "/redfish/v1/100"}])"_json);
}
...
TEST(SortJsonArrayByKey, SortedByStringValueOnSuccessArrayIsSorted)
{
    ...
    EXPECT_EQ(
        array,
        R"([{"@odata.id": "/redfish/v1"}, {"@odata.id" : "/redfish/v1/20"}, {"@odata.id" : "/redfish/v1/100"}])"_json);
}
