...
TEST(GetDateTimeStdtimeTz, NullptrNoTimezone)
{
    // nullptr means no timezone — treated as an error, returns empty string
    EXPECT_EQ(getDateTimeStdtimeTz(std::time_t{1638312095}, nullptr), "");
}
