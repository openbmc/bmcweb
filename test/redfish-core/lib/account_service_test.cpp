...
TEST(Conversion, PositiveToUint64)
{
    ...
    EXPECT_EQ(*passwordExpiration, unexpiringPasswordExpiration);

    passwordExpiration = passwordExpirationToUint64("2024-10-17T00:00:00");
    EXPECT_TRUE(passwordExpiration.has_value());
    EXPECT_EQ(*passwordExpiration, 1729123200);

    passwordExpiration = passwordExpirationToUint64("2024-10-17T18:12:04");
    EXPECT_TRUE(passwordExpiration.has_value());
    EXPECT_EQ(*passwordExpiration, 1729188724);
    ...
    EXPECT_TRUE(passwordExpiration.has_value());
    EXPECT_EQ(*passwordExpiration, 1729177924);
}
