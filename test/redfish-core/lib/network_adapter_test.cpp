...
constexpr const char* adapterPath =
...
TEST(AfterGetNetworkAdapterLocationService, EbadrOmitsLocation)
{
    ...
    afterGetNetworkAdapterLocationService(response, adapterPath, ec, {});
...
TEST(AfterGetNetworkAdapterEmbeddedService, EbadrOmitsLocationType)
{
    ...
    afterGetNetworkAdapterEmbeddedService(response, adapterPath, ec, {});
...
TEST(AfterGetNetworkAdapterEmbeddedService, SuccessSetsEmbeddedLocationType)
{
    ...
    afterGetNetworkAdapterEmbeddedService(response, adapterPath, ec, object);
