...
TEST(IsValidConfigFileName, FileNameValidCharReturnsTrue)
{
    ...
    EXPECT_TRUE(
        isValidConfigFileName("GoodConfigFile",jsonValue));
}
...
TEST(IsValidConfigFileName, FileNameInvalidPathReturnsFalse)
{
    ...
    EXPECT_FALSE(
        isValidConfigFileName("/mydir/configFile", jsonValue));
}
...
TEST(handleFileUpload,  contentNotAcceptable1)
{
    ...
    EXPECT_EQ(asyncResp->res.jsonValue["Description"],std::string(contentNotAcceptableMsg));
}
...
TEST(handleFileUpload,  contentAcceptable1){
    ...
    handleFileUpload(reqIn, asyncResp ,fileID) ;
    EXPECT_NE(asyncResp->res.jsonValue["Description"],std::string(contentNotAcceptableMsg));
    EXPECT_NE(asyncResp->res.jsonValue["Description"],std::string(resourceNotFoundMsg));
    EXPECT_NE(asyncResp->res.jsonValue["Description"],std::string(badRequestMsg));
