...
// Minimal handler that satisfies the Connection template contract without
// pulling in the full bmcweb router.  The fuzzer is targeting the connection
// state machine and HTTP parser path, not downstream request handling.
struct FuzzHandler
{
    App app;
