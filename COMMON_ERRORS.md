...
util functions will help to reduce the compilation time, increase code reuse 
and uniformity in error handling.
Below are the list of existing D-Bus utility functions 
- getProperty
- getAllProperties
- checkDbusPathExists
- getSubTree
...
scripts/generate_schema_enums.py. The generated header files contain the 
redfish enumerations which must be used for JSON response population. 
