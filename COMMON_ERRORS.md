...
to use an nlohmann::json::object_t or nlohmann::json::array_t where appropriate.
There is quite a large amount of code in bmcweb that does not handle the
distinction between nlohmann::json and nlohmann::json::object_t correctly. These
