...
inline int pamUpdatePasswordFunctionConversation(int numMsg, const struct pam_message** msgs,
                                   struct pam_response** resp, void* appdataPtr)
{
    if ((appdataPtr == nullptr) || (msgs == nullptr) || (resp == nullptr))
    {
                             ...
                             const std::string& password)
{
    ...
    const struct pam_conv localConversation = {pamUpdatePasswordFunctionConversation,
                                               passStrNoConst};
    pam_handle_t* localAuthHandle = nullptr; // this gets set by pam_start
