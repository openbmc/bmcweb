                               ...
                               std::string_view rhost)
{
    ...
    retval = pam_set_item(localAuthHandle, PAM_RHOST,
                          reinterpret_cast<const void *>(rhostStr.c_str()));
    if (retval != PAM_SUCCESS)
    {
        return retval;
    }
