...
void handleEnumerate(crow::Response &res, const std::string &objectPath)
{
    ...
    crow::connections::systemBus->async_method_call(
        ...
        // Map indicating connection name, and the object manager path
...
<<<<<<< HEAD
                ...
                for (auto &interface : connection.second)
                {
                    ...
                    {
                        {
                            objectManager = object.first;
                        }
                    }
>>>>>>> 96628f2... Fix an issue with non-root objectmapper entries
                }
            }
...
<<<<<<< HEAD
        ...
        for (const auto &connection : connections)
        {
            ...
            {
                getManagedObjectsForEnumerate(
                    objectPath, objectPath, connection.first, res, transaction);
=======
                // If we already know where the object manager is, we don't need
                }
            }
