                               ...
                               crow::Response& res)
{
    ...
    res.addHeader("Permissions-Policy",
                  ...
                  "battery=(), bluetooth=(), camera=(), ch-ua=(), "
                  "ch-ua-arch=(), ch-ua-bitness=(), ch-ua-full-version=(),"
                  "ch-ua-full-version-list=(), ch-ua-mobile=(), "
                  "ch-ua-model=(), ch-ua-platform=(), "
                  "ch-ua-platform-version=(), ch-ua-wow64=(), "
                  ...
                  "serial=(), sync-xhr=(), usb=(self), web-share=(), "
