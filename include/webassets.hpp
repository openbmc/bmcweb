...
inline void handleStaticAsset(
    const std::filesystem::path& absolutePath, std::string_view contentType,
    std::string_view contentEncoding, std::string_view etag, bool renamed,
...
inline void requestRoutes(App& app)
{
    ...
    for (const std::filesystem::directory_entry& dir : paths)
    {
        ...
        else if (std::filesystem::is_regular_file(dir))
        {
            ...
            auto contentType = std::ranges::find_if(
