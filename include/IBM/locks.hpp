...
class lock
{
  ...
  private:
        ...
        for (auto i : refrids)
        {
            ...
            else
            {
                ...
                return std::make_pair(
                    false,
                    std::make_pair(refrids[i], locktable[refrids[i]][0]));
            }
        }
    ...
    bool isvalidlockrequest(lockrequest reflockrecord)
    {
  ...
  public:
    ...
    rcacquirelock Acquirelock(lockrequests lockrequeststructure)
    {
