...
// http://localhost:8080/google/v1/NVMeSubsystemControllerCollection/test0
// {
//   "@odata.id": "/google/v1/NVMeSubsystemControllerCollection/test0",
//   "Actions": {
//     "#Nvme.Identify": {
//       "target":
//       "/google/v1/NVMeSubsystemControllerCollection/test0/Actions/Nvme.Identify"
//     },
//     "#Nvme.Log": {
//       "target":
//       "/google/v1/NVMeSubsystemControllerCollection/test0/Actions/Nvme.Log"
//     }
//   },
//   "Links": {
...
// }
// $ curl  -u root:0penBmc -X POST http://localhost:8080/google/v1/NVMeSubsystemControllerCollection/test0/Actions/NVMe.Identify -d '{"arg0": "hello"}' -H "Content-Type: application/json"
// bm8gMA==

// $ curl  -u root:0penBmc -X POST http://localhost:8080/google/v1/NVMeSubsystemControllerCollection/test0/Actions/NVMe.Log -d '{"arg0": "hello", "arg1": "world"}' -H "Content-Type: application/json"
// aGkgMA==
                      ...
                      const std::string& filepath)
{
    ...
    BMCWEB_LOG_INFO << "Binary Size: " << str.size() << "\n";
