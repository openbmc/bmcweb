...
inline void requestRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(
        ...
        .methods(
            ...
            if (!redfish::json_util::readJson(req, asyncResp->res, "Command",
                                              command))
            {

                BMCWEB_LOG_DEBUG << "Missing property Command.";
                messages::actionParameterMissing(asyncResp->res, "SendCommand",
                                                 "Command");
                return;
            }
            crow::connections::systemBus->async_method_call(
                ...
                "/xyz/openbmc_project/Control/Hoth",
                "xyz.openbmc_project.Control.Hoth", "SendHostCommand", command);
        });
}
