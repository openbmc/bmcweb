...
class KvmSession
{
  public:
    ...
    void onMessage(const std::string& data)
    {
        ...
        BMCWEB_LOG_DEBUG("conn:{}, inputbuffer size {}", fmt::ptr(&conn),
                         inputBuffer.size());
        doWrite();
    }
    ...
    void doWrite()
    {
        ...
        hostSocket.async_write_some(
            inputBuffer.data(), [this](const boost::system::error_code& ec,
                ...
                BMCWEB_LOG_DEBUG("conn:{}, Wrote {}bytes", fmt::ptr(&conn),
                                 bytesWritten);
                doingWrite = false;
