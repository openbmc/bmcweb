    ...
    const dbus::utility::DBusPropertiesMap& userInfoMap)
{
    ...
    if (userType == "xyz.openbmc_project.User.Manager.UserType.Internal")
    {
        userType = "Internal";
    }
    else if (userType == "xyz.openbmc_project.User.Manager.UserType.LDAP")
    {
        userType = "LDAP";
    }
    else if (userType == "xyz.openbmc_project.User.Manager.UserType.AD")
    {
        userType = "AD";
    }
