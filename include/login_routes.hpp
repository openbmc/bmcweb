...
void createSession(std::string_view username,
...
bool isRedfishGroupUser(const dbus::utility::DBusPropertiesMap& userInfoMap,
                        const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void getUserInfo(std::string_view username,
                 const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                 CallbackFn&& callback)
{
