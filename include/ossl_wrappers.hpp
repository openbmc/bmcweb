...
class OpenSSLSSLCtx
{
  public:
    ...
    bool setCiphersuites(std::string_view ciphersuites)
    {
        ...
        if (SSL_CTX_set_ciphersuites(ptr, ciphersuitesStr.c_str()) != 1)
        {
    ...
    bool setCurves(std::string_view curves)
    {
        ...
        if (SSL_CTX_set1_curves_list(ptr, curvesStr.c_str()) != 1)
        {
    ...
    bool setCipherList(std::string_view cipherList)
    {
        ...
        if (SSL_CTX_set_cipher_list(ptr, cipherListStr.c_str()) != 1)
        {
