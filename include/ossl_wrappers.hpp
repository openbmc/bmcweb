...
class OpenSSLEVPKey
{
  public:
    ...
    {
        if (PEM_write_bio_PrivateKey(bufio.get(), ptr, nullptr, nullptr, 0,
                                     nullptr, nullptr) <= 0)
        {
            return false;
        }
...
class OpenSSLEVPKeyCTX
{
  ...
  public:
    ...
    bool paramgenInit()
    {
        if (EVP_PKEY_paramgen_init(ptr) != 1)
        {
            return false;
        }
        return true;
    ...
    {
        if (EVP_PKEY_keygen(get(), &pkey.ptr) != 1)
        {
            return false;
        }
        return true;
    ...
    {
        if (EVP_PKEY_CTX_set_ec_param_enc(get(), enc) != 1)
        {
            return false;
        }
        return true;
    ...
    {
        if (EVP_PKEY_CTX_set_ec_paramgen_curve_nid(get(), nid) != 1)
        {
            return false;
        }
        return true;
...
class OpenSSLX509
{
  ...
  public:
    ...
    {
        if (PEM_write_bio_X509(bufio.get(), ptr) <= 0)
        {
            return false;
        }
        return true;
    ...
    {
        if (X509_set_pubkey(ptr, pkey.get()) != 1)
        {
            return false;
        }
        return true;
    ...
    {
        if (X509_sign(ptr, pkey.get(), EVP_sha256()) <= 0)
        {
            return false;
        }
        return true;
