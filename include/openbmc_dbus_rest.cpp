// Note:
// it appears moving the function definitions to the .CPP file reduced the
// build time for redfish.cpp
...
InProgressEnumerateData::~InProgressEnumerateData()
{
...
void handleList(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                       const std::string& objectPath, int32_t depth)
{
    crow::connections::systemBus->async_method_call(
