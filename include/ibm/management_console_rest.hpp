...
inline void getLockServiceData(crow::Response& res)
{
    ...
    res.jsonValue["Actions"]["#LockService.AcquireLock"]["target"] = "/redfish/v1/Oem/IBM/LockService/Actions/LockService.AcquireLock";
    res.jsonValue["Actions"]["#LockService.ReleaseLock"]["target"] = "/redfish/v1/Oem/IBM/LockService/Actions/LockService.ReleaseLock";
    res.jsonValue["Actions"]["#LockService.GetLockList"]["target"] = "/redfish/v1/Oem/IBM/LockService/Actions/LockService.GetLockList";
...
inline void requestRoutes(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Oem/IBM/LockService/Actions/LockService.AcquireLock")
        .privileges({"ConfigureComponents", "ConfigureManager"})
        .methods(boost::beast::http::verb::post)(
            [](const crow::Request& req, crow::Response& res) {
                std::vector<nlohmann::json> body;
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Oem/IBM/Lockservice/Actions/LockService.ReleaseLock")
        .privileges({"ConfigureComponents", "ConfigureManager"})
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Oem/IBM/LockService/Actions/LockService.GetLockList")
        .privileges({"ConfigureComponents", "ConfigureManager"})
        .methods(boost::beast::http::verb::post)(
            [](const crow::Request& req, crow::Response& res) {
