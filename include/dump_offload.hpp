...
static constexpr size_t socketBufferSize = 1024 * 1024;
...
class Handler : public std::enable_shared_from_this<Handler>
{
  public:
    ...
    /**
     * @brief  Checks if unix domain socket is ready for read
     *
     * @return void
     */
    void checkSocketReadyToRead()
    {
        this->unixSocket.async_wait(
            ...
            [this, self(shared_from_this())](boost::system::error_code ec) {
                if (ec)
                {
                    BMCWEB_LOG_ERROR << "UNIX Socket: async_wait error "
                                     << ec.message();
                    return;
                }
                this->doReadStream();
