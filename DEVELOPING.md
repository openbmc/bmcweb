...
exception. A single endpoint failing is not "critical."
"error" should be used for unexpected conditions that prevented bmcweb from
fulfilling the request. "error" should be used for OpenBMC internal errors but
not user errors.
"warning" and above can be used for user errors.
"info" and above can be used for good path logging.
