...
- critical: Something went badly wrong; we're no longer able to serve traffic.
  ...
  that caused crucial function to stop working or when bmcweb threw an
  exception.
- error: Something went wrong, and we weren't able to give the expected response
  ...
  unexpected conditions that prevented bmcweb from fulfilling the request.
  "error" should be used for 5xx errors.
