...
def main():
    ...
    parser.add_argument(
        '--base', action=argparse.BooleanOptionalAction,    default=False,
        help="Update base_message_registry or not")
    parser.add_argument(
        '--task_event', action=argparse.BooleanOptionalAction,
        default=False, help="Update task_event_message_registry or not")
    parser.add_argument(
        '--resource_event', action=argparse.BooleanOptionalAction,
        default=False, help="Update resource_event_message_registry or not")
    parser.add_argument(
        '--privileges', action=argparse.BooleanOptionalAction,
        default=False, help="Update privilege_registry or not")
