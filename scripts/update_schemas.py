...
""")
    #TODO There's a bug in the script that currently deletes this schema
    #(because it's an OEM schema). Because it's the only one, and we don't
    #update schemas very often, we just manually fix it until someone proposes
