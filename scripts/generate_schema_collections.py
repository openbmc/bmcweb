...
def main():
    ...
    # are upstream from a top level resource.  We shouldn't combine these into a
    ...
    parse_node(curr_path, collection_parents, top_collections, "ServiceRoot_v1.xml")

    print("Finished traversal!")

    # TODO: Generate unordered_map of <collection parents, valid paths>
    # TODO: Remove the prints since we can check the .cpp file(s) to verify
    keys = []
    ...
    # TODO: Generate unordered_set of top level collections
    print("Top level collections")
    for key in sorted(top_collections):
        print(key)
