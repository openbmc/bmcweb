...
def main():
    ...
    #for ds_child in ds:
    #    if ds_child.tag == EDM + "Schema":
    #        print(ds_child)
    #        entitycontainer = list(ds_child.iter(EDM + "EntityContainer"))
    #        if len(entitycontainer) is 0:
    #            continue;
    #        print("FOUND")
            #print(list(ds_child.iter()))
    #        print(entitycontainer)
            #print("")
            #for en in ds_child.iterfind(EDM + "EntityContainer"):
            #    print(en)
            #print(list(ds_child.iter(EDM + "EntityContainer")))
    #        print("End of loop\n")
        #print(child.tag, child.attrib)

#    print(ds)
#    print(ds.tag)
#    for nav in root.findall("NavigationProperty"):
#        print(nav.find("Name").text)
#        print(nav.find("Type").text)
