...
for file, json_dict, namespace, url in files:
    ...
    with open(file, 'w') as registry:
        ...
        env = jinja2.Environment(loader=jinja2.FileSystemLoader(search_path), extensions=['jinja2.ext.do'])
        registry.write(env.get_template('messages.tmpl').render(main=json_dict))
