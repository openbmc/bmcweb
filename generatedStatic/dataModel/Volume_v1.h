...
struct VolumeV1Links
{
    ...
    NavigationReferenceRedfish dedicatedSpareDrives;
    NavigationReferenceRedfish spareResourceSets;
    NavigationReferenceRedfish clientEndpoints;
    NavigationReferenceRedfish serverEndpoints;
    NavigationReferenceRedfish consistencyGroups;
    NavigationReferenceRedfish owningStorageService;
    NavigationReferenceRedfish journalingMedia;
    NavigationReferenceRedfish owningStorageResource;
    NavigationReferenceRedfish cacheVolumeSource;
    NavigationReferenceRedfish cacheDataVolumes;
};
...
struct VolumeV1Operation
{
    ...
    NavigationReferenceRedfish associatedFeaturesRegistry;
};
