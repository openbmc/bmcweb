...
struct PortV1GenZ
{
    NavigationReferenceRedfish LPRT;
    NavigationReferenceRedfish MPRT;
    NavigationReferenceRedfish VCAT;
};
...
struct PortV1Links
{
    ...
    NavigationReferenceRedfish associatedEndpoints;
    NavigationReferenceRedfish connectedSwitches;
    NavigationReferenceRedfish connectedSwitchPorts;
