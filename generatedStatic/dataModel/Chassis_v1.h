...
struct ChassisV1Links
{
    ...
    NavigationReferenceRedfish containedBy;
    NavigationReferenceRedfish contains;
    NavigationReferenceRedfish poweredBy;
    NavigationReferenceRedfish cooledBy;
    NavigationReferenceRedfish managersInChassis;
    ...
    NavigationReferenceRedfish switches;
