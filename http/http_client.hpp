...
inline std::shared_ptr<boost::asio::ssl::context> prepareSSLContext()
{
    ...
    if (SSL_CTX_set_cipher_list(sslCtx->native_handle(), sslCiphers.c_str()) !=
        1)
    {
