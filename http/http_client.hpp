...
class ConnectionInfo : public std::enable_shared_from_this<ConnectionInfo>
{
  private:
    ...
    void doResolve(const std::string& data)
    {
        ...
        BMCWEB_LOG_DEBUG
            << "MYDEBUG: Finished creating respHandler in doResolve()";
        ...
        boost::beast::http::async_read(
            ...
            [self(shared_from_this()),
             data](const boost::beast::error_code& ec,
                ...
                // Send is successful
                // Reset the retry counter just in case
                self->retryCount = 0;
    ...
    void waitAndRetry(const std::string& data)
    {
        ...
        timer.async_wait([self(shared_from_this()),
            ...
            // Let's close connection and start from resolve.
...
// class ConnectionPool : public std::enable_shared_from_this<ConnectionPool>
{
  private:
    ...
    void addConnection()
    {
        ...
        //        ConnectionInfo* ci = new ConnectionInfo(ioc, id, destIP,
        //        destPort,
        //                                                destUri, httpHeader,
        //                                                newId);
        //        connections.push_back(ci);

        connections.push_back(std::make_shared<ConnectionInfo>(
