...
class HttpClient : public std::enable_shared_from_this<HttpClient>
{
  private:
    ...
    void doResolve()
    {
        ...
        resolver.async_resolve(std::move(respHandler));
    }
  ...
  public:
    explicit HttpClient(boost::asio::io_context& ioc, const std::string& id,
        ...
        resolver(destIP, destPort),
        conn(ioc), timer(ioc), req(boost::beast::http::verb::post, destUri, 11),
        subId(id), host(destIP), port(destPort), uri(destUri), retryCount(0),
