                            ...
                            "xyz.openbmc_project.Configuration.SatelliteController")
                        {
                            ...
                            for (const auto& val : interface.second)
                            {
                                if (val.first == "Name")
                                {
                                    ...
                                    if (satelliteInfo.find(*val_data) !=
                                        satelliteInfo.end())
                                    {
                                        BMCWEB_LOG_ERROR
                                ...
                                else if (val.first == "Hostname")
                                {
                                    ...
                                    satellite.host = *val_data;
                                }

                                else if (val.first == "Port")
                                {
                                    const uint64_t* val_data =
                                    ...
                                    satellite.port = std::to_string(*val_data);
                                }
