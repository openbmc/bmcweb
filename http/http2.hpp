...
struct nghttp2_session
{
    nghttp2_session(nghttp2_session_callbacks& callbacks)
    {
    ...
    nghttp2_session(nghttp2_session&& other) noexcept
    {
        *this = std::move(other);
    }

    nghttp2_session& operator=(nghttp2_session&& other) noexcept
    {
        if (this != &other)
        {
            ptr = other.ptr;
