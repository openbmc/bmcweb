  ...
  public:
    ...
    void add(const std::string& url, unsigned ruleIndex)
    {
        ...
        for (unsigned i = 0; i < url.size(); i++)
        {
            ...
            if (c == '<')
            {
                constexpr static std::array<std::pair<ParamType, std::string>,
                                            3>
                    paramTraits = {{
...
inline void afterPrivilegeLookup(
    Request& req, std::shared_ptr<bmcweb::AsyncResp> asyncResp, BaseRule& rule,
    std::vector<std::string> params, const boost::system::error_code& ec,
  ...
  public:
                ...
                const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
    {
        ...
        crow::connections::systemBus->async_method_call(
            ...
            afterPrivilegeLookup(req, asyncResp, rule, params, ec, userInfoMap);
            },
