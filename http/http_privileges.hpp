...
/**
 * @brief HTTP privileges
 *
 *        This implements a set of HTTP privileges.  These directly represent
 ...
 *
 * This represents the Http "Privilege AND and OR syntax" as given
 * in the spec and shown in the Privilege Registry.  This does not
 * implement any HTTP property overrides, subordinate overrides, or
