...
class ISslContextFactory
{
  public:
    ...
    ISslContextFactory() = default;
    ISslContextFactory(const ISslContextFactory&) = delete;
    ISslContextFactory& operator=(const ISslContextFactory&) = delete;
    ISslContextFactory(ISslContextFactory&&) = default;
    ISslContextFactory& operator=(ISslContextFactory&&) = default;
