...
TEST(Utility, GetDateTime)
{
    ...
    EXPECT_EQ(crow::utility::getDateTime(std::time_t{-1234567}),
              "1969-12-17T17:03:53Z");
    // epoch
    EXPECT_EQ(crow::utility::getDateTime(std::time_t{-0}),
              "1970-01-01T00:00:00Z");
    // some time in the past after the epoch
    EXPECT_EQ(crow::utility::getDateTime(uint64_t{1638312095}),
