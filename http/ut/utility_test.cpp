...
TEST(GetDateTimeUint, MiscellaneousDateTime)
{
    ...
    EXPECT_EQ(getDateTimeUint(1638312095), "2021-11-30T22:41:35+00:00");
    // some time in the future, beyond 2038
    EXPECT_EQ(getDateTimeUint(41638312095), "3289-06-18T21:48:15+00:00");
    // the maximum time we support
    EXPECT_EQ(getDateTimeUint(253402300799), "9999-12-31T23:59:59+00:00");
}
...
{
    EXPECT_EQ(getDateTimeUintMs(1638312095123),
              "2021-11-30T22:41:35.123+00:00");
}

TEST(GetDateTimeUintMs, ZeroFractionValue)
{
    EXPECT_EQ(getDateTimeUintMs(1638312095000),
              "2021-11-30T22:41:35.000+00:00");
}
...
{
    EXPECT_EQ(getDateTimeUintUs(1638312095123456),
              "2021-11-30T22:41:35.123456+00:00");
}

TEST(GetDateTimeUintUs, ZeroFractionValue)
{
    EXPECT_EQ(getDateTimeUintUs(1638312095000000),
              "2021-11-30T22:41:35.000000+00:00");
}
