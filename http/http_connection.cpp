...
template<typename Adaptor, typename Handler>
boost::system::error_code Connection<Adaptor, Handler>::getClientIp(boost::asio::ip::address& ip)
{
...
template<typename Adaptor, typename Handler>
void Connection<Adaptor, Handler>::readClientIp()
{
    boost::asio::ip::address ip;
...
template<typename Adaptor, typename Handler>
bool Connection<Adaptor, Handler>::isAlive()
{
    if constexpr (std::is_same_v<Adaptor,
                                    boost::beast::ssl_stream<
                                        boost::asio::ip::tcp::socket>>)
...
template<typename Adaptor, typename Handler>
void Connection<Adaptor, Handler>::close()
{
    if constexpr (std::is_same_v<Adaptor,
                                    boost::beast::ssl_stream<
                                        boost::asio::ip::tcp::socket>>)
...
template<typename Adaptor, typename Handler>
void Connection<Adaptor, Handler>::doRead()
{
...
template<typename Adaptor, typename Handler>
void Connection<Adaptor, Handler>::doWrite()
{
