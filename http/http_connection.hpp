...
// request body limit size set by the bmcweb::HTTP_BODY_LIMIT option
constexpr uint64_t httpReqBodyLimit = 1024UL * 1024UL * bmcweb::HTTP_BODY_LIMIT;
    ...
    public std::enable_shared_from_this<Connection<Adaptor, Handler>>
{
  ...
  public:
        ...
        getCachedDateStr(getCachedDateStrF)
    {
        ...
        if constexpr (bmcweb::MUTUAL_TLS_AUTH)
        {
            prepareMutualTls();
        }
    ...
    void afterSslHandshake()
    {
        ...
        if constexpr (bmcweb::EXPERIMENTAL_HTTP2)
        {
