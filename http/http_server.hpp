...
class Server
{
  public:
    ...
    void doAccept()
    {
        ...
        BMCWEB_LOG_DEBUG("Starting accept");
                                       ...
                                       boost::asio::ip::tcp::socket>>::value)
        {
            ...
            {
                BMCWEB_LOG_CRITICAL("TLS context was null????");
                return;
            }
        ...
        acceptor.async_accept(
            ...
            if (ec)
            {
                BMCWEB_LOG_ERROR("Async accept hit error");
            }
            else
            {
                BMCWEB_LOG_DEBUG("{} Starting socket",
                                 logPtr(connection.get()));
