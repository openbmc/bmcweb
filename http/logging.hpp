                 ...
                 const std::source_location& loc) noexcept
{
    ...
    try
    {
        // TODO, multiple static analysis tools flag that this could potentially throw
        // Based on the documentation, it shouldn't throw, so long as none of the
        // formatters throw, so unclear at this point why this try/catch is required,
        // but add it to silence the static analysis tools.
