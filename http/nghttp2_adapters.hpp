...
class nghttp2_hd_inflater
{
  ...
  public:
    ...
    ssize_t hd2(nghttp2_nv* nv_out, int* inflate_flags, const uint8_t* in,
                size_t inlen, int in_final)
    {
        return nghttp2_hd_inflate_hd2(ptr, nv_out, inflate_flags, in, inlen,
                                      in_final);
    }
