...
// NOLINTBEGIN(readability-identifier-naming, readability-make-member-function-const)
...
// NOLINTEND(readability-identifier-naming, readability-make-member-function-const)
