...
class ConnectionImpl : public Connection
{
  public:
    ConnectionImpl(
        const crow::Request& reqIn, const boost::urls::url_view& urlViewIn,
        ...
        errorHandler(std::move(errorHandlerIn)), req(reqIn.req),
        session(sessionIn), protocolHeader(protocolHeaderIn)
    {
