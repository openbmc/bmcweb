...
This document shall provides an overview of handling a multi-host platform via
...
In accordance to the physical-topology
...
is expected that indexing of the hosts starts at index 1 to not introduce subtle
bugs, as documented in
...
The Redfish identfier for a ComputerSystem is currently derived from the dbus
...
entries specific to it. This type of filtering is currently not supported.
