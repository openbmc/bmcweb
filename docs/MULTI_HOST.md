...
be confused with bmcweb's [aggregation feature][1], which aggregates resources
from multiple hosts or computing nodes managed by satellite BMCs.

## Design

### Associations

In accordance with the physical-topology [design document][2], bmcweb uses dbus
associations to link a given ComputerSystem or Chassis with its specific
resources.
...
[3]:
  https://github.com/openbmc/phosphor-dbus-interfaces/blob/1730647ae60100bbbaac1f5d010f459d9eb91331/yaml/xyz/openbmc_project/Inventory/Decorator/ManagedHost.interface.yaml
