...
multi-host platforms. This list is subject to change. Further designs
for the respective backends need to be made, before any of these can be supported.
...
The following properties aren't yet implemented
for multi-host.
