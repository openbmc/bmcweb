...
struct DataSecurityLoSCapabilities_v1_DataSecurityLoSCapabilities
{
    ...
    DataSecurityLoSCapabilities_v1_AuthenticationType supportedHostAuthenticationTypes;
    DataSecurityLoSCapabilities_v1_AuthenticationType supportedUserAuthenticationTypes;
    DataSecurityLoSCapabilities_v1_SecureChannelProtocol supportedSecureChannelProtocols;
    DataSecurityLoSCapabilities_v1_AntiVirusScanTrigger supportedAntivirusScanPolicies;
    std::string supportedAntivirusEngineProviders;
    DataSecurityLoSCapabilities_v1_DataSanitizationPolicy supportedDataSanitizationPolicies;
    DataSecurityLineOfService_v1_DataSecurityLineOfService supportedLinesOfService;
