...
struct ConnectionV1Links
{
    ...
    NavigationReference_ initiatorEndpoints;
    NavigationReference_ targetEndpoints;
    NavigationReference_ initiatorEndpointGroups;
    NavigationReference_ targetEndpointGroups;
};
struct ConnectionV1MemoryChunkInfo
{
    ConnectionV1AccessCapability accessCapabilities;
    ConnectionV1AccessState accessState;
    NavigationReference_ memoryChunk;
};
