...
struct DataStorageLoSCapabilities_v1_DataStorageLoSCapabilities
{
    ...
    DataStorageLoSCapabilities_v1_StorageAccessCapability supportedAccessCapabilities;
    DataProtectionLoSCapabilities_v1_DataProtectionLoSCapabilities supportedRecoveryTimeObjectives;
    DataStorageLoSCapabilities_v1_ProvisioningPolicy supportedProvisioningPolicies;
    bool supportsSpaceEfficiency;
    DataStorageLineOfService_v1_DataStorageLineOfService supportedLinesOfService;
