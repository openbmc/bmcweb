...
struct StorageServiceV1Links
{
    ...
    NavigationReference_ hostingSystem;
    NavigationReference_ defaultClassOfService;
    NavigationReference_ dataProtectionLoSCapabilities;
    NavigationReference_ dataSecurityLoSCapabilities;
    NavigationReference_ dataStorageLoSCapabilities;
    NavigationReference_ iOConnectivityLoSCapabilities;
    NavigationReference_ iOPerformanceLoSCapabilities;
};
