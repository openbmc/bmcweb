...
struct ResourceBlockV1Links
{
    ...
    NavigationReference_ consumingResourceBlocks;
    NavigationReference_ supplyingResourceBlocks;
};
struct ResourceBlockV1ResourceBlock
{
    ...
    NavigationReference_ ethernetInterfaces;
    NavigationReference_ networkInterfaces;
    NavigationReference_ computerSystems;
