...
struct DataProtectionLoSCapabilities_v1_DataProtectionLoSCapabilities
{
    ...
    DataProtectionLoSCapabilities_v1_FailureDomainScope supportedRecoveryGeographicObjectives;
    std::string supportedRecoveryPointObjectiveTimes;
    DataProtectionLoSCapabilities_v1_RecoveryAccessScope supportedRecoveryTimeObjectives;
    ...
    DataProtectionLineOfService_v1_DataProtectionLineOfService supportedLinesOfService;
