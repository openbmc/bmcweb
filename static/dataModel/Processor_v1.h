...
struct ProcessorV1FpgaReconfigurationSlot
{
    ...
    NavigationReference_ accelerationFunction;
};
...
struct ProcessorV1Processor
{
    ...
    NavigationReference_ operatingConfigs;
    NavigationReference_ appliedOperatingConfig;
