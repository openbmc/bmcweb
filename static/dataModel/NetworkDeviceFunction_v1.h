...
struct NetworkDeviceFunctionV1Links
{
    ...
    NavigationReference_ pCIeFunction;
    NavigationReference_ endpoints;
    NavigationReference_ physicalPortAssignment;
    NavigationReference_ physicalNetworkPortAssignment;
};
struct NetworkDeviceFunctionV1NetworkDeviceFunction
{
    ...
    NavigationReference_ assignablePhysicalPorts;
    NavigationReference_ physicalPortAssignment;
    ...
    NavigationReference_ assignablePhysicalNetworkPorts;
    NavigationReference_ physicalNetworkPortAssignment;
