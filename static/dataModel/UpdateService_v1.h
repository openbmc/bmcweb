...
struct UpdateService_v1_UpdateService
{
    ...
    bool serviceEnabled;
    SoftwareInventoryCollection_v1_SoftwareInventoryCollection firmwareInventory;
    SoftwareInventoryCollection_v1_SoftwareInventoryCollection softwareInventory;
